...
class ChcDeployExtraConfig(AbstractModel):
    ...
    @property
    def MiniOsType(self):
        r"""MinIO type: whether to use Tencent Cloud's minios or the customer's own minios.
        :rtype: str
        """
    ...
    @property
    def BootType(self):
        r"""Server architecture and boot mode. Value: x86_legacy, arm_uefi.
        :rtype: str
        """
    ...
    @property
    def BootFile(self):
        r"""The boot file used by PXE. Default: pxelinux.0.
        :rtype: str
        """
...
class ConfigureChcAssistVpcRequest(AbstractModel):
    ...
    def ChcDeployExtraConfig(self):
        r"""Additional parameters for deployment network, used to specify minios type, bios boot mode, etc.
        :rtype: :class:`tencentcloud.cvm.v20170312.models.ChcDeployExtraConfig`
        """
...
class ConfigureChcDeployVpcRequest(AbstractModel):
    ...
    @property
    def ChcDeployExtraConfig(self):
        r"""dhcp option parameters required for deployment
        :rtype: :class:`tencentcloud.cvm.v20170312.models.ChcDeployExtraConfig`
        """
        return self._ChcDeployExtraConfig
...
class CreateDisasterRecoverGroupRequest(AbstractModel):
    ...
    @property
    def Affinity(self):
        r"""The affinity of the placement group. Instances in the placement group are distributed according to this affinity. The affinity value range is: 1-10, and defaults to 1.
        :rtype: int
        """
...
false (default): sends a normal request. after passing the check, creates an instance directly.
    ...
    def EnableJumboFrame(self):
        r"""Whether jumbo frames are enabled for the instance. Valid values:
- true: Jumbo frames are enabled. Only instance types that support jumbo frames can be set to true.
- false: Jumbo frames are disabled. Only instance types that support jumbo frames can be set to false.
...
class DeleteInstancesDisasterRecoverGroupsRequest(AbstractModel):
    r"""DeleteInstancesDisasterRecoverGroups request structure.
    ...
    @property
    def DisasterRecoverGroupIds(self):
        r"""ID list of placement groups, obtainable via the [DescribeDisasterRecoverGroups](https://www.tencentcloud.com/zh/document/api/213/33261) API. 
        :rtype: list of str
        """
        return self._DisasterRecoverGroupIds
...
class DeleteInstancesDisasterRecoverGroupsResponse(AbstractModel):
    r"""DeleteInstancesDisasterRecoverGroups response structure.
...
class EnterRescueModeRequest(AbstractModel):
    ...
    @property
    def StopType(self):
        r"""The shutdown mode of the instance. Valid values: <br><li>SOFT_FIRST: Indicates a forced shutdown after a graceful shutdown fails</li><br><li>HARD: Direct forced shutdown</li><br><li>SOFT: Soft shutdown only</li><br>Default value: SOFT.
        :rtype: str
        """
...
class InquiryPriceResetInstanceRequest(AbstractModel):
    ...
    @property
    def UserData(self):
        r"""User data provided for the instance, which must be base64-encoded. The maximum supported data size is 16KB. For detailed instructions on obtaining this parameter, see [Windows](https://cloud.tencent.com/document/product/213/17526) and [Linux](https://cloud.tencent.com/document/product/213/17525) documentation on executing commands during startup.
        :rtype: str
        """
        return self._UserData
...
class ModifyImageSharePermissionRequest(AbstractModel):
    ...
    @property
    def AccountIds(self):
        r"""ID list of root accounts receiving shared images. An account ID is different from a QQ number. For details on root account IDs, refer to the account ID section in [Account Information](https://console.cloud.tencent.com/developer).
        :rtype: list of str
        """
...
class ResetInstancesTypeRequest(AbstractModel):
    ...
    @property
    def InstanceType(self):
        r"""Instance model. Different resource specifications are specified for different models. For specific values, call DescribeInstanceTypeConfigs to get the latest specification list or refer to [Instance Types](https://intl.cloud.tencent.com/document/product/213/11518?from_cn_redirect=1).
        :rtype: str
        """
        return self._InstanceType
...
`false` (default value): Send a normal request and create instance(s) if all the requirements are met.
    ...
    @property
    def InstanceChargeType(self):
        r"""Instance [billing type](https://www.tencentcloud.com/document/product/213/2180). <br><li>`PREPAID`: Monthly Subscription, used for at least one month <br><li>`POSTPAID_BY_HOUR`: Hourly-based pay-as-you-go <br><li>`CDHPAID`: [Dedicated CVM](https://www.tencentcloud.com/document/product/416/5068?lang=en&pg=) (associated with a dedicated host. Resource usage of the dedicated host is free of charge.) <br><li>`SPOTPAID`: [Spot instance](https://intl.cloud.tencent.com/document/product/213/17817)<br>Default value: `POSTPAID_BY_HOUR`.
        :rtype: str
        """
        return self._InstanceChargeType
...
<br><li>To view specific values for `POSTPAID_BY_HOUR` instances, you can call DescribeInstanceTypeConfigs or refer to [Instance Types](https://www.tencentcloud.com/document/product/213/11518). <br><li>For `CDHPAID` instances, the value of this parameter is in the format of `CDH_XCXG` based on the number of CPU cores and memory capacity. For example, if you want to create a CDH instance with a single-core CPU and 1 GB memory, specify this parameter as `CDH_1C1G`.
    ...
    @property
    def ImageId(self):
        r"""The [image](https://www.tencentcloud.com/document/product/213/4940) ID in the format of `img-xxx`. There are three types of images:<br/><li>Public images</li><li>Custom images</li><li>Shared images</li><br/>To check the image ID:<br/><li>For public images, custom images, and shared images, go to the [CVM console](https://console.cloud.tencent.com/cvm/image?rid=1&imageType=PUBLIC_IMAGE). </li><li>Call [DescribeImages](https://www.tencentcloud.com/document/api/213/33272), pass in `InstanceType` to retrieve the list of images supported by the current model, and then find the `ImageId` in the response.</li>
 <b>Note: `ImageId` is required when `LaunchTemplate` is not specified. If both the parameters are passed in, `ImageId` prevails.</b>
        :rtype: str
        """
        return self._ImageId
...
Only applicable to accounts, regions, and billing modes (annual/monthly subscription, pay-as-you-go, spot instance, exclusive sales) with partial support.
    ...
    @property
    def InstanceName(self):
        r"""Instance display name.<br><li>If no instance display name is specified, it will display 'unnamed' by default.</li><li>Supports up to 128 characters (including pattern strings).</li><li>When purchasing multiple instances:.
- Specify a pattern string {R:x}: Generates a numeric sequence [x, x+n-1], where n represents the number of purchased instances. For example: Input server_{R:3}. When purchasing 1 instance, the display name is server_3; when purchasing 2 instances, the display names are server_3 and server_4.
- Specify a pattern string {R:x,F:y}: y indicates fixed digit (optional), value range [0,8], default value 0 means no fixed digit (equivalent to {R:x}). Automatically pads with zeros when digits are insufficient, for example: input server_{R:3,F:3}, when purchasing 2 instances, the instance display name is server_003, server_004. If digit count exceeds y (such as {R:99,F:2}), the actual number is used, for example: app_{R:99,F:2}, when purchasing 2 instances, the instance display name is app_99, app_100.
- Pattern strings must strictly follow the format {R:x,F:y} or {R:x}. Invalid formats (such as {}) are treated as plain text. Multiple pattern strings are supported.
- No pattern string specified: The display name is appended with suffix 1, 2...n, where n indicates the number of instances purchased. For example server_. When purchasing 2 instances, generates server_1 and server_2.
    ...
    @property
    def HostName(self):
        r"""Instance HostName.<br><li>Period (.) and hyphen (-) should not be used as the first or last character of the hostname, and should not be used consecutively.</li><br><li>Windows instances: The hostname should contain 2 to 15 characters, including letters (case insensitive), digits, and hyphens (-), does not support periods (.), and should not be all digits.</li><br><li>Instances of other types (such as Linux instances): The hostname should contain 2 to 60 characters, including multiple periods (.), with each segment between periods considered as one section. Each section can contain letters (case insensitive), digits, and hyphens (-).</li><br><li>When purchasing multiple instances:
- Specify a pattern string {R:x}: Generates a numeric sequence [x, x+n-1], where n represents the number of purchased instances. For example: Input server_{R:3}. When purchasing 1 instance, the hostname is server_3; when purchasing 2 instances, the hostnames are server_3 and server_4.
- Specify a pattern string {R:x,F:y}: y indicates fixed digit width (optional), valid range [0,8]. Default value 0 means no fixed width (equivalent to {R:x}). Insufficient digits are automatically padded with zeros. For example: Input server{R:3,F:3}. When purchasing 2 instances, the hostnames are server_003 and server_004. If the number of digits exceeds y (e.g., {R:99,F:2}), the actual digit count is used. For example: app{R:99,F:2}. When purchasing 2 instances, the hostnames are app_99 and app_100.
- Specify a pattern string {IP}: Automatically replace with the private IP address of the instance. For example: input node-{IP}, the instance hostname is node-10.0.12.8. Supports mixed use with serial number pattern strings, such as: input web-{IP}-{R:1}, when purchasing 2 instances, the instance hostnames are web-10.0.12.8-1 and web-10.0.12.9-2 respectively.
- Pattern strings must strictly follow the format {R:x,F:y}, {R:x}, or {IP}. Invalid formats (such as {}) are treated as plain text. Multiple pattern strings are supported.
...
`false` (default value): Send a normal request and create instance(s) if all the requirements are met.
    ...
    @property
    def CamRoleName(self):
        r"""CAM role name, which can be obtained from the `roleName` field in the response of the [`DescribeRoleList`](https://www.tencentcloud.com/document/product/598/33559) API.
        :rtype: str
        """
        return self._CamRoleName
