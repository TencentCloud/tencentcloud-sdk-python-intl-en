...
class VodClient(AbstractClient):
    ...
    def CommitUpload(self, request):
        r"""This API is used to confirm the upload result of media files and cover files to Tencent Cloud VOD, store media information, and return the playback address and file ID.
    ...
    def CreateAigcHunyuan3DTask(self, request):
        r"""This API is used to create AIGC Hunyuan 3D tasks.
    ...
    def CreateQualityInspectTemplate(self, request):
        r"""This API is used to create an audio-visual quality inspection template.
    ...
    def DeleteJustInTimeTranscodeTemplate(self, request):
        r"""This API is used to delete a just in time transcoding template.
    ...
    def DescribeAigcAdvancedCustomElements(self, request):
        r"""This API is used to retrieve advanced custom AIGC subjects.
    ...
    def DescribeAigcFaceInfo(self, request):
        r"""This API is used to retrieve AIGC face information. Note that calling this API incurs face recognition fees. Refer to the billing documentation (https://www.tencentcloud.com/document/product/266/95125?from_cn_redirect=1#96b3b59a-f9e1-49e9-966a-bedb70a4bf12).
    ...
    def DescribeJustInTimeTranscodeTemplates(self, request):
        r"""This API is used to search the instant transcoding template list.
    ...
    def DescribeSnapshotByTimeOffsetTemplates(self, request):
        r"""This API is used to query specified time point screenshot templates based on conditions with paging.
    ...
    def InspectMediaQuality(self, request):
        r"""This API is used to trigger an audio and video quality inspection task for on-demand audio-video media.
    ...
    def ModifyDefaultStorageRegion(self, request):
        r"""This API is used to set the default storage region. If no region is specified during file upload, files are uploaded to the default region.
    ...
    def ModifySampleSnapshotTemplate(self, request):
        r"""Modify a custom sampled screenshot template.
    ...
    def ModifyWordSample(self, request):
        r"""This API is used to modify the scenario and tags of a keyword. The keyword itself cannot be modified. If modification is needed, delete and rebuild it.
    ...
    def StartCDNDomain(self, request):
        r"""This API is used to enable or disable a CDN acceleration domain name.
