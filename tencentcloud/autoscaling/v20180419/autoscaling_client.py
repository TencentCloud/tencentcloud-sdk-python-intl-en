...
class AutoscalingClient(AbstractClient):
    ...
    def AttachInstances(self, request):
        r"""This interface (AttachInstances) is used to add CVM instances to a scaling group.
    ...
    def AttachLoadBalancers(self, request):
        r"""This API is used to add CLBs to a security group.
    ...
    def CancelInstanceRefresh(self, request):
        r"""This API is used to cancel the instance refresh activity of the scaling group.
    ...
    def ClearLaunchConfigurationAttributes(self, request):
        r"""This API is used to clear specific attributes of the launch configuration.
    ...
    def CompleteLifecycleAction(self, request):
        r"""This API is used to complete a lifecycle action by setting the status of lifecycle hook to `CONTINUE` or `ABANDON`.
    ...
    def CreateAutoScalingGroup(self, request):
        r"""This API (CreateAutoScalingGroup) is used to create an auto scaling group.
    ...
    def CreateAutoScalingGroupFromInstance(self, request):
        r"""This API is used to create launch configurations and scaling groups based on an instance.
    ...
    def CreateLaunchConfiguration(self, request):
        r"""This interface (CreateLaunchConfiguration) is used to create new launch configuration.
    ...
    def CreateLifecycleHook(self, request):
        r"""This interface (CreateLifecycleHook) is used for creating a lifecycle hook.
    ...
    def CreateNotificationConfiguration(self, request):
        r"""This API is used to create a notification.
    ...
    def CreateScheduledAction(self, request):
        r"""This API (CreateScheduledAction) is used to create a scheduled task.
    ...
    def DeleteAutoScalingGroup(self, request):
        r"""This API is used to delete an auto-scaling group. Make sure that there are no `IN_SERVICE` instances in the group, and there are no ongoing scaling activities. When you delete a scaling group, instances in the status of `CREATION_FAILED`, `TERMINATION_FAILED` and `DETACH_FAILED` are not terminated.
    ...
    def DeleteLaunchConfiguration(self, request):
        r"""This API (DeleteLaunchConfiguration) is used to delete a launch configuration.
    ...
    def DeleteLifecycleHook(self, request):
        r"""This API (DeleteLifeCycleHook) is used to delete a lifecycle hook.
    ...
    def DeleteNotificationConfiguration(self, request):
        r"""This API (DeleteNotificationConfiguration) is used to delete the specified notification.
    ...
    def DeleteScalingPolicy(self, request):
        r"""This API (DeleteScalingPolicy) is used to delete an alarm trigger policy.
    ...
    def DeleteScheduledAction(self, request):
        r"""This API (DeleteScheduledAction) is used to delete the specified scheduled task.
    ...
    def DescribeAccountLimits(self, request):
        r"""This API (DescribeAccountLimits) is used to query the limits of user's AS resources.
    ...
    def DescribeAutoScalingAdvices(self, request):
        r"""This API is used to query suggestions for scaling group configurations.
    ...
    def DescribeAutoScalingGroupLastActivities(self, request):
        r"""This API is used to query the latest activity history of an auto scaling group.
    ...
    def DescribeAutoScalingGroups(self, request):
        r"""This API (DescribeAutoScalingGroups) is used to query the information of auto scaling groups.
    ...
    def DescribeAutoScalingInstances(self, request):
        r"""This API (DescribeAutoScalingInstances) is used to query the information of instances associated with AS.
    ...
    def DescribeLaunchConfigurations(self, request):
        r"""This API is used to query the information of launch configurations.
    ...
    def DescribeLifecycleHooks(self, request):
        r"""This API (DescribeLifecycleHooks) is used to query the information of lifecycle hooks.
    ...
    def DescribeNotificationConfigurations(self, request):
        r"""This API (DescribeNotificationConfigurations) is used to query the information of one or more notifications.
    ...
    def DescribeRefreshActivities(self, request):
        r"""This API (DescribeRefreshActivities) is used to query the instance refresh activity records of a scaling group.
    ...
    def DescribeScalingPolicies(self, request):
        r"""This API (DescribeScalingPolicies) is used to query alarm trigger policies.
    ...
    def DescribeScheduledActions(self, request):
        r"""This API (DescribeScheduledActions) is used to query the details of one or more scheduled tasks.
    ...
    def DetachInstances(self, request):
        r"""This API is used to remove CVM instances from a scaling group. Instances removed via this API will not be terminated.
    ...
    def DetachLoadBalancers(self, request):
        r"""This API is used to unbind one or more CLBs from a scaling group. This API will not terminate CLBs.
    ...
    def DisableAutoScalingGroup(self, request):
        r"""This API is used to disable the specified auto-scaling group.
    ...
    def EnableAutoScalingGroup(self, request):
        r"""This API (EnableAutoScalingGroup) is used to enable the specified auto scaling group.
    ...
    def EnterStandby(self, request):
        r"""This API is used to set instances within the scaling group to standby status.
    ...
    def ExecuteScalingPolicy(self, request):
        r"""This API is used to execute a scaling policy.
    ...
    def ExitStandby(self, request):
        r"""This API is used to exit instances from standby status in the scaling group.
    ...
    def ModifyAutoScalingGroup(self, request):
        r"""This API (ModifyAutoScalingGroup) is used to modify an auto scaling group.
    ...
    def ModifyDesiredCapacity(self, request):
        r"""This API (ModifyDesiredCapacity) is used to modify the desired number of instances in the specified auto scaling group.
    ...
    def ModifyLaunchConfigurationAttributes(self, request):
        r"""This API (ModifyLaunchConfigurationAttributes) is used to modify part of a launch configuration's attributes.
    ...
    def ModifyLifecycleHook(self, request):
        r"""This API is used to modify the lifecycle hook.
    ...
    def ModifyLoadBalancerTargetAttributes(self, request):
        r"""This API is used to modify the target rule attributes of the CLB in the scaling group.
    ...
    def ModifyLoadBalancers(self, request):
        r"""This API is used to modify the cloud load balancers of a scaling group.
    ...
    def ModifyNotificationConfiguration(self, request):
        r"""This API is used to modify a notification policy.
    ...
    def ModifyScalingPolicy(self, request):
        r"""This API (ModifyScalingPolicy) is used to modify an alarm trigger policy.
    ...
    def ModifyScheduledAction(self, request):
        r"""This API (ModifyScheduledAction) is used to modify a scheduled task.
    ...
    def RemoveInstances(self, request):
        r"""This API is used to delete CVM instances from a scaling group. Instances that are automatically created through AS will be terminated, while those manually added to the scaling group will be removed and retained.
        * If the number of remaining `IN_SERVICE` instances in the scaling group is less than the minimum capacity, this API will return an error.
        * However, if the scaling group is in `DISABLED` status, the removal will not verify the relationship between the number of `IN_SERVICE` instances and the minimum capacity.
        * This removal will unassociate the CVM from the CLB instance that has been configured for the scaling group.
    ...
    def ResumeInstanceRefresh(self, request):
        r"""This API is used to resume the paused instance refresh activity, allowing it to retry failed instances in the current batch or proceed with refreshing subsequent batches. Note that calling this API is ineffective when the activity is not in a paused status.
    ...
    def RollbackInstanceRefresh(self, request):
        r"""This API is used to generate a new instance refresh activity, which also supports batch refreshing and operations such as pausing, resuming, and canceling. This API returns RefreshActivityId for the rollback activity.
    ...
    def ScaleInInstances(self, request):
        r"""This API is used to reduce the specified number of instances from the scaling group.
    ...
    def ScaleOutInstances(self, request):
        r"""This API is used to add the specified number of instances to a scaling group. It returns the scaling activity ID `ActivityId`.
    ...
    def SetInstancesProtection(self, request):
        r"""This API is used to enable scale-in protection for an instance.
    ...
    def StartAutoScalingInstances(self, request):
        r"""This API is used to start up CVM instances in a scaling group.
    ...
    def StartInstanceRefresh(self, request):
        r"""This API is used to refresh running CVM instances in the scaling group and return the RefreshActivityId for the instance refresh activity based on parameters in the launch configuration.
    ...
    def StopAutoScalingInstances(self, request):
        r"""This API is used to shut down CVM instances in a scaling group.
    ...
    def StopInstanceRefresh(self, request):
        r"""This API is used to pause the ongoing instance refresh activity.
    ...
    def UpgradeLaunchConfiguration(self, request):
        r"""There is a replacement API: ModifyLaunchConfiguration. This API carries the risk of parameter overwriting, and it has currently been hidden on the official website.
    ...
    def UpgradeLifecycleHook(self, request):
        r"""This API is used to upgrade the lifecycle hook.
