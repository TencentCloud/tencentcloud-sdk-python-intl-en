...
class PrivatednsClient(AbstractClient):
    ...
    def AddSpecifyPrivateZoneVpc(self, request):
        r"""This API is used to add the VPC associated with the private domain.
    ...
    def DeletePrivateZoneRecord(self, request):
        r"""This API is used to delete the private DNS records.
    ...
    def DeleteSpecifyPrivateZoneVpc(self, request):
        r"""This API is used to delete the VPC associated with the private domain.
    ...
    def DescribePrivateZoneRecordList(self, request):
        r"""This API is used to obtain the private domain record list.
    ...
    def QueryAsyncBindVpcStatus(self, request):
        r"""This API is used to query the asynchronous VPC binding status.
