...
class AddSpecifyPrivateZoneVpcRequest(AbstractModel):
    r"""AddSpecifyPrivateZoneVpc request structure.
    ...
    @property
    def VpcSet(self):
        r"""Information about the new VPC.
    ...
    def AccountVpcSet(self):
        r"""Information about the new VPC of the associated account.
    ...
    @property
    def Sync(self):
        r"""Whether the operation is synchronous.
        :rtype: bool
        """
        return self._Sync
...
class AddSpecifyPrivateZoneVpcResponse(AbstractModel):
    r"""AddSpecifyPrivateZoneVpc response structure.
    ...
    def __init__(self):
        ...
        :type ZoneId: str
        :param _VpcSet: The VPC to be added.
        :type VpcSet: list of VpcInfo
        :param _AccountVpcSet: The VPC of the associated account that is to be added.
        :type AccountVpcSet: list of AccountVpcInfo
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    @property
    def AccountVpcSet(self):
        r"""The VPC of the associated account that is to be added.
        :rtype: list of AccountVpcInfo
        """
        return self._AccountVpcSet
...
class DeletePrivateZoneRecordRequest(AbstractModel):
    ...
    @property
    def RecordId(self):
        r"""Record ID (which can be obtained by calling DescribePrivateZoneRecordList).
        :rtype: str
        """
        return self._RecordId
    ...
    def RecordIdSet(self):
        r"""Record ID array, with RecordId preferred.
        :rtype: list of str
        """
...
class DeleteSpecifyPrivateZoneVpcRequest(AbstractModel):
    r"""DeleteSpecifyPrivateZoneVpc request structure.
    ...
    @property
    def AccountVpcSet(self):
        r"""VPC of the associated account that is to be deleted.
        :rtype: list of AccountVpcInfo
        """
        return self._AccountVpcSet
...
class DeleteSpecifyPrivateZoneVpcResponse(AbstractModel):
    r"""DeleteSpecifyPrivateZoneVpc response structure.
...
class DescribePrivateZoneRecordListRequest(AbstractModel):
    ...
    @property
    def ZoneId(self):
        r"""Private domain ID, which is in zone-xxxxxx format.
        :rtype: str
        """
        return self._ZoneId
    ...
    @property
    def Filters(self):
        r"""Filter parameters. (Valid values: Value and RecordType.)
        :rtype: list of Filter
        """
        return self._Filters
    ...
    @property
    def Limit(self):
        r"""Pagination limit. Maximum value: 200. Default value: 20.
        :rtype: int
        """
        return self._Limit
...
class DescribePrivateZoneRecordListResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _TotalCount: Number of private DNS records.
        :type TotalCount: int
        :param _RecordSet: Private DNS record list.
    ...
    @property
    def TotalCount(self):
        r"""Number of private DNS records.
        :rtype: int
        """
        return self._TotalCount
...
class QueryAsyncBindVpcStatusRequest(AbstractModel):
    r"""QueryAsyncBindVpcStatus request structure.
...
class QueryAsyncBindVpcStatusResponse(AbstractModel):
    r"""QueryAsyncBindVpcStatus response structure.

    """

    def __init__(self):
        r"""
        :param _Status: processing: Processing is ongoing. success: Execution succeeded.
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    @property
    def Status(self):
        r"""processing: Processing is ongoing. success: Execution succeeded.
failed: Execution failed.
        :rtype: str
        """
        return self._Status
