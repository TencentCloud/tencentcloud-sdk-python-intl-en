...
class ChangeClothesRequest(AbstractModel):
    r"""ChangeClothes request structure.
...
It is recommended to input a complete front-facing flat image of the clothes, containing only one garment in the image. The type of the clothes supports Upper-body, Lower-body and Dress, and you can choose one from the three. The algorithm will change the model's clothes based on the input model image and the input clothes image.
    ...
    def ClothesType(self):
        r"""Type of the clothes, which needs to be consistent with the input clothes image.
Supported value:
Upper-body
Lower-body
Dress
    ...
    @property
    def LogoAdd(self):
        r"""Switch indicating whether to add a logo to the generated image. Default value: 1.
1: add logo
0: do not add logo
Other values: add logo
It is recommended to use an obvious logo to indicate that the image result is generated by AI.
...
By default, the text "Generated by AI" is added to the bottom right corner of the generated image. You can also use other logo.
    ...
    @property
    def RspImgType(self):
        r"""Image return method (base64 or url).
You can specify only one method. Default value: base64.
The URL is valid for 1 hour.
It is recommended to choose url when the generated image resolution is large. Using base64 may cause return failure due to the image being too large.
        :rtype: str
...
class ChangeClothesResponse(AbstractModel):
    r"""ChangeClothes response structure.
...
If the value is url, the URL of the generated image is returned. The URL is valid for 1 hour. Save it in time.
    ...
    def ResultImage(self):
        r"""Different content is returned depending on the input parameter RspImgType.
If the value is base64, the Base64 code of the generated image is returned.
If the value is url, the URL of the generated image is returned. The URL is valid for 1 hour. Save it in time.
        :rtype: str
        """
...
class ImageToImageRequest(AbstractModel):
    r"""ImageToImage request structure.
...
If the input value is greater than 0, the value will be used as the maximum number of faces with a small area can be restored in each image. The generation time will increase according to the actual number of faces restored.
    ...
    @property
    def InputImage(self):
        r"""Base64 code of the input mage.
Either the Base64 code or URL must be provided. If both are provided, URL prevails.
Image restrictions: The single-edge resolution must be less than 5,000 and greater than 50, and the size after Base64 encoding must be less than 8 MB. Supported formats include JPG, JPEG, PNG, BMP, TIFF and WEBP.
        :rtype: str
        """
...
It is recommended to use only one style. If no style is specified, 201 (anime style) is used by default.
    ...
    def ResultConfig(self):
        r"""Configurations of the generated image, including the resolution.
Images with the following resolutions can be generated: origin (The resolution is the same as the input image resolution, with the edge resolution of up to 2000. The image will be zoomed out proportionally if the resolution is exceeded.), 768:768 (1:1), 768:1024 (3:4), and 1024:768 (4:3).
If the resolution is not specified, origin is used by default.
...
The URL is valid for 1 hour.
    ...
    def EnhanceImage(self):
        r"""Switch indicating whether to  enhance image clarity. Default value: 0.
1: on
0: off
If the switch is turned on, the image clarity will be enhanced and the generation time will increase.
        :rtype: int
    ...
    def RestoreFace(self):
        r"""Maximum number of faces for detail restoration. Value range: 0 - 6. Default value: 0.
If the input value is greater than 0, the value will be used as the maximum number of faces with a small area can be restored in each image. The generation time will increase according to the actual number of faces restored.
        :rtype: int
        """
...
class ImageToImageResponse(AbstractModel):
    r"""ImageToImage response structure.
...
class LogoParam(AbstractModel):
    ...
    @property
    def LogoImage(self):
        r"""Logo Base64 code. Either the Base64 code or URL must be provided. If both are provided, URL prevails.
        :rtype: str
        """
    ...
    @property
    def LogoRect(self):
        r"""Coordinates of the logo image in the generated image. The logo image will be stretched according to the coordinates.
...
class ResultConfig(AbstractModel):
    r"""Return result configurations
