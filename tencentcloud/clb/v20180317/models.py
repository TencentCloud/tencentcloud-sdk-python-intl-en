...
Enable this feature with caution if the maximum number of connections is limited for real servers. This feature is in beta testing. To use it, submit a [beta testing application](https://intl.cloud.tencent.com/apply/p/tsodp6qm21?from_cn_redirect=1).
    ...
    def DeregisterTargetRst(self):
        r"""Whether to send an RST packet to the client when a listener is unbound from a real server. This parameter applies only to TCP listeners.
        :rtype: bool
        """
...
<li>Either this parameter or the Certificate parameter should be specified when you create a TCP_SSL listener or an HTTPS listener with the SNI feature disabled. You cannot specify them at the same time.</li>
    ...
    def IdleConnectTimeout(self):
        r"""Idle connection timeout, in seconds. This parameter applies only to TCP listeners. Value range: 300–900 for shared instances and dedicated instances and 300–1980 for LCU-supported instances. To set a value, [submit a ticket for application](https://console.cloud.tencent.com/workorder/category).
        :rtype: int
        """
    ...
    @property
    def SnatEnable(self):
        r"""Whether to enable SNAT. True: enable; False: disable.
        :rtype: bool
        """
    ...
    @property
    def H2cSwitch(self):
        r"""Whether to enable H2C for a private network HTTP listener. True: enable; False: disable.
        :rtype: bool
        """
    ...
    def SslCloseSwitch(self):
        r"""Whether to disable SSL for TCP_SSL listeners. Dual-stack binding is still supported after SSL is disabled. True: disable; False: enable.
        :rtype: bool
        """
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    @property
    def CheckPort(self):
        r"""A custom check parameter, representing the health check port, which is the port of the real server by default. Unless you want to specify a port, it is recommended to leave it empty. (Applicable only to TCP/UDP listeners)
...
Default value: -1, which indicates no limit.
    ...
    @property
    def IdleConnectTimeout(self):
        r"""Idle connection timeout, in seconds. This parameter applies only to TCP listeners. Default value: 900. Value range: 300–900 for shared instances and dedicated instances and 300–1980 for LCU-supported instances. To set a value greater than 2000, [submit a ticket for application](https://console.cloud.tencent.com/workorder/category). The maximum value can be 3600.
        :rtype: int
        """
        return self._IdleConnectTimeout
    ...
    @property
    def SnatEnable(self):
        r"""Whether to enable SNAT. True: enable SNAT; False: do not enable SNAT.
        :rtype: bool
        """
        return self._SnatEnable
