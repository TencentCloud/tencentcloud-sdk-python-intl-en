...
class StsClient(AbstractClient):
    ...
    def AssumeRole(self, request):
        r"""This API is used to request for the temporary security credentials of a role.
    ...
    def AssumeRoleWithSAML(self, request):
        r"""This API is used to request for the temporary credentials for a role that has been authenticated via a SAML assertion.
    ...
    def GetFederationToken(self, request):
        r"""This API is used to get temporary credentials for a federated user.
