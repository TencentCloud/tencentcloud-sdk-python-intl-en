...
2. The region ID for non-region-specific products should be set to non-regional.
    ...
    @property
    def ProductIds(self):
        r"""Query by Product ID(s). Product ID examples: cvm, lb, cdb, cdn, crs.
        :rtype: list of str
        """
...
class EventDetail(AbstractModel):
    r"""Describes information on an event.
    ...
    @property
    def EndTime(self):
        r"""Event end time. If the event is still ongoing and has not ended, the end time will be empty.
        :rtype: str
        """
    ...
    def CurrentStatus(self):
        r"""Current status: Normally, Informational, Degradation.
        :rtype: str
        """
