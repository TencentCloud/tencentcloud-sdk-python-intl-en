...
class Subtitle(AbstractModel):
    r"""The information about the timestamps.
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    @property
    def Text(self):
        r"""The word in the text that is sent.
        :rtype: str
        """
        return self._Text
    ...
    @property
    def BeginTime(self):
        r"""The start timestamp of the word in the synthesized audio data, in milliseconds.
        :rtype: int
        """
    ...
    @property
    def EndTime(self):
        r"""The end timestamp of the word in the synthesized audio data, in milliseconds.
        :rtype: int
        """
    ...
    @property
    def BeginIndex(self):
        r"""The start index of the character in the whole sentence, starting from 0.
        :rtype: int
        """
    ...
    @property
    def EndIndex(self):
        r"""The end index of the character in the whole sentence, starting from 0.
        :rtype: int
        """
...
class TextToVoiceRequest(AbstractModel):
    r"""TextToVoice request structure.
...
<li>101056-zhilin (Northeastern Mandarin)</li>
    ...
    @property
    def Text(self):
        r"""The source text for synthesizing speech, which is encoded in UTF-8.
It can contain up to 150 Chinese characters (a full-width punctuation as a Chinese character) or 500 letters ( a half-width punctuation as a letter).
        :rtype: str
        """
        return self._Text
    ...
    @property
    def SessionId(self):
        r"""The `SessionId` of a request, which will be returned as-is. We recommend that you pass characters like uuid to prevent repetition.
        :rtype: str
        """
    ...
    @property
    def Volume(self):
        r"""Volume range: [0, 10], corresponding to 11 volume levels. 0 is the default value, indicating the normal volume. There is no mute option.
        :rtype: float
        """
        return self._Volume
    ...
    @property
    def Speed(self):
        r"""Speed range: [-2, 6], corresponding to different speeds<li>-2 for 0.6 times</li><li>-1 for 0.8 times</li><li>0 for 1.0 time (default)</li><li>1 for 1.2 times</li><li>2 for 1.5 times</li><li>6 for 2.5 times</li>To set finer-grained speed levels, keep one decimal place, such as 0.5, 1.1, and 1.8.<br>
        :rtype: float
        """
        return self._Speed
    ...
    @property
    def ProjectId(self):
        r"""Project ID, which defaults to 0 and can be customized.
        :rtype: int
        """
    ...
    @property
    def ModelType(self):
        r"""Model type, with `1` for the default model.
        :rtype: int
        """
    ...
    @property
    def VoiceType(self):
        r"""Standard voices <li>10510000-zhixiaoyao (Chinese)</li><li>1001-zhiyu (Chinese)</li><li>1002-zhiling (Chinese)</li><li>1003-zhimei (Chinese)</li><li>1004-zhiyun (Chinese)</li><li>1005-zhili (Chinese)</li></li><li>1008-zhiqi (Chinese)</li><li>1009-zhiyun (Chinese)</li><li>1010-zhihua (Chinese)</li><li>1017-zhirong (Chinese)</li><li>1018-zhijing (Chinese)</li><li>1050-WeJack (English)</li><li>1051-WeRose (English)</li>Premium voices<br>Premium voices have higher fidelity and more natural-sounding quality than standard voices. For price details, see [Purchase Guide](https://www.tencentcloud.com/document/product/1154/47874).<br><li>100510000-zhixiaoyao (Chinese)</li><li>101001-zhiyu (Chinese)</li><li>101002-zhiling (Chinese)</li><li>101003-zhimei (Chinese)</li><li>101004-zhiyun (Chinese)</li><li>101005-zhili (Chinese)</li><li>101006-zhiyan (Chinese)</li></li><li>101008-zhiqi (Chinese)</li><li>101009-zhiyun (Chinese)</li><li>101010-zhihua (Chinese)</li><li>101011-zhiyan (Chinese)</li><li>101012-zhidan (Chinese)</li><li>101013-zhihui (Chinese)</li><li>101014-zhining (Chinese)</li><li>101015-zhimeng (Chinese)</li><li>101016-zhitian (Chinese)</li><li>101017-zhirong (Chinese)</li><li>101018-zhijing (Chinese)</li><li>101019-zhitong (Cantonese)</li><li>101020-zhigang (Chinese)</li><li>101021-zhirui (Chinese)</li><li>101022-zhihong (Chinese)</li><li>101023-zhixuan (Chinese)</li><li>101024-zhihao (Chinese)</li><li>101025-zhiwei (Chinese)</li><li>101026-zhixi (Chinese)</li><li>101027-zhimei (Chinese)</li><li>101028-zhijie (Chinese)</li><li>101029-zhikai (Chinese)</li><li>101030-zhike (Chinese)</li><li>101031-zhikui (Chinese)</li><li>101032-zhifang (Chinese)</li><li>101033-zhibei (Chinese)</li><li>101034-zhilian (Chinese)</li><li>101035-zhiyi (Chinese)</li><li>101040-zhichuan (Sichuan dialect)</li><li>101050-WeJack (English)</li><li>101051-WeRose (English)</li><li>101052-zhiwei (Chinese)</li>
<li>101053-zhifang (Chinese)</li>
<li>101054-zhiyou (Chinese)</li>
<li>101055-zhiyou (Chinese)</li>
<li>101056-zhilin (Northeastern Mandarin)</li>
    ...
    def FastVoiceType(self):
        r"""Instant Voice Clone Voice ID. Required when using Instant Voice Clone voices.
        :rtype: str
        """
    ...
    def PrimaryLanguage(self):
        r"""Primary language type: <li>1 - Chinese (default)</li><li>2 - English</li>
        :rtype: int
        """
    ...
    @property
    def SampleRate(self):
        r"""Audio sample rate: <li>16000: 16k (default)</li><li>8000: 8k</li>
        :rtype: int
        """
    ...
    @property
    def Codec(self):
        r"""Format of returned audio. Valid values: WAV (default), MP3, and PCM.
        :rtype: str
        """
        return self._Codec
    ...
    def EnableSubtitle(self):
        r"""Whether to enable the timestamp feature. Default value: `false`.
        :rtype: bool
        """
    ...
    def SegmentRate(self):
        r"""The threshold of speech segmentation sensibility, which can be `0` (default), `1`, or `2`. A larger value indicates fewer segments, and the model tends to only segment sentences based on punctuation marks. We recommend you not change this parameter to avoid adverse effect on speech synthesis.
        :rtype: int
        """
    ...
    def EmotionCategory(self):
        r"""Controls the emotion of synthesized speech. This parameter is supported only by multi-emotion voices. Valid values: neutral, sad, happy, angry, fear, news, story, radio, poetry, call, sajiao, disgusted, amaze, peaceful, exciting, aojiao, jieshuo. <br>Example value: neutral.
        :rtype: str
        """
    ...
    def EmotionIntensity(self):
        r"""Controls the intensity of emotion in synthesized speech. Valid values: [50, 200]. Default: 100. Takes effect only when EmotionCategoryis specified.
        :rtype: int
        """
...
class TextToVoiceResponse(AbstractModel):
    r"""TextToVoice response structure.
    ...
    @property
    def Audio(self):
        r"""Base64-encoded WAV/MP3 audio data
        :rtype: str
        """
        return self._Audio
    ...
    @property
    def Subtitles(self):
        r"""Timestamp information. If the timestamp feature is not enabled, an empty array will be returned.
