...
class ArchiveKeyRequest(AbstractModel):
    ...
    def MemberAccount(self):
        r"""Trusted service member account information. valid at that time when the current account is admin or delegated admin.
...
class DescribeKeyRequest(AbstractModel):
    ...
    @property
    def MemberAccount(self):
        r"""Trusted service member account information.
        :rtype: :class:`tencentcloud.kms.v20190118.models.MemberAccount`
        """
        return self._MemberAccount
...
class GetServiceStatusResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _ServiceEnabled: <p>Whether the KMS service is enabled. true means enabled</p>
        :type ServiceEnabled: bool
        :param _InvalidType: <p>Service unavailability type: 0-not purchased, 1-normal, 2-service suspended due to overdue payments, 3-resource release</p>
        :type InvalidType: int
        :param _UserLevel: <p>0-Standard Edition, 1-Flagship Edition</p>
        :type UserLevel: int
        :param _ProExpireTime: <p>Expiry time of the flagship edition (Epoch Unix Timestamp).</p>
        :type ProExpireTime: int
        :param _ProRenewFlag: <p>Whether the flagship edition is automatically renewed: 0-no auto-renewal, 1-auto-renewal</p>
        :type ProRenewFlag: int
        :param _ProResourceId: <p>Unique identifier of the flagship edition purchase record. If the flagship edition is not activated, the return value is empty.</p>
        :type ProResourceId: str
        :param _ExclusiveVSMEnabled: <p>Whether to enable managed by KMS</p>
        :type ExclusiveVSMEnabled: bool
        :param _ExclusiveHSMEnabled: <p>Whether to enable KMS exclusive edition</p>
        :type ExclusiveHSMEnabled: bool
        :param _SubscriptionInfo: <p>KMS subscription information.</p>
        :type SubscriptionInfo: str
        :param _CmkUserCount: <p>Return the usage quantity of KMS user secret key</p>
        :type CmkUserCount: int
        :param _CmkLimit: <p>Return the specification quantity of KMS user secret keys</p>
        :type CmkLimit: int
        :param _ExclusiveHSMList: <p>Return the dedicated cluster group</p>
        :type ExclusiveHSMList: list of ExclusiveHSM
        :param _IsAllowedDataKeyHosted: <p>Indicates whether data key management is supported. 1: supported. 0: not supported.</p>
        :type IsAllowedDataKeyHosted: bool
        :param _DataKeyLimit: <p>Valid when IsAllowedDataKeyHosted is 1. Purchase quota of the data key</p>
        :type DataKeyLimit: int
        :param _FreeDataKeyLimit: <p>Valid at that time when IsAllowedDataKeyHosted is 1. Data key free quota.</p>
        :type FreeDataKeyLimit: int
        :param _DataKeyUsedCount: <p>Valid when IsAllowedDataKeyHosted is 1. Number of used data keys.</p>
        :type DataKeyUsedCount: int
        :param _SyncTaskList: <p>Target region info of the sync task</p>
        :type SyncTaskList: list of DestinationSyncConfig
        :param _IsAllowedSync: <p>Whether sync task is supported. true: supported, false: unsupported.</p>
        :type IsAllowedSync: bool
        :param _QpsLimit: <p>QPS in the region</p>
        :type QpsLimit: int
        :param _QpsTotalLimit: <p>Total QPS value</p>
    ...
    @property
    def ServiceEnabled(self):
        r"""<p>Whether the KMS service is enabled. true means enabled</p>
        :rtype: bool
        """
        return self._ServiceEnabled
    ...
    def InvalidType(self):
        r"""<p>Service unavailability type: 0-not purchased, 1-normal, 2-service suspended due to overdue payments, 3-resource release</p>
        :rtype: int
        """
    ...
    @property
    def UserLevel(self):
        r"""<p>0-Standard Edition, 1-Flagship Edition</p>
        :rtype: int
        """
    ...
    def ProExpireTime(self):
        r"""<p>Expiry time of the flagship edition (Epoch Unix Timestamp).</p>
        :rtype: int
        """
    ...
    def ProRenewFlag(self):
        r"""<p>Whether the flagship edition is automatically renewed: 0-no auto-renewal, 1-auto-renewal</p>
        :rtype: int
        """
    ...
    def ProResourceId(self):
        r"""<p>Unique identifier of the flagship edition purchase record. If the flagship edition is not activated, the return value is empty.</p>
        :rtype: str
        """
    ...
    def ExclusiveVSMEnabled(self):
        r"""<p>Whether to enable managed by KMS</p>
        :rtype: bool
        """
    ...
    def ExclusiveHSMEnabled(self):
        r"""<p>Whether to enable KMS exclusive edition</p>
        :rtype: bool
        """
    ...
    def SubscriptionInfo(self):
        r"""<p>KMS subscription information.</p>
        :rtype: str
        """
    ...
    def CmkUserCount(self):
        r"""<p>Return the usage quantity of KMS user secret key</p>
        :rtype: int
        """
    ...
    @property
    def CmkLimit(self):
        r"""<p>Return the specification quantity of KMS user secret keys</p>
        :rtype: int
        """
    ...
    def ExclusiveHSMList(self):
        r"""<p>Return the dedicated cluster group</p>
    ...
    def IsAllowedDataKeyHosted(self):
        r"""<p>Indicates whether data key management is supported. 1: supported. 0: not supported.</p>
        :rtype: bool
        """
    ...
    def DataKeyLimit(self):
        r"""<p>Valid when IsAllowedDataKeyHosted is 1. Purchase quota of the data key</p>
        :rtype: int
        """
    ...
    def FreeDataKeyLimit(self):
        r"""<p>Valid at that time when IsAllowedDataKeyHosted is 1. Data key free quota.</p>
        :rtype: int
        """
    ...
    def DataKeyUsedCount(self):
        r"""<p>Valid when IsAllowedDataKeyHosted is 1. Number of used data keys.</p>
        :rtype: int
        """
    ...
    def SyncTaskList(self):
        r"""<p>Target region info of the sync task</p>
    ...
    def IsAllowedSync(self):
        r"""<p>Whether sync task is supported. true: supported, false: unsupported.</p>
        :rtype: bool
        """
...
class ImportKeyMaterialRequest(AbstractModel):
    ...
    def EncryptedKeyMaterial(self):
        r"""<p>base64-encoded encrypted key material using the PublicKey returned by GetParametersForImport. For KMS in national cryptography version regions, the length requirement for imported key material is 128 bit. For KMS in FIPS 140-2 version regions, the length requirement for imported key material is 256 bit.</p>
        :rtype: str
        """
    ...
    @property
    def ImportToken(self):
        r"""<p>Import token obtained by calling GetParametersForImport.</p>
        :rtype: str
        """
        return self._ImportToken
    ...
    @property
    def KeyId(self):
        r"""<p>The CMK designated for importing key material must be identical to the CMK specified in GetParametersForImport.</p>
        :rtype: str
        """
        return self._KeyId
    ...
    @property
    def ValidTo(self):
        r"""<p>Expiration time of the key material in unix timestamp. If unspecified or 0, the key material does not expire. If specified, the expiration time must be greater than the current time and supports up to 2147443200.</p>
        :rtype: int
        """
...
class KeyMetadata(AbstractModel):
    ...
    @property
    def Alias(self):
        r"""<p>An alias name as a key that is easier to identify and understand</p>
        :rtype: str
        """
        return self._Alias
    ...
    @property
    def KeyState(self):
        r"""<p>CMK state, value: Enabled | Disabled | PendingDelete | PendingImport | Archived</p>
        :rtype: str
        """
        return self._KeyState
    ...
    @property
    def KeyUsage(self):
        r"""<p>CMK purpose. Value: ENCRYPT_DECRYPT | ASYMMETRIC_DECRYPT_RSA_2048 | ASYMMETRIC_DECRYPT_SM2 | ASYMMETRIC_SIGN_VERIFY_SM2 | ASYMMETRIC_SIGN_VERIFY_RSA_2048 | ASYMMETRIC_SIGN_VERIFY_ECC</p>
        :rtype: str
        """
        return self._KeyUsage
    ...
    @property
    def Type(self):
        r"""<p>CMK type. 2 means compliant with FIPS 140-2 standard. 4 means compliant with national cryptography standards.</p><p>Enumeration value:</p><ul><li>2: Complies with FIPS 140-2 standard</li><li>4: Complies with national cryptography standards</li></ul>
        :rtype: int
        """
        return self._Type
    ...
    @property
    def KeyRotationEnabled(self):
        r"""<p>Is key rotation function enabled?</p>
        :rtype: bool
        """
        return self._KeyRotationEnabled
    ...
    @property
    def Owner(self):
        r"""<p>Creator of the CMK. For user-created CMKs, the value is user. For CMKs auto-created by authorized Cloud services, the value is the corresponding product name.</p>
        :rtype: str
        """
        return self._Owner
    ...
    def NextRotateTime(self):
        r"""<p>The time when the next rotation occurs with key rotation enabled</p>
        :rtype: int
        """
    ...
    @property
    def DeletionDate(self):
        r"""<p>The time when schedule deletion</p>
        :rtype: int
        """
        return self._DeletionDate
    ...
    @property
    def Origin(self):
        r"""<p>CMK key material type. TENCENT_KMS for those created by KMS, EXTERNAL for user import.</p>
        :rtype: str
        """
        return self._Origin
    ...
    @property
    def ValidTo(self):
        r"""<p>Valid when Origin is EXTERNAL. Indicates the expiration date of the key material. 0 means never expire.</p>
        :rtype: int
        """
        return self._ValidTo
    ...
    @property
    def ResourceId(self):
        r"""<p>Resource ID, format: creatorUin/$creatorUin/$keyId</p>
        :rtype: str
        """
        return self._ResourceId
    ...
    @property
    def HsmClusterId(self):
        r"""<p>HSM Cluster ID (only applicable to KMS exclusive/managed service instance)</p>
        :rtype: str
        """
        return self._HsmClusterId
    ...
    def LastRotateTime(self):
        r"""<p>Last rotation time (Unix timestamp).</p>
        :rtype: int
        """
    ...
    @property
    def IsSyncReplica(self):
        r"""<p>Whether the key is the primary replica. 0: primary replica, 1: synced replica.</p>
        :rtype: int
        """
        return self._IsSyncReplica
    ...
    @property
    def SyncStatus(self):
        r"""<p>Key synchronization state: 0: unsynced, 1: synced successfully, 2: synchronization failed, 3: syncing.</p>
        :rtype: int
        """
        return self._SyncStatus
    ...
    @property
    def SourceHsmClusterId(self):
        r"""<p>Synchronous original cluster. If empty, it is a public cloud public cluster.</p>
        :rtype: str
        """
        return self._SourceHsmClusterId
...
class MemberAccount(AbstractModel):
    r"""Shared member account information.
