...
Example value: STL.
    ...
    @property
    def File3D(self):
        r"""3D file url address. model file size ≤60 mb. supports fbx, obj, and glb format 3d file input.
        :rtype: str
        """
        return self._File3D
    ...
    @property
    def Format(self):
        r"""Returns the 3D file format. valid values: STL, USDZ, FBX, MP4, GIF.
Recommended input models below 50W, may timeout when selecting USDZ, MP4, or GIF format.
Example value: STL.
        :rtype: str
        """
...
class SubmitHunyuan3DPartJobRequest(AbstractModel):
    ...
    @property
    def File(self):
        r"""Recommends inputting 3D models generated by AIGC. recommended file size ≤100MB. face count ≤1,500,000. only supports FBX format.
        :rtype: :class:`tencentcloud.hunyuan.v20230901.models.InputFile3D`
        """
        return self._File
...
class SubmitHunyuanTo3DRapidJobRequest(AbstractModel):
    ...
    @property
    def Prompt(self):
        r"""Text-To-3D, description of 3D content, forward Prompt content. supports up to 200 utf-8 characters. either ImageBase64, ImageUrl, or Prompt is required, and Prompt cannot coexist with ImageBase64/ImageUrl.	
        :rtype: str
        """
        return self._Prompt
    ...
    @property
    def ImageBase64(self):
        r"""Input image Base64 data. size: unilateral resolution requirement not less than 128, not greater than 5000, size ≤6m (after encoding, size increases by approximately 30%). format: jpg, png, jpeg, webp. imagebase64, imageurl, and Prompt are required, but Prompt and imagebase64/imageurl cannot coexist.	
        :rtype: str
        """
        return self._ImageBase64
    ...
    @property
    def ImageUrl(self):
        r"""Input image Url. size: unilateral resolution requirement not less than 128, not greater than 5000. size ≤8m. format: jpg, png, jpeg, webp. imagebase64, imageurl, and Prompt are required, and Prompt cannot coexist with imagebase64/imageurl.	
        :rtype: str
        """
        return self._ImageUrl
    ...
    def EnableGeometry(self):
        r"""Specifies whether to enable the single geometry generation option. when enabled, it generates a 3D model without textures (white model). enabled, the generative model does not support OBJ format. default model file format is GLB.	
        :rtype: bool
        """
