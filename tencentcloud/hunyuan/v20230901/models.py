...
class DescribeAutoRiggingJobRequest(AbstractModel):
    r"""DescribeAutoRiggingJob request structure.
...
class DescribeAutoRiggingJobResponse(AbstractModel):
    r"""DescribeAutoRiggingJob response structure.
...
DONE: successfu.
        ...
        :param _ErrorMessage: Error message.
        :type ErrorMessage: str
        :param _ResultFile3Ds: Describes the generated 3d file array (valid period: 24 hours).
        :type ResultFile3Ds: list of File3D
        :param _RequestId: The unique request ID, generated by the server, will be returned for every request (if the request fails to reach the server for other reasons, the request will not obtain a RequestId). RequestId is required for locating a problem.
        :type RequestId: str
        """
...
DONE: successfu.
    ...
    @property
    def ResultFile3Ds(self):
        r"""Describes the generated 3d file array (valid period: 24 hours).
        :rtype: list of File3D
        """
        return self._ResultFile3Ds
...
class DescribeConvert3DFormatJobRequest(AbstractModel):
    r"""DescribeConvert3DFormatJob request structure.
...
class DescribeConvert3DFormatJobResponse(AbstractModel):
    r"""DescribeConvert3DFormatJob response structure.
...
class DescribeHunyuanTo3DUVJobRequest(AbstractModel):
    r"""DescribeHunyuanTo3DUVJob request structure.
...
class DescribeHunyuanTo3DUVJobResponse(AbstractModel):
    r"""DescribeHunyuanTo3DUVJob response structure.
...
class File3D(AbstractModel):
    r"""3D model related files, files or textures.
    ...
    @property
    def Type(self):
        r"""3D model or texture. valid values: GIF or OBJ or Image.
        :rtype: str
        """
        return self._Type
...
Example value: RUN
        ...
        :type ResultFile3Ds: list of File3D
        :param _PartSegmentationInfo: Component segmentation data;
...
class QueryHunyuanTo3DTextureEditJobRequest(AbstractModel):
    r"""QueryHunyuanTo3DTextureEditJob request structure.
...
class QueryHunyuanTo3DTextureEditJobResponse(AbstractModel):
    r"""QueryHunyuanTo3DTextureEditJob response structure.
...
Example value: RUN	
        ...
        :param _ErrorMessage: Error message
        :type ErrorMessage: str
        :param _ResultFile3Ds: The URL address for generating texture files is valid for 1 day.
        :type ResultFile3Ds: list of File3D
        :param _RequestId: The unique request ID, generated by the server, will be returned for every request (if the request fails to reach the server for other reasons, the request will not obtain a RequestId). RequestId is required for locating a problem.
        :type RequestId: str
        """
...
Example value: RUN	
    ...
    @property
    def ResultFile3Ds(self):
        r"""The URL address for generating texture files is valid for 1 day.
        :rtype: list of File3D
        """
        return self._ResultFile3Ds
...
class SubmitAutoRiggingJobRequest(AbstractModel):
    r"""SubmitAutoRiggingJob request structure.
    ...
    @property
    def File3D(self):
        r"""<p>3D Character Model File: Generates a 3D character animation based on the provided source model.<br>The character model must be in a standard T-Pose (a standing posture with both arms extended horizontally). You must select exactly one of the following 3D model file options; reference specifications:<br>fbx: 3D model file in FBX format; file size must not exceed 60 MB.<br>obj: 3D model file in OBJ format; file size must not exceed 60 MB.</p>
        :rtype: :class:`tencentcloud.hunyuan.v20230901.models.InputFile3D`
        """
        return self._File3D
    ...
    @property
    def MotionType(self):
        r"""<p>Preset Action Types (Reference Values):</p><ol><li>Roundhouse Kick </li><li>Left Hook </li><li>Charged Attack </li><li>Charged Punch </li><li>Two-Hit Combo </li><li>Two-Hit Combo - 2 </li><li>Backstep </li><li>Hit Reaction </li><li>Hit Reaction - 2 </li><li>Hit Reaction - 3 </li><li>Knockdown - 1 </li><li>Knockdown - 2 </li><li>Landing </li><li>Dejection </li><li>Throat Slash </li><li>Jab </li><li>Continuous Strikes </li><li>Kick </li><li>Side Kick </li><li>Tai Chi </li><li>Backflip </li><li>Crouching Turn </li><li>Walk - 1 </li><li>Walk - 2 </li><li>Walk - 3 </li><li>Idle - 1 </li><li>Idle - 2 </li><li>Street Dance </li><li>The Twist </li><li>Turn Left </li><li>Turn Right </li><li>Jog </li><li>Jog - 2 </li><li>Run </li><li>Sprint - 1 </li><li>Sprint - 2 </li><li>Sprint - 3 </li><li>Jump (In Place) - 1 </li><li>Sliding Tackle </li><li>Long Jump (Forward) </li><li>Long Jump (Forward) - 2 </li><li>Vault </li><li>Intimidation </li><li>Fall Forward </li><li>Turn Right </li><li>Jump (In Place) - 2 </li><li>Turn Around </li><li>Send Shockwave</li></ol>
        :rtype: int
        """
...
class SubmitAutoRiggingJobResponse(AbstractModel):
    r"""SubmitAutoRiggingJob response structure.
...
class SubmitConvert3DFormatJobRequest(AbstractModel):
    r"""SubmitConvert3DFormatJob request structure.
...
Example value: STL.
    ...
    @property
    def File(self):
        r"""3D file URL address. The model file size should be less than 200MB;
Supports 3D file inputs in FBX, OBJ, and GLB formats;
For the OBJ format, a compressed package URL must be uploaded, containing URLs for the obj and mtl 3D model files, as well as texture maps;
It is recommended to upload OBJ models generated by HY-3D.
        :rtype: :class:`tencentcloud.hunyuan.v20230901.models.InputFile3D`
...
class SubmitConvert3DFormatJobResponse(AbstractModel):
    r"""SubmitConvert3DFormatJob response structure.
...
class SubmitHunyuan3DPartJobRequest(AbstractModel):
    ...
    @property
    def File(self):
        r"""<p>Recommends inputting 3D models generated by AIGC Recommended file size not greater than 200MB Face count not greater than 1,500,000 Only supports FBX format</p>
        :rtype: :class:`tencentcloud.hunyuan.v20230901.models.InputFile3D`
        """
        return self._File
    ...
    @property
    def PartSegmentationInfo(self):
        r"""<p>Model component segmentation data; The format is a JSON string, e.g., {"MeshName_part_1":{"face_ids": 1,2,3..],"color":"#FF805C"}}. Here, face_ids is an integer array representing the set of face IDs for the segment, and color specifies the color.</p>
        :rtype: str
        """
        return self._PartSegmentationInfo
    ...
    def EnableStagedGeneration(self):
        r"""<p>Determines whether component generation is performed in a step-by-step manner. When enabled, providing the original model allows for the generation of a model containing segmentation information, along with the corresponding segmentation data. Users can then edit this information before submitting the segmented model and data to proceed with the component generation process. </br>This parameter is disabled by default.</p>
        :rtype: bool
        """
    ...
    def EnablePostProcess(self):
        r"""<p>Whether post-processing is enabled. Once enabled, only one model link will be output, off by default. (After this API is enabled, an additional increase of 20 points is required.)</p>
        :rtype: bool
        """
...
class SubmitHunyuan3DPartJobResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _JobId: <p>Task id (valid period: 24 hours).</p>
        :type JobId: str
        :param _RequestId: The unique request ID, generated by the server, will be returned for every request (if the request fails to reach the server for other reasons, the request will not obtain a RequestId). RequestId is required for locating a problem.
        :type RequestId: str
        """
    ...
    @property
    def JobId(self):
        r"""<p>Task id (valid period: 24 hours).</p>
        :rtype: str
        """
        return self._JobId
...
class SubmitHunyuanTo3DTextureEditJobRequest(AbstractModel):
    r"""SubmitHunyuanTo3DTextureEditJob request structure.
...
Format support: jpg, jpeg, png
        :type Image: :class:`tencentcloud.hunyuan.v20230901.models.ImageInfo`
...
3D model limit: less than 200MB
    ...
    @property
    def Image(self):
        r"""Reference image for 3D model texture editing: Base64 data and image Url
Either Base64 or Url must be provided. if both are provided, Url prevails
Image restrictions: unilateral resolution less than 4096 and greater than 128, converted into Base64 string less than 10MB
Format support: jpg, jpeg, png
        :rtype: :class:`tencentcloud.hunyuan.v20230901.models.ImageInfo`
        """
        return self._Image
    ...
    @property
    def Prompt(self):
        r"""Describes texture editing, forward prompt content
Supports up to 1024 utf-8 characters
Either image or prompt is required, and prompt and image cannot coexist
Example value: a kitten
        :rtype: str
    ...
    @property
    def EnablePBR(self):
        r"""Whether to enable the PBR texture parameter, only supports enabling when entering the Prompt
Example value: true
        :rtype: bool
        """
        return self._EnablePBR
...
class SubmitHunyuanTo3DTextureEditJobResponse(AbstractModel):
    r"""SubmitHunyuanTo3DTextureEditJob response structure.
...
class SubmitHunyuanTo3DUVJobRequest(AbstractModel):
    r"""SubmitHunyuanTo3DUVJob request structure.
...
class SubmitHunyuanTo3DUVJobResponse(AbstractModel):
    r"""SubmitHunyuanTo3DUVJob response structure.
