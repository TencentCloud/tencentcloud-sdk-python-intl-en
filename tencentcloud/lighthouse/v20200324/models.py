...
class DiskConfig(AbstractModel):
    ...
    @property
    def DiskType(self):
        r"""<p>CLOUD disk type. valid values as follows:</p><li>CLOUD_BASIC: ordinary CLOUD disk</li><li>CLOUD_PREMIUM: high-performance CLOUD block storage</li><li>CLOUD_SSD: SSD CLOUD disk</li>.
        :rtype: str
        """
        return self._DiskType
    ...
    def DiskSalesState(self):
        r"""<P>Cloud block storage (cbs) saleable state.</p>.
        :rtype: str
        """
    ...
    def MaxDiskSize(self):
        r"""<p>Maximum CBS size.</p><p>unit: GB</p>.
        :rtype: int
        """
    ...
    def MinDiskSize(self):
        r"""<p>Minimum CBS disk size.</p><p>unit: GB</p>.
        :rtype: int
        """
    ...
    def DiskStepSize(self):
        r"""<p>Cloud block storage (cbs) step length.</p><p>unit: GB</p>.
        :rtype: int
        """
