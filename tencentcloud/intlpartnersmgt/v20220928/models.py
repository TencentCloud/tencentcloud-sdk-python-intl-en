...
class ActionSummaryOverviewItem(AbstractModel):
    r"""Transaction type details in the customer bill data totaled by payment mode
    ...
    def OriginalCost(self):
        r"""Actual total consumption, up to 8 decimal places.
        :rtype: str
        """
    ...
    def VoucherPayAmount(self):
        r"""Voucher payment amount, up to 8 decimal places.
        :rtype: str
        """
    ...
    @property
    def TotalCost(self):
        r"""Total consumption, up to 8 decimal places.
        :rtype: str
        """
...
class AllocateCreditPoolRequest(AbstractModel):
    r"""AllocateCreditPool request structure.
...
class AllocateCreditPoolResponse(AbstractModel):
    r"""AllocateCreditPool response structure.
    ...
    def RemainingCredit(self):
        r"""Current total remaining quota.
        :rtype: float
        """
...
class ApproveClientApplyRequest(AbstractModel):
    r"""ApproveClientApply request structure.
    ...
    def ApproveType(self):
        r"""Approval type. only supports pass and reject.
        :rtype: str
        """
    ...
    def RejectReason(self):
        r"""Reason for rejection. required only when approvetype is reject.
        :rtype: str
        """
...
class ApproveClientApplyResponse(AbstractModel):
    r"""ApproveClientApply response structure.
...
class ApproveSubAgentApplyRequest(AbstractModel):
    r"""ApproveSubAgentApply request structure.
    ...
    @property
    def ApproveType(self):
        r"""Approval type. Only pass and reject are supported.
        :rtype: str
        """
        return self._ApproveType
    ...
    @property
    def RejectReason(self):
        r"""Reason for rejection. Fill in only when ApproveType is reject.
        :rtype: str
        """
        return self._RejectReason
...
class ApproveSubAgentApplyResponse(AbstractModel):
    r"""ApproveSubAgentApply response structure.
...
class BusinessSummaryOverviewItem(AbstractModel):
    r"""Product details in the customer bill data totaled by product
    ...
    @property
    def OriginalCost(self):
        r"""List price, keep 8 decimal places.
        :rtype: str
        """
        return self._OriginalCost
    ...
    @property
    def VoucherPayAmount(self):
        r"""Voucher payment amount, keep 8 decimal places.
        :rtype: str
        """
        return self._VoucherPayAmount
    ...
    @property
    def TotalCost(self):
        r"""Consumption amount, keep 8 decimal places.
        :rtype: str
        """
        return self._TotalCost
...
class CountryCodeItem(AbstractModel):
    r"""Element type of the `GetCountryCodes` API
...
2. Customer name cannot be pure numbers
    ...
    def AccountType(self):
        r"""Account type of a new customer.
Valid values: `personal`, `company`.
        :rtype: str
        """
...
A password must contain numbers, letters, and symbols (!@#$%^&*()). Space is not allowed.
    ...
    def ConfirmPassword(self):
        r"""The confirmed password, which must be the same as that entered in the `Password` field.
        :rtype: str
        """
...
The system will perform binding limit verification of the mobile number you provide, allowing a maximum of 5 accounts per mobile number.
    ...
    def CountryCode(self):
        r"""Customer's country/region code, which can be obtained via the  [GetCountryCodes API](https://www.tencentcloud.com/document/product/1085/51416), such as "852".
Parameter value is not allowed to be 7,380,86.
        :rtype: str
        """
    ...
    @property
    def Area(self):
        r"""Customer's ISO2 standard country/region code, which can be obtained via the [GetCountryCodes API](https://www.tencentcloud.com/document/product/1085/51416). It should correspond to the `CountryCode` field, such as `HK`.
        :rtype: str
        """
        return self._Area
    ...
    @property
    def VerifyCode(self):
        r"""VerifyCode. This parameter is required. 
Use the [SendVerifyCode API](https://www.tencentcloud.com/document/product/1085/65907) to obtain the verifycode.The SendVerifyCode API sends a 6-digit verifycode to your specified mobile number via SMS. After receiving it, you need to pass it along with other parameters.
        :rtype: str
        """
    ...
    @property
    def TradeOne(self):
        r"""Layer-1 industry id. This is a required item and can be obtained via the [ GetTradeConfigList  API](https://www.tencentcloud.com/zh/document/product/1085/68181),
such as "kghy_01".
        :rtype: str
        """
    ...
    @property
    def TradeTwo(self):
        r"""Layer-2 industry id. This is a required item and can be obtained via the [ GetTradeConfigList API](https://www.tencentcloud.com/zh/document/product/1085/68181),
such as "kghy_0101"
        :rtype: str
        """
    ...
    @property
    def Extended(self):
        r"""Extension field, which is left empty by default.
        :rtype: str
        """
    ...
    def CustomerName(self):
        r"""For individual customers, fill in the name. for corporate customers, fill in the full company name.Constraints:
1. Length: 2~200 characters
2. Customer name cannot be pure numbers
        :rtype: str
        """
...
class CreateAndSendClientInvitationMailRequest(AbstractModel):
    r"""CreateAndSendClientInvitationMail request structure.
...
Note: this field takes effect only in the scenario of inviting a second-level reseller.
    ...
    @property
    def Email(self):
        r"""Email address that receives the customer invitation link.
        :rtype: str
        """
        return self._Email
...
SubAgent: second-level reseller.
    ...
    def MaterialUrl(self):
        r"""Specifies the application material.
Note: this field takes effect only in the scenario of inviting a second-level reseller.
        :rtype: str
        """
...
class CreateAndSendClientInvitationMailResponse(AbstractModel):
    r"""CreateAndSendClientInvitationMail response structure.
    ...
    def InvitationLink(self):
        r"""Specifies the invitation link for the customer.
        :rtype: str
        """
...
class DescribeBillDownloadUrlRequest(AbstractModel):
    ...
    @property
    def Month(self):
        r"""The month to which the bill belongs, formatted as YYYY-MM; the earliest month available for query is June, 2022. Current month's billing data may be inaccurate; please download the current month's bill after it is generated at 1:00 on the 5th of the next month.
        :rtype: str
        """
        return self._Month
    ...
    @property
    def FileType(self):
        r"""Type of bill. Valid values: L2 or L3
        :rtype: str
        """
...
class DescribeBillDownloadUrlResponse(AbstractModel):
    ...
    def DownloadUrl(self):
        r"""File download link, with a file validity period of 1 hour
        :rtype: str
        """
    ...
    @property
    def Ready(self):
        r"""File generation status. 0: generating; 1: generated.
        :rtype: int
        """
        return self._Ready
...
class DescribeBillSummaryByPayModeResponse(AbstractModel):
    ...
    def SummaryOverview(self):
        r"""Get the payment mode details of the sub-customer bill summary through the api.
...
class DescribeBillSummaryByProductResponse(AbstractModel):
    ...
    @property
    def SummaryOverview(self):
        r"""Detailed information of product dimension.
...
class DescribeBillSummaryByRegionResponse(AbstractModel):
    ...
    @property
    def SummaryOverview(self):
        r"""Get the region details of the customer bill data totaled by region through the api.
...
class DescribeBillSummaryRequest(AbstractModel):
    ...
    @property
    def Month(self):
        r"""The month to which the bill belongs, formatted as YYYY-MM.
        :rtype: str
        """
        return self._Month
    ...
    @property
    def GroupType(self):
        r"""Billing dimension. Optional parameters: product, project, tag
        :rtype: str
        """
...
class DescribeBillSummaryResponse(AbstractModel):
    ...
    def SummaryDetail(self):
        r"""Detailed summary by billing dimension.
...
class DescribeCustomerBillDetailByDayRequest(AbstractModel):
    r"""DescribeCustomerBillDetailByDay request structure.
...
class DescribeCustomerBillDetailByDayResponse(AbstractModel):
    r"""DescribeCustomerBillDetailByDay response structure.
...
class DescribeCustomerBillDetailRequest(AbstractModel):
    r"""DescribeCustomerBillDetail request structure.
...
class DescribeCustomerBillDetailResponse(AbstractModel):
    r"""DescribeCustomerBillDetail response structure.
...
class DescribeCustomerBillDownloadUrlRequest(AbstractModel):
    r"""DescribeCustomerBillDownloadUrl request structure.
    ...
    @property
    def FileType(self):
        r"""Bill type. valid values: [billResource, billDetail, billResourcePack, billDetailPack]. `billResource`: resource bill; `billDetail`: detailed bill; `billResourcePack`: resource bill package; `billDetailPack`: detailed bill package.
        :rtype: str
        """
        return self._FileType
    ...
    def CustomerUinType(self):
        r"""Customer type. valid values: [Customer, Reseller, ResellerCustomer]. `Customer`: direct customer; `Reseller`: secondary reseller; `ResellerCustomer`: reseller's customers
        :rtype: str
        """
    ...
    def FileLanguage(self):
        r"""Language. valid values: [zh_cn, en]. default is `en` (english).
        :rtype: str
        """
    ...
    @property
    def CustomerUin(self):
        r"""Customer uin. when downloading the bill package (FileType is billResourcePack or billDetailPack), CustomerUin is not passed
        :rtype: int
        """
        return self._CustomerUin
...
class DescribeCustomerBillDownloadUrlResponse(AbstractModel):
    r"""DescribeCustomerBillDownloadUrl response structure.
...
class DescribeCustomerBillSummaryRequest(AbstractModel):
    r"""DescribeCustomerBillSummary request structure.
...
class DescribeCustomerBillSummaryResponse(AbstractModel):
    r"""DescribeCustomerBillSummary response structure.
...
2: mandatory arrears. 
    ...
    @property
    def AuthStatus(self):
        r"""Specifies the identity verification status.
-999: account information not found.
-1: file not uploaded.
0: pending review.
Under review.
...
1: enterprise type.
    ...
    def CidRegisterTime(self):
        r"""Specifies the registration time of the cid.
        :rtype: str
        """
    ...
    def UinRegisterTime(self):
        r"""Specifies the registration time of the uin.
        :rtype: str
        """
    ...
    def AuthPassTime(self):
        r"""Time when real-name authentication passed.
        :rtype: str
        """
    ...
    @property
    def HasExpense(self):
        r"""Whether there is consumption.
0: no consumption; 1: consumption.
        :rtype: int
        """
...
class DescribeCustomerInfoRequest(AbstractModel):
    r"""DescribeCustomerInfo request structure.
    ...
    @property
    def CustomerUin(self):
        r"""List of customer UIN. Array length value: 1-20.
        :rtype: list of int
        """
        return self._CustomerUin
...
class DescribeCustomerInfoResponse(AbstractModel):
    r"""DescribeCustomerInfo response structure.
...
class DescribeCustomerOwnVoucherItem(AbstractModel):
    ...
    def VoucherStatus(self):
        r"""Voucher status: Issued/Used/Expired/Invalidated.
        :rtype: str
        """
    ...
    def PaymentMode(self):
        r"""Payment mode. valid values: AllPayment, Prepaid, and Postpaid.
        :rtype: str
        """
    ...
    def ProductScope(self):
        r"""Applicable product: AllProducts/SpecifyProducts/SpecifyProductsBlacklist.
        :rtype: str
        """
...
class DescribeCustomerOwnVoucherListRequest(AbstractModel):
    r"""DescribeCustomerOwnVoucherList request structure.
    ...
    @property
    def PageSize(self):
        r"""Number of items per page. value range: 1-100.
        :rtype: int
        """
        return self._PageSize
    ...
    @property
    def VoucherStatus(self):
        r"""Voucher status. valid values: Issued, Used, Expired, Invalidated.
        :rtype: str
        """
        return self._VoucherStatus
    ...
    @property
    def PaymentMode(self):
        r"""Payment mode. valid values: AllPayment, Prepaid, Postpaid.
        :rtype: str
        """
        return self._PaymentMode
    ...
    @property
    def ProductScope(self):
        r"""Applicable product. valid values: AllProducts, SpecifyProducts, SpecifyProductsBlacklist.
        :rtype: str
        """
        return self._ProductScope
...
class DescribeCustomerOwnVoucherListResponse(AbstractModel):
    r"""DescribeCustomerOwnVoucherList response structure.
    ...
    @property
    def Data(self):
        r"""Voucher information description.
...
class DescribeCustomerOwnVoucherUsageDetailsRequest(AbstractModel):
    r"""DescribeCustomerOwnVoucherUsageDetails request structure.
    ...
    @property
    def PageSize(self):
        r"""Number of items per page, range 1-100
        :rtype: int
        """
        return self._PageSize
...
class DescribeCustomerOwnVoucherUsageDetailsResponse(AbstractModel):
    r"""DescribeCustomerOwnVoucherUsageDetails response structure.

    """

    def __init__(self):
        r"""
        :param _Data: Voucher information details
        :type Data: list of UsageDetail
        :param _VoucherId: Voucher ID.
        :type VoucherId: int
        :param _TotalAmount: Total voucher amount
        :type TotalAmount: float
        :param _RemainAmount: Voucher balance
        :type RemainAmount: float
        :param _TotalRecordsCount: Total number of records
        :type TotalRecordsCount: int
        :param _Month: Voucher Usage Month
        :type Month: str
        :param _RecordsCountByMonth: Number of records in the current month
        :type RecordsCountByMonth: int
        :param _RequestId: The unique request ID, generated by the server, will be returned for every request (if the request fails to reach the server for other reasons, the request will not obtain a RequestId). RequestId is required for locating a problem.
        :type RequestId: str
        """
        self._Data = None
        ...
        self._TotalRecordsCount = None
        self._Month = None
        self._RecordsCountByMonth = None
        self._RequestId = None

    @property
    def Data(self):
        r"""Voucher information details
    ...
    @property
    def TotalRecordsCount(self):
        r"""Total number of records
        :rtype: int
        """
        return self._TotalRecordsCount

    @TotalRecordsCount.setter
    def TotalRecordsCount(self, TotalRecordsCount):
        self._TotalRecordsCount = TotalRecordsCount
    ...
    @property
    def RecordsCountByMonth(self):
        r"""Number of records in the current month
        :rtype: int
        """
        return self._RecordsCountByMonth

    @RecordsCountByMonth.setter
    def RecordsCountByMonth(self, RecordsCountByMonth):
        self._RecordsCountByMonth = RecordsCountByMonth
    ...
    def _deserialize(self, params):
        ...
        self._TotalRecordsCount = params.get("TotalRecordsCount")
        self._Month = params.get("Month")
        self._RecordsCountByMonth = params.get("RecordsCountByMonth")
        self._RequestId = params.get("RequestId")


class DescribeCustomerUinData(AbstractModel):
    r"""List of customer UINs
    ...
    @property
    def CustomerUin(self):
        r"""Customer UIN Note: This field may return null, indicating that no valid values can be obtained.
        :rtype: str
        """
        return self._CustomerUin
...
class DescribeCustomerUinRequest(AbstractModel):
    r"""DescribeCustomerUin request structure.
...
class DescribeCustomerUinResponse(AbstractModel):
    r"""DescribeCustomerUin response structure.
    ...
    @property
    def Data(self):
        r"""List of customer UINs Note: This field may return null, indicating that no valid values can be obtained.
...
class DescribeCustomerVoucherItem(AbstractModel):
    ...
    @property
    def Usage(self):
        r"""Purpose: ProductTrial/CustomerOffer.
        :rtype: str
        """
        return self._Usage
...
class DescribeCustomerVoucherListRequest(AbstractModel):
    r"""DescribeCustomerVoucherList request structure.
    ...
    @property
    def Usage(self):
        r"""valid values: ProductTrial, CustomerOffer.
        :rtype: str
        """
        return self._Usage
...
class DescribeCustomerVoucherListResponse(AbstractModel):
    r"""DescribeCustomerVoucherList response structure.
...
class DescribeCustomerVoucherUsageDetailsRequest(AbstractModel):
    r"""DescribeCustomerVoucherUsageDetails request structure.
...
class DescribeCustomerVoucherUsageDetailsResponse(AbstractModel):
    r"""DescribeCustomerVoucherUsageDetails response structure.
...
class DescribeRebateDownloadUrlRequest(AbstractModel):
    r"""DescribeRebateDownloadUrl request structure.
    ...
    @property
    def Month(self):
        r"""Month of the commission bill. Format: YYYY-MM.
        :rtype: str
        """
        return self._Month
    ...
    @property
    def FileType(self):
        r"""Bill file type. Valid value: CommissionDetail.
        :rtype: str
        """
        return self._FileType
...
class DescribeRebateDownloadUrlResponse(AbstractModel):
    r"""DescribeRebateDownloadUrl response structure.
...
class ForceQNRequest(AbstractModel):
    ...
    @property
    def Type(self):
        r"""0: Normal  2: Forced service suspension
        :rtype: int
        """
        return self._Type
...
class GetTradeConfigListRequest(AbstractModel):
    r"""GetTradeConfigList request structure.

    """


class GetTradeConfigListResponse(AbstractModel):
    r"""GetTradeConfigList response structure.
...
class ModifyClientRemarkRequest(AbstractModel):
    r"""ModifyClientRemark request structure.
...
class ModifyClientRemarkResponse(AbstractModel):
    r"""ModifyClientRemark response structure.
    ...
    def ClientRemark(self):
        r"""If successful, returns the new customer remarks
        :rtype: str
        """
...
class PayModeSummaryOverviewItem(AbstractModel):
    r"""Payment mode details in the customer bill data totaled by payment mode
    ...
    @property
    def Detail(self):
        r"""Bill details in each payment mode.
...
class PolicyProductList(AbstractModel):
    r"""Policy product list entity response parameters structure.
    ...
    def ProductCode(self):
        r"""The code of the ProductName field in the  bill data. If the return value is *, any item at this level is included in the policy product range.
        :rtype: str
        """
    ...
    @property
    def ProductName(self):
        r"""The ProductName field value in the billing data. If the return value is *, any item at this level is included in the policy product range.
        :rtype: str
        """
        return self._ProductName
    ...
    def SubProductCode(self):
        r"""The code of the SubProduct field in the  bill data. If the return value is *, any item at this level is included in the policy product range.
        :rtype: str
        """
    ...
    @property
    def SubProductName(self):
        r"""The SubProduct field value in the billing data. If the return value is *, any item at this level is included in the policy product range.
        :rtype: str
        """
        return self._SubProductName
    ...
    def ComponentTypeCode(self):
        r"""The code of the ComponentType field in the  bill data. If the return value is *, any item at this level is included in the policy product range.
        :rtype: str
        """
    ...
    def ComponentTypeName(self):
        r"""The ComponentType field value in the billing data. If the return value is *, any item at this level is included in the policy product range.
        :rtype: str
        """
    ...
    def ComponentCode(self):
        r"""The code of the Component field in the  bill data. If the return value is *, any item at this level is included in the policy product range.
        :rtype: str
        """
    ...
    @property
    def ComponentName(self):
        r"""The Component field value in the billing data. If the return value is *, any item at this level is included in the policy product range.
        :rtype: str
        """
        return self._ComponentName
...
class QueryAccountVerificationStatusRequest(AbstractModel):
    r"""QueryAccountVerificationStatus request structure.
...
class QueryAccountVerificationStatusResponse(AbstractModel):
    r"""QueryAccountVerificationStatus response structure.
...
class QueryCreditAllocationHistoryData(AbstractModel):
    r"""Returned information for querying the customer credit allocation records
    ...
    def ClientCreditAfter(self):
        r"""Available credits after allocation.
        :rtype: float
        """
...
class QueryCreditAllocationHistoryResponse(AbstractModel):
    ...
    @property
    def Total(self):
        r"""Total number of historical records.
        :rtype: int
        """
        return self._Total
    ...
    @property
    def History(self):
        r"""Detailed list of historical information.
...
class QueryCreditByUinListRequest(AbstractModel):
    r"""QueryCreditByUinList request structure.
    ...
    @property
    def UinList(self):
        r"""List of user. Array length value: 1-50.
...
class QueryCreditByUinListResponse(AbstractModel):
    r"""QueryCreditByUinList response structure.
...
class QueryCustomerBillingQuotaData(AbstractModel):
    r"""Sub-customer credit balance data
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    @property
    def TotalCredit(self):
        r"""Total credit limit (unit: usd), accurate down to two decimal places.
        :rtype: float
        """
        return self._TotalCredit
    ...
    @property
    def RemainingCredit(self):
        r"""Remaining credit limit (unit: usd), accurate down to two decimal places.
        :rtype: float
        """
        return self._RemainingCredit
    ...
    def RemainingVoucher(self):
        r"""Remaining total voucher amount (unit: usd), accurate down to two decimal places.
        :rtype: float
        """
...
class QueryCustomerBillingQuotaRequest(AbstractModel):
    r"""QueryCustomerBillingQuota request structure.
    ...
    def EventId(self):
        ...
        r"""Event id, used to tag the request event, usually a random number.
        :rtype: int
        """
...
class QueryCustomerBillingQuotaResponse(AbstractModel):
    r"""QueryCustomerBillingQuota response structure.
...
class QueryCustomersCreditData(AbstractModel):
    ...
    @property
    def Credit(self):
        r"""Credit allocated to a customer
        :rtype: float
        """
        return self._Credit
    ...
    @property
    def RemainingCredit(self):
        r"""The remaining credit of a customer
        :rtype: float
        """
        return self._RemainingCredit
...
class QueryCustomersCreditRequest(AbstractModel):
    ...
    @property
    def FilterType(self):
        r"""Search condition type. You can only search by ClientUin, Name, Remark, or Email.
        :rtype: str
        """
...
class QueryDirectCustomersCreditData(AbstractModel):
    r"""The credit information of direct customers
...
class QueryDirectCustomersCreditRequest(AbstractModel):
    r"""QueryDirectCustomersCredit request structure.

    """


class QueryDirectCustomersCreditResponse(AbstractModel):
    r"""QueryDirectCustomersCredit response structure.
    ...
    @property
    def Data(self):
        r"""Direct customer information list
        :rtype: list of QueryDirectCustomersCreditData
        """
        return self._Data
...
2: Sub-Customer.
    ...
    @property
    def CreateTime(self):
        r"""Creation time of the invitation link.
        :rtype: str
        """
...
2: Used.
    ...
    @property
    def UseTime(self):
        r"""Indicates the usage time of the invitation link.
        :rtype: str
        """
...
2: Sub-Customer.
    ...
    @property
    def BindTime(self):
        r"""The binding time of the customer.
        :rtype: str
        """
        return self._BindTime
...
class QueryInvitationInfoRequest(AbstractModel):
    r"""QueryInvitationInfo request structure.
    ...
    @property
    def InvitationToken(self):
        r"""Invite token. array member quantity value: [1, 100].
        :rtype: list of str
        """
        return self._InvitationToken
...
class QueryInvitationInfoResponse(AbstractModel):
    r"""QueryInvitationInfo response structure.
...
class QueryPartnerCreditResponse(AbstractModel):
    ...
    def CustomerTotalCredit(self):
        r"""Allocated quota for the client
        :rtype: float
        """
    ...
    def CustomerRemainingCredit(self):
        r"""Remaining quota for the client
        :rtype: float
        """
...
class QueryPendingClientsV2Request(AbstractModel):
    r"""QueryPendingClientsV2 request structure.
...
class QueryPendingClientsV2Response(AbstractModel):
    r"""QueryPendingClientsV2 response structure.
    ...
    @property
    def Data(self):
        r"""Details of customers in application.
    ...
    @property
    def Total(self):
        r"""Total number of customers in application.
        :rtype: int
        """
        return self._Total
...
class QueryPendingSubAgentsV2Request(AbstractModel):
    r"""QueryPendingSubAgentsV2 request structure.
    ...
    @property
    def PageSize(self):
        r"""Specifies the number of items per page. value range: supports up to 100.
        :rtype: int
        """
        return self._PageSize
...
class QueryPendingSubAgentsV2Response(AbstractModel):
    r"""QueryPendingSubAgentsV2 response structure.
    ...
    @property
    def Data(self):
        r"""Application in progress second-level reseller information.
    ...
    @property
    def Total(self):
        r"""Number of second-level resellers in application.
        :rtype: int
        """
        return self._Total
...
class QueryPendingSubAgentsV2ResponseData(AbstractModel):
    r"""Information of second-level reseller application in progress.
...
{Reviewing: pending review}.
    ...
    @property
    def AuthState(self):
        r"""Identity verification status -1: file not uploaded 0: pending review 1: under review; 2: review error; 3: approved.
        :rtype: int
        """
...
class QueryPolicyProductListByCodeRequest(AbstractModel):
    r"""QueryPolicyProductListByCode request structure.
    ...
    @property
    def ProductCode(self):
        r"""The code of the ProductName field in the  bill data.
        :rtype: str
        """
        return self._ProductCode
    ...
    @property
    def ProductName(self):
        r"""The ProductName field value in the billing data.
        :rtype: str
        """
        return self._ProductName
    ...
    @property
    def SubProductCode(self):
        r"""The code of the SubProductName field in the  bill data.
        :rtype: str
        """
        return self._SubProductCode
    ...
    @property
    def SubProductName(self):
        r"""The SubProductName field value in the billing data.
        :rtype: str
        """
        return self._SubProductName
    ...
    @property
    def PageSize(self):
        r"""Page parameter: Indicates the number of entries per page. Value range: [1, 200], default is 200.
        :rtype: int
        """
        return self._PageSize
...
class QueryPolicyProductListByCodeResponse(AbstractModel):
    r"""QueryPolicyProductListByCode response structure.
...
class QuerySubAgentsDetailV2Request(AbstractModel):
    r"""QuerySubAgentsDetailV2 request structure.
...
acs: ascending.
    ...
    @property
    def PageSize(self):
        r"""Number of items per page. supports up to 100.
        :rtype: int
        """
        return self._PageSize
    ...
    @property
    def FilterType(self):
        r"""Filter criteria, support the following filter parameters.
Note: Email, SubAgentUin, and ClientUin only support exact search. other conditions support fuzzy retrieval.The following are the definitions of filtering  items:
...
ClientUin: specifies the Indirect customer uin.
    ...
    @property
    def Order(self):
        r"""Sorting method. sorts by binding time in ascending or descending order. defaults to descending order if not specified.
Desc: descending order.
acs: ascending.
        :rtype: str
        """
...
class QuerySubAgentsDetailV2Response(AbstractModel):
    r"""QuerySubAgentsDetailV2 response structure.
    ...
    @property
    def Total(self):
        r"""Number of second-level resellers.
        :rtype: int
        """
        return self._Total
    ...
    @property
    def Data(self):
        r"""Second-Level reseller information.
...
class QuerySubAgentsDetailV2ResponseData(AbstractModel):
    ...
    def CountOfCustomers(self):
        r"""Number of secondary dealer sub-customers.
        :rtype: int
        """
    ...
    @property
    def Credit(self):
        r"""Credit limit pool of second-level reseller.
        :rtype: float
        """
        return self._Credit
    ...
    @property
    def RemainingCredit(self):
        r"""Value pool of unconsumed credit limit for second-level reseller.
        :rtype: float
        """
        return self._RemainingCredit
    ...
    @property
    def Voucher(self):
        r"""Cash coupon quota pool for second-level reseller.
        :rtype: float
        """
    ...
    @property
    def RemainingVoucher(self):
        r"""Balance of cash coupon quota pool for second-level reseller.
        :rtype: float
        """
        return self._RemainingVoucher
...
class QueryT1IndirectCustomersDetailRequest(AbstractModel):
    r"""QueryT1IndirectCustomersDetail request structure.
    ...
    @property
    def Page(self):
        r"""Pagination parameter: current page number. it starts from 1.
        :rtype: int
        """
        return self._Page
    ...
    @property
    def PageSize(self):
        r"""Pagination parameter, indicates the number of entries per page. supports [1, 100] data entries per request.
        :rtype: int
        """
        return self._PageSize
...
class QueryT1IndirectCustomersDetailResponse(AbstractModel):
    r"""QueryT1IndirectCustomersDetail response structure.
    ...
    @property
    def Total(self):
        r"""The number of indirect sub-customers of a distributor.
        :rtype: int
        """
        return self._Total
    ...
    @property
    def Data(self):
        r"""Indirect sub-customer information.
...
class QueryT1IndirectCustomersDetailResponseData(AbstractModel):
    r"""Query data of indirect sub-customers of a first-level distributor.
    ...
    def ClientBindTime(self):
        r"""The time when a sub-customer binds a second-level reseller, time zone: UTC+08:00.
        :rtype: str
        """
...
class QueryVoucherAmountByUinRequest(AbstractModel):
    r"""QueryVoucherAmountByUin request structure.
    ...
    @property
    def ClientUins(self):
        r"""Customer UIN list. Array length value: 1-20.
        :rtype: list of int non-negative
        """
...
class QueryVoucherAmountByUinResponse(AbstractModel):
    r"""QueryVoucherAmountByUin response structure.
    ...
    @property
    def Data(self):
        r"""Customer voucher quota information
...
class QueryVoucherListByUinItem(AbstractModel):
    r"""Voucher information of a single customer
...
class QueryVoucherListByUinRequest(AbstractModel):
    r"""QueryVoucherListByUin request structure.
    ...
    @property
    def Status(self):
        r"""Voucher status. If this parameter is not passed in, all status will be queried by default. Valid values: `Unused`, `Used`, `Expired`.
        :rtype: str
        """
        return self._Status
...
class QueryVoucherListByUinResponse(AbstractModel):
    r"""QueryVoucherListByUin response structure.
    ...
    @property
    def Data(self):
        r"""Customer voucher information
...
class QueryVoucherPoolRequest(AbstractModel):
    r"""QueryVoucherPool request structure.

    """


class QueryVoucherPoolResponse(AbstractModel):
    r"""QueryVoucherPool response structure.
    ...
    @property
    def AccountType(self):
        r"""Reseller role type (1: Reseller; 2: Distributor; 3: Second-level reseller)
        :rtype: int
        """
        return self._AccountType
    ...
    @property
    def IssuedNum(self):
        r"""The number of issued vouchers
        :rtype: int
        """
...
class RegionSummaryOverviewItem(AbstractModel):
    r"""Region details in the customer bill data totaled by region
...
class SendVerifyCodeRequest(AbstractModel):
    r"""SendVerifyCode request structure.
...
class SendVerifyCodeResponse(AbstractModel):
    r"""SendVerifyCode response structure.
...
class SummaryDetails(AbstractModel):
    ...
    @property
    def GroupKey(self):
        r"""Classification dimension summary key.
        :rtype: str
        """
    ...
    @property
    def GroupValue(self):
        r"""Summary value by classification dimension.
        :rtype: str
        """
...
class TradeOneNode(AbstractModel):
    r"""Primary Industry Information
    ...
    @property
    def Children(self):
        r"""Layer-2 industries corresponding to the layer-1 industry.
...
class TradeTwoNode(AbstractModel):
    r"""Secondary Industry Information
...
class UsageDetail(AbstractModel):
    ...
    def SubProductCodeName(self):
        r"""Subproduct name of the order
        :rtype: str
        """
