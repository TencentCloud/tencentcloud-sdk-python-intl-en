...
Note: this field may return null, indicating that no valid values can be obtained.
        ...
        :param _Tags: List of tags associated with the policy
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    @property
    def Tags(self):
        r"""List of tags associated with the policy
        :rtype: list of Tag
        """
        return self._Tags
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    def MinimumLength(self):
        r"""Minimum length required for the password.
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    def MustContain(self):
        r"""Types of characters the password must contain. 
A: Must contain uppercase letter
a: Must contain lowercase letter
1: Must contain number
!: Must contain special character
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    def ForcePasswordChange(self):
        r"""Password validity period in days, after which the password must be reset. 0 (no expiration)
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    def RetryPasswordLimit(self):
        r"""Maximum number of failed login attempts allowed within a one hour window.
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    def PasswordExpirationInvalidation(self):
        r"""Indicates whether a user can reset their own password after it has expired. 
1: Yes, 2: No (Yes: After password expiration, sub-users are unable to log in and require administrator reset. No: After password expiration, sub-users can log in and are forced to change password based on old password.)
...
class UpdatePasswordRulesRequest(AbstractModel):
    r"""UpdatePasswordRules request structure.
...
class UpdatePasswordRulesResponse(AbstractModel):
    r"""UpdatePasswordRules response structure.
