...
class TextTranslateRequest(AbstractModel):
    r"""TextTranslate request structure.
...
<li>hi (Hindi): en (English)</li>
    ...
    @property
    def SourceText(self):
        r"""The texts to be translated, which must be encoded in UTF-8 and can contain up to 2,000 characters in a request. For non-pure texts such as those with HTML tags, the translation may fail.
        :rtype: str
        """
...
hi: Hindi
    ...
    @property
    def Target(self):
        r"""Supported target languages for the above source languages:
...
<li>hi (Hindi): en (English)</li>
    ...
    @property
    def ProjectId(self):
        r"""The project ID, which can be obtained from **Console -> Account Center -> Project Management**. If no one is set, enter the default project ID `0`.
        :rtype: int
        """
    ...
    def UntranslatedText(self):
        r"""The parameter used to mark the text content that needs to remain untranslated, such as special symbols and names of people and places. You can set only one word for this parameter in each request. Only nouns (like names of people and places) are supported, and verbs or phrases may cause poor translation outcomes.
        :rtype: str
        """
...
class TextTranslateResponse(AbstractModel):
    r"""TextTranslate response structure.
    ...
    @property
    def Source(self):
        r"""The source language. See the request parameter `Source` for details.
        :rtype: str
        """
        return self._Source
    ...
    @property
    def Target(self):
        r"""The target language. See the request parameter `Target` for details.
        :rtype: str
        """
        return self._Target
