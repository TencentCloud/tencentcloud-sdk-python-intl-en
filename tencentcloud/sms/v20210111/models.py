...
class AddSmsSignRequest(AbstractModel):
    r"""AddSmsSign request structure.
...
Note: you cannot apply for an approved or pending signature again.
    ...
    @property
    def SignType(self):
        r"""Signature type. Each of these types is followed by their `DocumentType` (identity certificate type) option:
0: company. Valid values of `DocumentType` include 0 and 1.
1: app. Valid values of `DocumentType` include 0, 1, 2, 3, and 4.
2: website. Valid values of `DocumentType` include 0, 1, 2, 3, and 5.
3: WeChat Official Account. Valid values of `DocumentType` include 0, 1, 2, 3, and 8.
...
1: for others.
    ...
    @property
    def ProofImage(self):
        r"""You should Base64-encode the image of the identity certificate corresponding to the signature first, remove the prefix `data:image/jpeg;base64,` from the resulted string, and then use it as the value of this parameter.
        :rtype: str
        """
    ...
    def CommissionImage(self):
        r"""Power of attorney, which should be submitted if `SignPurpose` is for use by others.
You should Base64-encode the image first, remove the prefix `data:image/jpeg;base64,` from the resulted string, and then use it as the value of this parameter.
Note: this field will take effect only when `SignPurpose` is 1 (for user by others).
        :rtype: str
        """
    ...
    @property
    def Remark(self):
        r"""Signature application remarks.
        :rtype: str
        """
        return self._Remark
...
class AddSmsSignResponse(AbstractModel):
    r"""AddSmsSign response structure.
...
class AddSmsTemplateRequest(AbstractModel):
    r"""AddSmsTemplate request structure.
...
1: Global SMS.
    ...
    @property
    def SmsType(self):
        r"""SMS type. 1: Marketing SMS, 2: Notification SMS, 3: OTP SMS.
Note: To further improve the quality of SMS service and increase the approval rate of SMS templates, Tencent Cloud SMS template types will be optimized to "OTP", "Notification", and "Marketing" from May 16, 2024. You can Refer to [Optimization of Tencent Cloud SMS Template Types](https://www.tencentcloud.com/document/product/382/60410). Customers who newly register for SMS service must strictly refer to the new SMS type to apply for SMS template.
        :rtype: int
        """
...
1: Global SMS.
    ...
    @property
    def Remark(self):
        r"""Template remarks, such as reason for application and use case.
        :rtype: str
        """
        return self._Remark
...
class AddSmsTemplateResponse(AbstractModel):
    r"""AddSmsTemplate response structure.
    ...
    def AddTemplateStatus(self):
        r"""SMS template addition response body
...
class AddTemplateStatus(AbstractModel):
    r"""Template parameter addition response
...
class CallbackStatusStatistics(AbstractModel):
    r"""Receipt statistics response body
    ...
    def RequestSuccessCount(self):
        r"""Successfully submitted SMS messages.
        :rtype: int
        """
    ...
    def ShutdownErrorCount(self):
        r"""Errors such as out-of-service or power-off.
        :rtype: int
        """
...
class CallbackStatusStatisticsRequest(AbstractModel):
    r"""CallbackStatusStatistics request structure.
...
Note: `EndTime` must be after `BeginTime`, and the difference should not exceed 32 days.
    ...
    def SmsSdkAppId(self):
        r"""The SMS `SdkAppId` generated after an application is added in the [SMS console](https://console.cloud.tencent.com/smsv2/app-manage), such as 1400006666.
        :rtype: str
        """
...
class CallbackStatusStatisticsResponse(AbstractModel):
    r"""CallbackStatusStatistics response structure.
...
class DeleteSignStatus(AbstractModel):
    ...
    @property
    def DeleteTime(self):
        r"""Deleted time in seconds in the format of UNIX timestamp.
        :rtype: int
        """
...
class DeleteSmsSignRequest(AbstractModel):
    r"""DeleteSmsSign request structure.
    ...
    @property
    def SignId(self):
        r"""ID of the signature to be deleted.
        :rtype: int
        """
        return self._SignId
...
class DeleteSmsSignResponse(AbstractModel):
    r"""DeleteSmsSign response structure.
...
class DeleteSmsTemplateRequest(AbstractModel):
    r"""DeleteSmsTemplate request structure.
    ...
    @property
    def TemplateId(self):
        r"""ID of the template to be deleted.
        :rtype: int
        """
        return self._TemplateId
...
class DeleteSmsTemplateResponse(AbstractModel):
    r"""DeleteSmsTemplate response structure.
...
class DescribePhoneNumberInfoRequest(AbstractModel):
    r"""DescribePhoneNumberInfo request structure.
...
Take the number +8613711112222 as an example. “86” is the country code (with a “+” sign in its front) and “13711112222” is the subscriber number.
    ...
    def PhoneNumberSet(self):
        r"""A parameter used to query mobile numbers in E.164 format (+[country/region code][subscriber number]). Up to 200 mobile numbers can be queried at a time.
Take the number +8613711112222 as an example. “86” is the country code (with a “+” sign in its front) and “13711112222” is the subscriber number.
        :rtype: list of str
        """
...
class DescribePhoneNumberInfoResponse(AbstractModel):
    r"""DescribePhoneNumberInfo response structure.
    ...
    def PhoneNumberInfoSet(self):
        r"""A parameter used to obtain mobile number information.
...
class DescribeSignListStatus(AbstractModel):
    r"""Response for getting SMS signature information
...
-1: application rejected or failed.
    ...
    @property
    def International(self):
        r"""Whether it is Global SMS. 0: Mainland China SMS; 1: Global SMS.
        :rtype: int
        """
        return self._International
    ...
    @property
    def StatusCode(self):
        r"""Signature application status. Valid values: 0: approved; 1: under review.
-1: application rejected or failed.
        :rtype: int
        """
    ...
    def ReviewReply(self):
        r"""Review reply, i.e., response given by the reviewer, which is usually the reason for rejection.
        :rtype: str
        """
    ...
    @property
    def CreateTime(self):
        r"""Application submission time in the format of UNIX timestamp in seconds.
        :rtype: int
        """
...
class DescribeSmsSignListRequest(AbstractModel):
    r"""DescribeSmsSignList request structure.
...
class DescribeSmsSignListResponse(AbstractModel):
    r"""DescribeSmsSignList response structure.
    ...
    def DescribeSignListStatusSet(self):
        r"""Response for getting signature information
...
class DescribeSmsTemplateListRequest(AbstractModel):
    r"""DescribeSmsTemplateList request structure.
...
1: Global SMS.
    ...
    def TemplateIdSet(self):
        r"""Array of template IDs. If the array is empty, the template list information will be queried by default. You need to use the `Limit` and `Offset` fields to set the query range.
<dx-alert infotype="notice" title="Note">The max array length is 100 by default.</dx-alert>
        :rtype: list of int non-negative
        """
...
class DescribeSmsTemplateListResponse(AbstractModel):
    r"""DescribeSmsTemplateList response structure.
    ...
    def DescribeTemplateStatusSet(self):
        r"""Response for getting SMS template information
...
class DescribeTemplateListStatus(AbstractModel):
    ...
    @property
    def StatusCode(self):
        r"""Template application status. Valid values: 0: approved and effective; 1: under review; 2: approved but to be effective; -1: application rejected or failed.
        :rtype: int
        """
        return self._StatusCode
...
class ModifySignStatus(AbstractModel):
    r"""Signature modification response
...
class ModifySmsSignRequest(AbstractModel):
    r"""ModifySmsSign request structure.
...
Note: this field will take effect only when `SignPurpose` is 1 (for user by others).
    ...
    @property
    def SignId(self):
        r"""ID of the signature to be modified.
        :rtype: int
        """
        return self._SignId
...
8: screenshot of WeChat Official Account settings page (for personal WeChat Official Account).
    ...
    @property
    def International(self):
        r"""A parameter used to specify whether it is Global SMS:
`0`: Chinese mainland SMS.
`1`: Global SMS.
Note: the value of this parameter must be consistent with the `International` value of the signature to be modified. This parameter cannot be used to directly change a Chinese mainland signature to an international signature.
        :rtype: int
...
class ModifySmsSignResponse(AbstractModel):
    r"""ModifySmsSign response structure.
...
class ModifySmsTemplateRequest(AbstractModel):
    r"""ModifySmsTemplate request structure.
...
1: Global SMS.
    ...
    @property
    def TemplateId(self):
        r"""ID of the template to be modified.
        :rtype: int
        """
        return self._TemplateId
...
class ModifySmsTemplateResponse(AbstractModel):
    r"""ModifySmsTemplate response structure.
    ...
    def ModifyTemplateStatus(self):
        r"""Template parameter modification response
...
class PhoneNumberInfo(AbstractModel):
    ...
    @property
    def Code(self):
        r"""Error code for mobile number information query. `Ok` will be returned if the query is successful.
        :rtype: str
        """
        return self._Code
    ...
    @property
    def Message(self):
        r"""Description of the error code for mobile number information query.
        :rtype: str
        """
    ...
    def SubscriberNumber(self):
        r"""Subscriber number in normal format such as 13711112222, without any prefix (country or region code).
        :rtype: str
        """
    ...
    def PhoneNumber(self):
        r"""The standardized mobile number in E.164 format after parsing, which is consistent with the parsed number for SMS message delivery. If the parsing fails, the original number will be returned.
        :rtype: str
        """
    ...
    @property
    def IsoCode(self):
        r"""Country or region code such as CN and US. If the country or region code cannot be identified, `DEF` will be returned by default.
        :rtype: str
        """
...
class PullSmsReplyStatus(AbstractModel):
    ...
    @property
    def ExtendCode(self):
        r"""SMS code number extension, which is not activated by default. If you need to activate it, please contact [SMS Helper](https://intl.cloud.tencent.com/document/product/382/3773?from_cn_redirect=1#.E6.8A.80.E6.9C.AF.E4.BA.A4.E6.B5.81).
        :rtype: str
        """
    ...
    @property
    def ReplyTime(self):
        r"""Reply time in seconds in the format of UNIX timestamp.
        :rtype: int
        """
    ...
    @property
    def SubscriberNumber(self):
        r"""User's mobile number in a common format such as 13711112222.
        :rtype: str
        """
        return self._SubscriberNumber
...
class PullSmsReplyStatusByPhoneNumberRequest(AbstractModel):
    r"""PullSmsReplyStatusByPhoneNumber request structure.
...
Note: this parameter is currently fixed at 0.
    ...
    @property
    def BeginTime(self):
        r"""Pull start time in seconds in the format of UNIX timestamp.
Note: the data for the last 7 days can be pulled at most.
        :rtype: int
        """
        return self._BeginTime
...
Note: this parameter is currently fixed at 0.
    ...
    @property
    def PhoneNumber(self):
        r"""Target mobile number in the E.164 standard (+[country/region code][mobile number]), such as +8613711112222, which has a + sign followed by 86 (country/region code) and then by 13711112222 (mobile number).
        :rtype: str
        """
        return self._PhoneNumber
    ...
    @property
    def EndTime(self):
        r"""Pull end time in seconds in the format of UNIX timestamp.
        :rtype: int
        """
        return self._EndTime
...
class PullSmsReplyStatusByPhoneNumberResponse(AbstractModel):
    r"""PullSmsReplyStatusByPhoneNumber response structure.
...
class PullSmsReplyStatusRequest(AbstractModel):
    r"""PullSmsReplyStatus request structure.
...
class PullSmsReplyStatusResponse(AbstractModel):
    r"""PullSmsReplyStatus response structure.
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    def UserReceiveTime(self):
        r"""Actual time of SMS receipt by user in seconds in the format of UNIX timestamp.
        :rtype: int
        """
    ...
    def ReportStatus(self):
        r"""Whether the SMS message is actually received. Valid values: SUCCESS (success), FAIL (failure).
        :rtype: str
        """
    ...
    def Description(self):
        r"""Description of SMS receipt by user.
        :rtype: str
        """
    ...
    def SessionContext(self):
        r"""User session content, which is the same as the `SessionContext` in the request and is empty by default. If you need to activate it, contact [SMS Helper](https://intl.cloud.tencent.com/document/product/382/3773?from_cn_redirect=1#.E6.8A.80.E6.9C.AF.E4.BA.A4.E6.B5.81).
Note: This field may return null, indicating that no valid values can be obtained.
        :rtype: str
        """
...
class PullSmsSendStatusByPhoneNumberRequest(AbstractModel):
    r"""PullSmsSendStatusByPhoneNumber request structure.
...
class PullSmsSendStatusByPhoneNumberResponse(AbstractModel):
    r"""PullSmsSendStatusByPhoneNumber response structure.
    ...
    def PullSmsSendStatusSet(self):
        r"""Delivery status response set.
...
class PullSmsSendStatusRequest(AbstractModel):
    r"""PullSmsSendStatus request structure.
...
class PullSmsSendStatusResponse(AbstractModel):
    r"""PullSmsSendStatus response structure.
...
class ReportConversionRequest(AbstractModel):
    r"""ReportConversion request structure.
    ...
    @property
    def SmsSdkAppId(self):
        r"""The SMS SdkAppId generated after an application is created in the [SMS console](https://console.cloud.tencent.com/smsv2/app-manage), such as “1400006666”.
        :rtype: str
        """
        return self._SmsSdkAppId
    ...
    @property
    def SerialNo(self):
        r"""The serial number returned for a message sent.
        :rtype: str
        """
        return self._SerialNo
    ...
    def ConversionTime(self):
        r"""The recipient’s reply time in seconds in the format of UNIX timestamp.
        :rtype: int
        """
...
class ReportConversionResponse(AbstractModel):
    r"""ReportConversion response structure.
    ...
    def ReportConversionStatus(self):
        r"""Response packet for conversion rate reporting.
...
class ReportConversionStatus(AbstractModel):
    r"""Response for conversion rate reporting
    ...
    @property
    def Code(self):
        r"""Error code. `ok` is returned if the conversion rate is successfully reported.
        :rtype: str
        """
        return self._Code
...
Note: If your monthly usage reaches the specified threshold, you can apply for an independent `SenderId`. For more information, contact [SMS Helper](https://intl.cloud.tencent.com/document/product/382/3773?from_cn_redirect=1#.E6.8A.80.E6.9C.AF.E4.BA.A4.E6.B5.81).
    ...
    @property
    def SignName(self):
        r"""SMS signature information which is encoded in UTF-8. You must enter an approved signature (such as Tencent Cloud). The signing information can be viewed on the **Signatures** page in [Global SMS](https://console.cloud.tencent.com/smsv2/isms-sign).
        :rtype: str
        """
        return self._SignName
...
<dx-alert infotype="notice" title="Note">The number of template parameters should be consistent with that of the template variables of `TemplateId`.</dx-alert>
    ...
    @property
    def ExtendCode(self):
        r"""SMS code number extension, which is not activated by default. If you need to activate it, you can contact [SMS Helper](https://intl.cloud.tencent.com/document/product/382/3773?from_cn_redirect=1#.E6.8A.80.E6.9C.AF.E4.BA.A4.E6.B5.81).
        :rtype: str
        """
        return self._ExtendCode
    ...
    @property
    def SenderId(self):
        r"""For Global SMS, if you have applied for a separate `SenderId`, this parameter is required. By default, the public `SenderId` is used, in which case you don't need to enter this parameter.
Note: If your monthly usage reaches the specified threshold, you can apply for an independent `SenderId`. For more information, contact [SMS Helper](https://intl.cloud.tencent.com/document/product/382/3773?from_cn_redirect=1#.E6.8A.80.E6.9C.AF.E4.BA.A4.E6.B5.81).
        :rtype: str
        """
...
class SendStatusStatistics(AbstractModel):
    r"""Delivery statistics response body
    ...
    @property
    def FeeCount(self):
        r"""Billable SMS message quantity; for example, in 100 successfully submitted SMS messages, if 20 ones are long messages (over 80 characters) and split into two messages each, then the billable quantity will be 80 * 1 + 20 * 2 = 120.
        :rtype: int
        """
...
class SendStatusStatisticsRequest(AbstractModel):
    r"""SendStatusStatistics request structure.
...
class SendStatusStatisticsResponse(AbstractModel):
    r"""SendStatusStatistics response structure.
