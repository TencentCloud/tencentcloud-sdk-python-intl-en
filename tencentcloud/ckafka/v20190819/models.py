...
class CreateTopicRequest(AbstractModel):
    ...
    @property
    def UncleanLeaderElectionEnable(self):
        r"""<p>Whether to allow unsynchronized replicas to be elected as leader, 0: not allowed, 1: allowed, default not allowed</p>
        :rtype: int
        """
        return self._UncleanLeaderElectionEnable
...
class InstanceAttributesResponse(AbstractModel):
    ...
    @property
    def RetentionBytes(self):
        r"""<p>Message retention size at the instance level</p>Measurement unit: bytes<br>Default value: -1
        :rtype: int
        """
        return self._RetentionBytes
    ...
    def TransactionalIdExpirationMs(self):
        r"""<p>The maximum idle time of a transaction ID. Uncommitted transactions that time out will be marked with expiration.</p>Unit: ms
        :rtype: int
        """
