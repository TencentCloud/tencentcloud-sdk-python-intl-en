...
class AppIdResponse(AbstractModel):
    ...
    @property
    def AppIdList(self):
        r"""Specifies the App Id list that meets the requirements.
        :rtype: list of int
        """
...
class ZoneResponse(AbstractModel):
    ...
    def ClusterInfo(self):
        r"""Specifies the user-exclusive cluster info.
    ...
    @property
    def Standard(self):
        r"""Purchase the standard version configuration.
        :rtype: str
        """
    ...
    @property
    def StandardS2(self):
        r"""Purchase the standard version S2 configuration.
        :rtype: str
        """
    ...
    @property
    def Profession(self):
        r"""Specifies the configuration for purchasing the professional edition.
        :rtype: str
        """
    ...
    @property
    def Physical(self):
        r"""Purchase physical dedicated edition configuration.
        :rtype: str
        """
    ...
    @property
    def PublicNetwork(self):
        r"""Public network bandwidth. minimum 3 Mbps. maximum 999 Mbps. only the pro edition supports filling in. abandoned, meaningless.
        :rtype: str
        """
        return self._PublicNetwork
    ...
    def PublicNetworkLimit(self):
        r"""Configures the public network bandwidth.
        :rtype: str
        """
