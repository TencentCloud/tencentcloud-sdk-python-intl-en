...
class CreateIAPUserOIDCConfigRequest(AbstractModel):
    r"""CreateIAPUserOIDCConfig request structure.
    ...
    def IdentityUrl(self):
        r"""OpenID Connect IdP URL. It corresponds to the value of the "issuer" field in the Openid-configuration provided by the enterprise IdP.
        :rtype: str
        """
...
class CreateIAPUserOIDCConfigResponse(AbstractModel):
    r"""CreateIAPUserOIDCConfig response structure.
...
class DescribeIAPLoginSessionDurationRequest(AbstractModel):
    r"""DescribeIAPLoginSessionDuration request structure.

    """


class DescribeIAPLoginSessionDurationResponse(AbstractModel):
    r"""DescribeIAPLoginSessionDuration response structure.
...
class DescribeIAPUserOIDCConfigRequest(AbstractModel):
    r"""DescribeIAPUserOIDCConfig request structure.

    """


class DescribeIAPUserOIDCConfigResponse(AbstractModel):
    r"""DescribeIAPUserOIDCConfig response structure.
    ...
    def ProviderType(self):
        r"""IdP type. 13: IAP user OIDC IdP.
        :rtype: int
        """
    ...
    def Fingerprints(self):
        r"""The verification fingerprint of the HTTPS CA certificate. English letters and digits are allowed, and each fingerprint is 40 characters long, with a maximum of 5 fingerprints.
        :rtype: list of str
        """
    ...
    def EnableAutoPublicKey(self):
        r"""Whether to enable the automatic use of the OIDC signature public key. 1: Yes, 2: No (default).
        :rtype: int
        """
...
class DisableIAPUserSSORequest(AbstractModel):
    r"""DisableIAPUserSSO request structure.

    """


class DisableIAPUserSSOResponse(AbstractModel):
    r"""DisableIAPUserSSO response structure.
...
class ModifyIAPLoginSessionDurationRequest(AbstractModel):
    r"""ModifyIAPLoginSessionDuration request structure.
...
class ModifyIAPLoginSessionDurationResponse(AbstractModel):
    r"""ModifyIAPLoginSessionDuration response structure.
...
class UpdateIAPUserOIDCConfigRequest(AbstractModel):
    r"""UpdateIAPUserOIDCConfig request structure.
    ...
    @property
    def IdentityKey(self):
        r"""RSA signature public key in the JWKS format, which is used to verify the OpenID Connect IdP's ID token and must be Base64-encoded. For the security of your account, we recommend you rotate it regularly.
        :rtype: str
        """
        return self._IdentityKey
    ...
    @property
    def Description(self):
        r"""Description, with a length of 1 to 255 English or Chinese characters. It is empty by default.
        :rtype: str
        """
        return self._Description
...
class UpdateIAPUserOIDCConfigResponse(AbstractModel):
    r"""UpdateIAPUserOIDCConfig response structure.
