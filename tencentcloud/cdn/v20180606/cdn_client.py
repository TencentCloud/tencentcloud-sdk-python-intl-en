...
class CdnClient(AbstractClient):
    ...
    def DescribeUrlViolations(self, request):
        r"""This API is used to query the URL list with domain violations detected by the CDN system scan and their status.
    ...
    def DuplicateDomainConfig(self, request):
        r"""This API is used to copy the configuration of a reference domain to a new domain name. Self-owned certificates and customization options are not currently supported.
    ...
    def ModifyDomainConfig(self, request):
        r"""This API is used to modify the configuration of a CDN acceleration domain name.
    ...
    def PushUrlsCache(self, request):
        r"""This API is used to load a list of specified URL resources to CDN nodes and supports preheating in designated acceleration regions.
    ...
    def UpdateDomainConfig(self, request):
        r"""This API is used to modify the configuration message of a CDN acceleration domain name.
