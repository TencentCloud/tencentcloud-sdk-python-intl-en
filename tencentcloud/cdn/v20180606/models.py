...
class AccessControl(AbstractModel):
    r"""Request header and request URL access control
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable access control based on the request header and request URL. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
    ...
    def AccessControlRules(self):
        r"""Request header and request URL access rule
Note: This field may return `null`, indicating that no valid value can be obtained.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def RuleType(self):
        r"""requestHeader: access control over request header
url: access control over access URL
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def RuleHeader(self):
        r"""This parameter is required only if `RuleType` is `requestHeader`
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
class AddCLSTopicDomainsRequest(AbstractModel):
    r"""AddCLSTopicDomains request structure.
    ...
    def DomainAreaConfigs(self):
        r"""Region configuration for domains
    ...
    @property
    def Channel(self):
        r"""Specifies whether to access CDN or ECDN. Valid values: `cdn` (default) and `ecdn`.
        :rtype: str
        """
...
class AddCLSTopicDomainsResponse(AbstractModel):
    r"""AddCLSTopicDomains response structure.
...
class AddCdnDomainRequest(AbstractModel):
    r"""AddCdnDomain request structure.
...
Overseas acceleration service must be enabled to use overseas acceleration and global acceleration.
    ...
    def ServiceType(self):
        r"""Acceleration domain name service type
`web`: Webpage file downloads
`download`: Large file downloads
`media`: Audio and video on demand acceleration
`hybrid`: Dynamic and static content acceleration
`dynamic`: Dynamic content acceleration
    ...
    @property
    def ProjectId(self):
        r"""Project ID. Default value: 0, indicating `Default Project`
        :rtype: int
        """
    ...
    def FollowRedirect(self):
        r"""301/302 origin-pull follow-redirect configuration
    ...
    @property
    def ErrorPage(self):
        r"""Error code redirection (in beta)
    ...
    def RequestHeader(self):
        r"""Request header configuration
    ...
    def ResponseHeader(self):
        r"""Response header configuration
    ...
    def DownstreamCapping(self):
        r"""Download speed configuration
    ...
    @property
    def VideoSeek(self):
        r"""Video dragging configuration
    ...
    @property
    def Cache(self):
        r"""Cache validity configuration
    ...
    def OriginPullOptimization(self):
        r"""Cross-MLC-border origin-pull optimization
    ...
    def Authentication(self):
        r"""Timestamp hotlink protection
    ...
    def ForceRedirect(self):
        r"""Force redirect by access protocol
    ...
    @property
    def Ipv6(self):
        r"""IPv6 configuration (This feature is in beta and not generally available yet.)
    ...
    def SpecificConfig(self):
        r"""Specific region configuration
Applicable to cases where the acceleration domain name configuration differs for regions in and outside mainland China.
    ...
    @property
    def Area(self):
        r"""Domain name acceleration region
mainland: acceleration inside mainland China
overseas: acceleration outside mainland China
global: global acceleration
Overseas acceleration service must be enabled to use overseas acceleration and global acceleration.
    ...
    def OriginPullTimeout(self):
        r"""Origin-pull timeout configuration
    ...
    @property
    def Quic(self):
        r"""QUIC access, which is a paid service. You can check the product document and Billing Overview for more information.
    ...
    def AwsPrivateAccess(self):
        r"""Access authentication for S3 origin
    ...
    def OssPrivateAccess(self):
        r"""Access authentication for OSS origin
    ...
    def HwPrivateAccess(self):
        r"""Origin-pull authentication for Huawei Cloud OBS origin
    ...
    def QnPrivateAccess(self):
        r"""Origin-pull authentication for Qiniu Cloud Kodo origin
    ...
    def OthersPrivateAccess(self):
        r"""Origin-pull authentication for other origins
    ...
    def HttpsBilling(self):
        r"""HTTPS (enabled by default), which is a paid service. You can check the product document and Billing Overview for more information.
...
class AddCdnDomainResponse(AbstractModel):
    r"""AddCdnDomain response structure.
...
class AdvanceCacheRule(AbstractModel):
    r"""Advanced cache configuration rules
...
class AdvanceConfig(AbstractModel):
    r"""Advanced configuration settings
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Value(self):
        r"""Whether to support advanced configuration
`on`: Supported
`off`: Not supported
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
...
class AdvanceHttps(AbstractModel):
    r"""Custom HTTPS configuration for origin-pull
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    def VerifyOriginType(self):
        r"""Origin-pull verification status
`off`: Disables origin-pull verification
`oneWay`: Only verify the origin
`twoWay`: Enables two-way origin-pull verification
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def CertInfo(self):
        r"""Configuration information of the origin-pull certificate
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    def OriginCertInfo(self):
        r"""Configuration information of the origin server certificate
Note: this field may return `null`, indicating that no valid values can be obtained.
...
class AdvancedAuthentication(AbstractModel):
    r"""Timestamp hotlink protection advanced configuration (allowlist feature)
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable hot linking protection. Values:
`on`: Enable
`off`: Disable
Only one advanced configuration can be enabled. Set the rests to `null`.
        :rtype: str
    ...
    @property
    def TypeA(self):
        r"""Timestamp hotlink protection advanced configuration mode A
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def TypeB(self):
        r"""Timestamp hotlink protection advanced configuration mode B
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def TypeC(self):
        r"""Timestamp hotlink protection advanced configuration mode C
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def TypeD(self):
        r"""Timestamp hotlink protection advanced configuration mode D
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def TypeE(self):
        r"""Timestamp hotlink protection advanced configuration mode E
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def TypeF(self):
        r"""Timestamp hotlink protection advanced configuration mode F
Note: this field may return `null`, indicating that no valid values can be obtained.
...
class AdvancedAuthenticationTypeA(AbstractModel):
    ...
    @property
    def SecretKey(self):
        r"""Key used for signature calculation, allowing 6 to 32 bytes of letters and digits.
        :rtype: str
        """
    ...
    @property
    def SignParam(self):
        r"""Signature field name in the URI string, starting with a letter, and consisting of letters, digits, and underscores.
        :rtype: str
        """
    ...
    @property
    def TimeParam(self):
        r"""Time field name in the URI string, starting with a letter, and consisting of letters, digits, and underscores.
        :rtype: str
        """
    ...
    def ExpireTimeRequired(self):
        r"""Whether the expiration time parameter is required
        :rtype: bool
        """
    ...
    @property
    def TimeFormat(self):
        r"""Time format. Valid values: dec (decimal), hex (hexadecimal).
        :rtype: str
        """
    ...
    @property
    def FailCode(self):
        r"""Status code returned when the authentication failed
        :rtype: int
        """
    ...
    @property
    def ExpireCode(self):
        r"""Status code returned when the URL expired
        :rtype: int
        """
    ...
    @property
    def RulePaths(self):
        r"""List of URLs to be authenticated
        :rtype: list of str
        """
...
class AdvancedAuthenticationTypeD(AbstractModel):
    ...
    def BackupSecretKey(self):
        r"""Alternative key used for authentication after the authentication key (`SecretKey`) failed
        :rtype: str
        """
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    def AclSignParam(self):
        r"""ACL signature field name in the URI string, starting with a letter, and consisting of letters, digits, and underscores.
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
    ...
    def StartTimeParam(self):
        r"""Start time field name in the URI string, starting with a letter, and consisting of letters, digits, and underscores.
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
    ...
    def ExpireTimeParam(self):
        r"""Expiration time field name in the URI string, starting with a letter, and consisting of letters, digits, and underscores.
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
...
class AdvancedAuthenticationTypeF(AbstractModel):
    r"""Timestamp hotlink protection advanced authentication configuration mode F (TypeF)
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    def TransactionParam(self):
        r"""Transaction field name in the URI string, starting with a letter, and consisting of letters, digits, and underscores.
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
    ...
    @property
    def SecretKey(self):
        r"""CMK used for signature calculation, allowing 6 to 32 bytes of letters and digits.
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
        return self._SecretKey
    ...
    @property
    def BackupSecretKey(self):
        r"""Alternative key used for signature calculation, which is used after the CMK fails in authentication. It allows 6 to 32 bytes of letters and digits.
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
        return self._BackupSecretKey
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def IgnoreSetCookie(self):
        r"""Whether to ignore the header and body on cache nodes if the origin server returns the header `Set-Cookie`.
`on`: Ignore; do not cache the header and body.
`off`: Do not ignore; follow the custom cache rules of cache nodes.
It is disabled by default.
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class Authentication(AbstractModel):
    r"""Timestamp hotlink protection configuration
...
Only one advanced configuration can be enabled. Set the rests to `null`.
    ...
    def AuthAlgorithm(self):
        r"""Authentication algorithm. Values:
`md5`: Calculate the hash using MD5.
`sha256`: Calculate the hash using SHA-256.
Default value: `md5`.
Note: This field may return·`null`, indicating that no valid values can be obtained.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def TypeB(self):
        r"""Timestamp hotlink protection mode B configuration (mode B is being upgraded and is currently not supported)
Note: This field may return `null`, indicating that no valid value can be obtained.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def SecretKey(self):
        r"""The key for signature calculation
6-32 characters. Only digits and letters are allowed. 
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
...
Unit: second. The maximum value is 630720000.
    ...
    def FileExtensions(self):
        r"""File extension list settings determining if authentication should be performed
If it contains an asterisk (*), this indicates all files.
        :rtype: list of str
        """
    ...
    @property
    def FilterType(self):
        r"""`whitelist`: All file types apart from the FileExtensions list are authenticated.
`blacklist`: Only the file types in the FileExtensions list are authenticated.
        :rtype: str
        """
    ...
    @property
    def BackupSecretKey(self):
        r"""Backup key, which is used to calculate a signature.
6-32 characters. Only digits and letters are allowed. 
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
If it contains an asterisk (*), this indicates all files.
    ...
    @property
    def FilterType(self):
        r"""whitelist: indicates that all file types apart from the FileExtensions list are authenticated
blacklist: indicates that only the file types in the FileExtensions list are authenticated
        :rtype: str
        """
        return self._FilterType
...
Note: This field may return·`null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable `AvifAdapter` for image optimization. Values:
`on`: Enable
`off`: Disable
Note: This field may return·`null`, indicating that no valid values can be obtained.
        :rtype: str
...
class AwsPrivateAccess(AbstractModel):
    r"""Origin access authentication for S3 bucket.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable origin-pull authentication for S3 buckets.
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
class BandwidthAlert(AbstractModel):
    r"""Bandwidth cap configuration. This is disabled by default.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable usage limit. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
    ...
    def BpsThreshold(self):
        r"""The upper limit of bandwidth usage (in bps) or traffic usage (in bytes).
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: int
        """
    ...
    def CounterMeasure(self):
        r"""Action taken when threshold is reached
`RETURN_404`: A 404 error will be returned for all requests.
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
    ...
    def LastTriggerTime(self):
        r"""The last time when the usage upper limit in the Chinese mainland was reached
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
    ...
    def AlertSwitch(self):
        r"""Whether to enable alerts for usage limit. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
    ...
    def AlertPercentage(self):
        r"""Triggers alarms when the ratio of bandwidth or traffic usage to the usage upper limit reaches the specified value
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: int
        """
    ...
    def LastTriggerTimeOverseas(self):
        r"""The last time when the usage outside the Chinese mainland reached the upper limit
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
    ...
    @property
    def Metric(self):
        r"""Dimension of the usage limit
`bandwidth`: Bandwidth
`flux`: Traffic
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
...
class BriefDomain(AbstractModel):
    r"""Basic domain configuration information, including CNAME, status, service type, acceleration region, creation time, last modified time, and origin server configuration.
...
global: Locked globally
    ...
    @property
    def Cname(self):
        r"""CNAME address of domain name
        :rtype: str
        """
        return self._Cname
...
`offline`: Disabled
    ...
    @property
    def ProjectId(self):
        r"""Project ID, which can be viewed on the Tencent Cloud project management page
        :rtype: int
        """
        return self._ProjectId
...
`media`: Streaming media VOD acceleration
    ...
    @property
    def Origin(self):
        r"""Origin server configuration details.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.Origin`
        """
        return self._Origin
...
global: Locked globally
    ...
    @property
    def Product(self):
        r"""Product of the domain name, either `cdn` or `ecdn`.
        :rtype: str
        """
...
class Cache(AbstractModel):
    r"""Node cache expiration time configuration. There are two types of configuration:
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def SimpleCache(self):
        r"""Basic cache expiration time configuration
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    def AdvancedCache(self):
        r"""(Disused) Advanced cache validity configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def RuleCache(self):
        r"""Advanced path cache configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class CacheConfig(AbstractModel):
    r"""Heuristic cache validity configuration
...
Note: This field may return·`null`, indicating that no valid values can be obtained.
    ...
    def HeuristicCacheTimeSwitch(self):
        r"""Whether to enable heuristic cache validity. Values:
`on`: Enable
`off`: Disable
Note: This field may return·`null`, indicating that no valid values can be obtained.
        :rtype: str
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable path cache. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def CompareMaxAge(self):
        r"""Advanced cache expiration configuration. If this is enabled, the max-age value returned by the origin server will be compared with the cache expiration time set in CacheRules, and the smallest value will be cached on the node.
`on`: Enable
`off`: Disable
This is disabled by default.
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class CacheConfigFollowOrigin(AbstractModel):
    r"""Path cache configuration follows the origin server configuration.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to follow the origin configuration for path cache. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
    ...
    def HeuristicCache(self):
        r"""Heuristic cache configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class CacheConfigNoCache(AbstractModel):
    r"""Path cache/no cache configuration.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable no-caching at the path. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
    ...
    @property
    def Revalidate(self):
        r"""Always forwards to the origin server for verification
`on`: Enable
`off`: Disable
It is disabled by default.
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class CacheKey(AbstractModel):
    r"""Cache key configuration (Ignore Query String configuration)
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def FullUrlCache(self):
        r"""Whether to enable full-path cache
`on`: Enable full-path cache (i.e., disable Ignore Query String)
`off`: Disable full-path cache (i.e., enable Ignore Query String)
        :rtype: str
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Cookie(self):
        r"""Cookie contained in `CacheKey`
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Header(self):
        r"""Request header contained in `CacheKey`
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def CacheTag(self):
        r"""Custom string contained in `CacheKey`
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Scheme(self):
        r"""Request protocol contained in `CacheKey`
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def KeyRules(self):
        r"""Path-specific cache key configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to include `CacheTag` as part of `CacheKey`. Values:
`on`: Yes
`off`: No
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
class CappingRule(AbstractModel):
    r"""Downstream speed limit configuration rules. Up to 100 entries can be configured.
...
For `path`, enter an absolute path, e.g., `/xxx/test.html`.
    ...
    def KBpsThreshold(self):
        r"""Downstream speed value settings (in KB/s)
        :rtype: int
        """
...
You can also specify a status code for querying.
    ...
    @property
    def Metric(self):
        r"""Queries by the specified metric:
`flux`: Traffic (in bytes)
`bandwidth`: Bandwidth (in bps)
`request`: Number of requests
`fluxHitRate`: Traffic hit rate (in %)
...
unknown: unknown node location
    ...
    @property
    def History(self):
        r"""Activation and deactivation history of the node.
...
class CdnIpHistory(AbstractModel):
    r"""CDN node activation and deactivation history
...
`offline`: Nodes deactivated
    ...
    @property
    def Datetime(self):
        r"""Operation time corresponding to operation type
If its value is `null`, it means there is no status change record.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
class ClientCert(AbstractModel):
    r"""HTTPS client certificate configuration
...
class ClsSearchLogs(AbstractModel):
    ...
    @property
    def Context(self):
        r"""Cursor for more search results
        :rtype: str
        """
    ...
    @property
    def Listover(self):
        r"""Whether all search results have been returned
        :rtype: bool
        """
...
class Compatibility(AbstractModel):
    r"""Old configuration compatibility check
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Code(self):
        r"""Compatibility flag status code.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: int
        """
        return self._Code
...
class Compression(AbstractModel):
    r"""Smart compression configuration. By default, Gzip compression is performed for files with js, html, css, xml, json, shtml, and htm suffixes, and with sizes between 256 and 2097152 bytes.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable smart compression. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
class CompressionRule(AbstractModel):
    r"""Intelligent compression rule configuration
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Compress(self):
        r"""true: must be set as true, enables compression
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: bool
        """
    ...
    @property
    def MinLength(self):
        r"""The minimum file size to trigger compression (in bytes)
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: int
        """
    ...
    @property
    def MaxLength(self):
        r"""The maximum file size to trigger compression (in bytes).
The maximum value is 30 MB.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: int
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def FileExtensions(self):
        r"""Compress based on file suffix.
File suffixes such as jpg and txt are supported.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: list of str
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to include Cookie as part of CacheKey. Values:
`on`: Yes
`off`: No
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
class CreateClsLogTopicRequest(AbstractModel):
    r"""CreateClsLogTopic request structure.
    ...
    @property
    def DomainAreaConfigs(self):
        r"""Domain name region information
        :rtype: list of DomainAreaConfig
        """
        return self._DomainAreaConfigs
...
class CreateClsLogTopicResponse(AbstractModel):
    r"""CreateClsLogTopic response structure.
...
class DeleteCdnDomainResponse(AbstractModel):
    r"""DeleteCdnDomain response structure.
...
class DeleteClsLogTopicRequest(AbstractModel):
    r"""DeleteClsLogTopic request structure.
...
class DeleteClsLogTopicResponse(AbstractModel):
    r"""DeleteClsLogTopic response structure.
...
class DescribeBillingDataRequest(AbstractModel):
    r"""DescribeBillingData request structure.
...
Default value: `bandwidth`
    ...
    @property
    def StartTime(self):
        r"""Start time of the query, e.g. 2018-09-04 10:40:00.
The specified start time will be rounded down based on the granularity parameter `Interval`. For example, if you set the start time to 2018-09-04 10:40:00 with 1-hour granularity, the time will be rounded down to 2018-09-04 10:00:00.
The period between the start time and end time can be up to 90 days.
        :rtype: str
        """
    ...
    @property
    def EndTime(self):
        r"""End time of the query, e.g. 2018-09-04 10:40:00.
The specified end time will be rounded down based on the granularity parameter `Interval`. For example, if you set the end time to 2018-09-04 10:40:00 with 1-hour granularity, the time will be rounded down to 2018-09-04 10:00:00.
The period between the start time and end time can be up to 90 days.
        :rtype: str
        """
    ...
    @property
    def Interval(self):
        r"""Time granularity, which can be:
`min`: 1-minute granularity. The query period cannot exceed 24 hours.
`5min`: 5-minute granularity. The query range cannot exceed 31 days.
`hour`: 1-hour granularity. The query period cannot exceed 31 days.
`day`: 1-day granularity. The query period cannot exceed 31 days.
...
`min` is not supported if the `Area` field is `overseas`.
    ...
    @property
    def Domain(self):
        r"""Domain name whose billing data is to be queried
        :rtype: str
        """
        return self._Domain
    ...
    @property
    def Project(self):
        r"""Specifies the project ID to be queried. [Check project ID in the console](https://console.cloud.tencent.com/project)
If the `Domain` parameter is passed in, the `Proejct` parameter is ignored. Only the billing data of the specified domain name is returned. 
        :rtype: int
        """
    ...
    @property
    def Area(self):
        r"""Acceleration region whose billing data is to be queried:
`mainland`: Regions within the Chinese mainland
`overseas`: Regions outside the Chinese mainland
If this parameter is left empty, `mainland` will be used by default
        :rtype: str
    ...
    @property
    def District(self):
        r"""Country/region to be queried if `Area` is `overseas`
To view codes of provinces or countries/regions, see [Province Code Mappings](https://intl.cloud.tencent.com/document/product/228/6316?from_cn_redirect=1#.E7.9C.81.E4.BB.BD.E6.98.A0.E5.B0.84)
If this parameter is left empty, all countries/regions will be queried
        :rtype: int
        """
...
Default value: `bandwidth`
    ...
    @property
    def Product(self):
        r"""Specifies the product to query, either `cdn` (default) or `ecdn`.
        :rtype: str
        """
        return self._Product
...
class DescribeBillingDataResponse(AbstractModel):
    r"""DescribeBillingData response structure.
...
`day`: 1 day
    ...
    @property
    def Interval(self):
        r"""Time granularity, which is specified by the parameter passed in during the query:
`min`: 1 minute
`5min`: 5 minutes
`hour`: 1 hour
`day`: 1 day
...
class DescribeCdnDataRequest(AbstractModel):
    r"""DescribeCdnData request structure.
...
The period between the start time and end time can be up to 90 days.
    ...
    @property
    def Metric(self):
        r"""Specifies the metric to query, which can be:
`flux`: Traffic (in bytes)
`fluxIn`: Upstream traffic (in bytes), only used for the `ecdn` product
`fluxOut`: Downstream traffic (in bytes), only used for the `ecdn` product
`bandwidth`: Bandwidth (in bps)
...
Specifies the status code to query. The return will be empty if the status code has never been generated.
    ...
    @property
    def Domains(self):
        r"""Specifies the list of domain names to be queried
You can specify one or more domain names.
Up to 30 domain names can be queried in one request.
If this parameter is not specified, it means to query all domain names under the current account.
        :rtype: list of str
...
Note that `Project` will be ignored if `Domains` is specified.
    ...
    @property
    def Interval(self):
        r"""Sampling interval. The available options vary for different query period. See below: 
`min`: Return data with 1-minute granularity. It’s available when the query period is  within 24 hours and `Area` is `mainland`.
`5min`: Return data with 5-minute granularity. It’s available when the query period is within 31 days.
`hour`: Return data with 1-hour granularity. It’s available when the query period is within 31 days.
`day`: Return data with 1-day granularity. It’s available when the query period is longer than 31 days.
...
You can set it to true to return the details for each Domain (the statusCode metric is currently not supported).
    ...
    @property
    def Isp(self):
        r"""Specifies an ISP when you query the CDN data within the Chinese mainland. If this is left blank, all ISPs will be queried.
To view ISP codes, see [ISP Code Mappings](https://intl.cloud.tencent.com/document/product/228/6316?from_cn_redirect=1#.E5.8C.BA.E5.9F.9F-.2F-.E8.BF.90.E8.90.A5.E5.95.86.E6.98.A0.E5.B0.84.E8.A1.A8)
Note that only one of `District`, `Isp` and `IpProtocol` can be specified.
        :rtype: int
        """
    ...
    @property
    def District(self):
        r"""Specifies a province when you query the CDN data within the Chinese mainland. If this is left blank, all provinces will be queried.
Specifies a country/region when you query the CDN data outside the Chinese mainland. If this is left blank, all countries/regions will be queried.
To view codes of provinces or countries/regions, see [Province Code Mappings](https://intl.cloud.tencent.com/document/product/228/6316?from_cn_redirect=1#.E5.8C.BA.E5.9F.9F-.2F-.E8.BF.90.E8.90.A5.E5.95.86.E6.98.A0.E5.B0.84.E8.A1.A8).
When `Area` is `mainland`, you can query by the province. Note that only one of `District`, `Isp` and `IpProtocol` can be specified.
        :rtype: int
    ...
    @property
    def Protocol(self):
        r"""Specifies the protocol to be queried; if you leave it blank, all protocols will be queried.
`all`: All protocols
`http`: Query HTTP data
`https`: Query HTTPS data
        :rtype: str
    ...
    @property
    def DataSource(self):
        r"""Specifies the data source to be queried. It’s only open to beta users now. 
        :rtype: str
        """
    ...
    @property
    def IpProtocol(self):
        r"""Specifies the IP protocol to be queried. If it’s not specified, data of all IP protocols are returned.
`all`: All protocols
`ipv4`: Query IPv4 data
`ipv6`: Query IPv6 data
If `IpProtocol` is specified, `District` parameter can not be specified at the same time.
Note: `ipv4` and `ipv6` are only available to beta users. 
    ...
    @property
    def Area(self):
        r"""Specifies the service area. If it’s not specified, CDN data of the Chinese mainland are returned.
`mainland`: Query CDN data in the Chinese mainland.
`overseas`: Query CDN data outside the Chinese mainland.
        :rtype: str
        """
    ...
    @property
    def AreaType(self):
        r"""Specify whether to query by the region of the server or client. This parameter is valid only when `Area` is `overseas`.
`server`: Query by the location of server (Tencent Cloud CDN nodes)
`client`: Query by the location of the client (where the request devices are located)
        :rtype: str
        """
    ...
    @property
    def TimeZone(self):
        r"""Specifies a time zone to query. The default time zone is UTC+08:00.
        :rtype: str
        """
        return self._TimeZone
...
class DescribeCdnDataResponse(AbstractModel):
    r"""DescribeCdnData response structure.
...
`day`: 1 day
    ...
    @property
    def Interval(self):
        r"""Time granularity of the returned data. 
`min`: 1 minute
`5min`: 5 minutes
`hour`: 1 hour
`day`: 1 day
    ...
    @property
    def Data(self):
        r"""Returned data details of the specified conditional query
...
class DescribeCdnDomainLogsRequest(AbstractModel):
    r"""DescribeCdnDomainLogs request structure.
...
`access`: Access logs.
    ...
    @property
    def Limit(self):
        r"""Limit on paginated queries. Default value: 100. Maximum value: 1,000
        :rtype: int
        """
        return self._Limit
...
class DescribeCdnDomainLogsResponse(AbstractModel):
    r"""DescribeCdnDomainLogs response structure.
...
You can open the link to download a .gz log package that contains all log files without extension.
    ...
    @property
    def TotalCount(self):
        r"""Total number of entries obtained
        :rtype: int
        """
...
class DescribeCdnIpRequest(AbstractModel):
    r"""DescribeCdnIp request structure.
...
class DescribeCdnIpResponse(AbstractModel):
    r"""DescribeCdnIp response structure.
...
class DescribeCdnOriginIpRequest(AbstractModel):
    r"""DescribeCdnOriginIp request structure.

    """


class DescribeCdnOriginIpResponse(AbstractModel):
    r"""DescribeCdnOriginIp response structure.
    ...
    @property
    def Ips(self):
        r"""Intermediate node IP details
    ...
    @property
    def TotalCount(self):
        r"""Number of intermediate node IPs
        :rtype: int
        """
        return self._TotalCount
...
class DescribeCertDomainsRequest(AbstractModel):
    r"""DescribeCertDomains request structure.
    ...
    @property
    def Cert(self):
        r"""Base64-encoded string of certificate in PEM format
        :rtype: str
        """
        return self._Cert
    ...
    @property
    def Product(self):
        r"""Product of the domain name, either `cdn` (default) or `ecdn`.
        :rtype: str
        """
        return self._Product
...
class DescribeCertDomainsResponse(AbstractModel):
    r"""DescribeCertDomains response structure.
...
class DescribeDomainsConfigRequest(AbstractModel):
    r"""DescribeDomainsConfig request structure.
    ...
    @property
    def Filters(self):
        r"""Query condition filter, complex type.
...
class DescribeDomainsConfigResponse(AbstractModel):
    r"""DescribeDomainsConfig response structure.
...
Used for paginated queries
    ...
    def TotalNumber(self):
        r"""Number of domain names that match the specified query conditions
Used for paginated queries
        :rtype: int
        """
...
class DescribeDomainsRequest(AbstractModel):
    r"""DescribeDomains request structure.
...
class DescribeDomainsResponse(AbstractModel):
    r"""DescribeDomains response structure.
...
Used for paginated queries
    ...
    @property
    def TotalNumber(self):
        r"""The number of domain names that matched the query conditions
Used for paginated queries
        :rtype: int
        """
        return self._TotalNumber
...
class DescribeIpStatusRequest(AbstractModel):
    r"""DescribeIpStatus request structure.
...
`global`: Global nodes
    ...
    @property
    def Segment(self):
        r"""Whether to return a value as an IP range
        :rtype: bool
        """
    ...
    def AbbreviationIpv6(self):
        r"""Whether to abbreviate the IPv6 address.
        :rtype: bool
        """
...
class DescribeIpStatusResponse(AbstractModel):
    r"""DescribeIpStatus response structure.
...
class DescribeIpVisitRequest(AbstractModel):
    r"""DescribeIpVisit request structure.
...
day: 1 day. If the query period is longer than 24 hours, `day` will be used by default.
    ...
    @property
    def StartTime(self):
        r"""Query start time, such as 2018-09-04 10:40:10; the returned result is later than or equal to the specified time.
According to the specified time granularity, forward rounding is applied; for example, if the query start time is 2018-09-04 10:40:10 and the query time granularity is 5 minutes, the time for the first returned entry will be 2018-09-04 10:40:00.
        :rtype: str
        """
        return self._StartTime
    ...
    @property
    def EndTime(self):
        r"""Query end time, such as 2018-09-04 10:40:10; the returned result is earlier than or equal to the specified time.
According to the specified time granularity, forward rounding is applied; for example, if the query start time is 2018-09-04 10:40:10 and the query time granularity is 5 minutes, the time for the last returned entry will be 2018-09-04 10:40:00.
        :rtype: str
        """
        return self._EndTime
    ...
    @property
    def Domains(self):
        r"""Specifies the list of domain names to be queried; up to 30 domain names can be queried at a time.
        :rtype: list of str
        """
        return self._Domains
    ...
    @property
    def Project(self):
        r"""Specifies the project ID to be queried, which can be viewed [here](https://console.cloud.tencent.com/project)
Please note that if domain names are specified, this parameter will be ignored.
        :rtype: int
        """
        return self._Project
    ...
    @property
    def Interval(self):
        r"""Sampling interval in minutes. The available options vary for different query period. See below: 
5min: 5 minutes. If the query period is within 24 hours, `5min` will be used by default.
day: 1 day. If the query period is longer than 24 hours, `day` will be used by default.
        :rtype: str
        """
...
class DescribeIpVisitResponse(AbstractModel):
    r"""DescribeIpVisit response structure.
    ...
    @property
    def Interval(self):
        r"""Time granularity of data statistics, which supports 5min (5 minutes) and day (1 day).
        :rtype: str
        """
        return self._Interval
    ...
    @property
    def Data(self):
        r"""Origin-pull data details of each resource.
        :rtype: list of ResourceData
        """
        return self._Data
...
class DescribeMapInfoRequest(AbstractModel):
    r"""DescribeMapInfo request structure.
...
class DescribeMapInfoResponse(AbstractModel):
    r"""DescribeMapInfo response structure.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def ServerRegionRelation(self):
        r"""Mapping relationship between server region ID and sub-region ID
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def ClientRegionRelation(self):
        r"""Mapping relationship between client region ID and sub-region ID
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: list of RegionMapRelation
        """
...
class DescribeOriginDataRequest(AbstractModel):
    r"""DescribeOriginData request structure.
...
It is supported to specify a status code for query. The return will be empty if the status code has never been generated.
    ...
    @property
    def Domains(self):
        r"""Specifies the list of domain names to query. You can query up to 30 domain names at a time.
        :rtype: list of str
        """
        return self._Domains
...
You can set it to true to return the details for each Domain (the statusCode metric is currently not supported)
    ...
    @property
    def Area(self):
        r"""Specifies the service region. If this value is left blank, it means to query CDN data within the Chinese mainland.
`mainland`: Query CDN data in the Chinese mainland.
`overseas`: Query CDN data outside the Chinese mainland.
        :rtype: str
        """
...
class DescribeOriginDataResponse(AbstractModel):
    r"""DescribeOriginData response structure.
    ...
    @property
    def Interval(self):
        r"""Time granularity of data statistics, which supports `min` (1 minute), `5min` (5 minutes), `hour` (1 hour), and `day` (1 day).
        :rtype: str
        """
        return self._Interval
...
class DescribePayTypeRequest(AbstractModel):
    r"""DescribePayType request structure.
...
class DescribePayTypeResponse(AbstractModel):
    r"""DescribePayType response structure.
...
class DescribePurgeQuotaRequest(AbstractModel):
    r"""DescribePurgeQuota request structure.

    """


class DescribePurgeQuotaResponse(AbstractModel):
    r"""DescribePurgeQuota response structure.
    ...
    @property
    def PathPurge(self):
        r"""Directory purge usage and quota.
        :rtype: list of Quota
        """
...
`path`: Directory purge record
    ...
    @property
    def StartTime(self):
        r"""Specifies the starting time of the period you want to query, such as `2018-08-08 00:00:00`
        :rtype: str
        """
        return self._StartTime
    ...
    @property
    def EndTime(self):
        r"""Specifies the end time of the period you want to query, such as 2018-08-08 23:59:59
        :rtype: str
        """
        return self._EndTime
    ...
    @property
    def TaskId(self):
        r"""Specifies a task ID when you want to query by task ID.
You must specify either a task ID or a starting time for your query.
        :rtype: str
        """
        return self._TaskId
    ...
    @property
    def Limit(self):
        r"""Limit on paginated queries. Default value: 20
        :rtype: int
        """
        return self._Limit
    ...
    @property
    def Keyword(self):
        r"""You can filter the results by domain name or a complete URL beginning with `http(s)://`
        :rtype: str
        """
    ...
    @property
    def Status(self):
        r"""Specifies a task state for your query:
`fail`: purge failed
`done`: purge succeeded
`process`: purge in progress
        :rtype: str
    ...
    @property
    def Area(self):
        r"""Specifies a purge region for your query:
`mainland`: within Mainland China
`overseas`: outside Mainland China
`global`: global
        :rtype: str
...
class DescribePushQuotaRequest(AbstractModel):
    r"""DescribePushQuota request structure.

    """


class DescribePushQuotaResponse(AbstractModel):
    r"""DescribePushQuota response structure.
    ...
    @property
    def UrlPush(self):
        r"""URL prefetch usage and quota.
        :rtype: list of Quota
        """
...
class DescribePushTasksRequest(AbstractModel):
    r"""DescribePushTasks request structure.
...
`invalid`: Invalid prefetch with 4XX/5XX status code returned from the origin server
    ...
    @property
    def StartTime(self):
        r"""Starting time, such as `2018-08-08 00:00:00`
        :rtype: str
        """
        return self._StartTime
    ...
    @property
    def EndTime(self):
        r"""End time, such as `2018-08-08 23:59:59`
        :rtype: str
        """
        return self._EndTime
    ...
    @property
    def TaskId(self):
        r"""Specifies a task ID for your query.
You must specify either a task ID or a starting time.
        :rtype: str
        """
        return self._TaskId
    ...
    @property
    def Keyword(self):
        r"""Specifies a keyword for your query. Please enter a domain name or a complete URL beginning with `http(s)://`
        :rtype: str
        """
        return self._Keyword
    ...
    @property
    def Area(self):
        r"""Specifies a region to query the prefetch records
`mainland`: Chinese mainland
`overseas`: Outside the Chinese mainland
`global`: Globe
        :rtype: str
    ...
    @property
    def Status(self):
        r"""Queries the status of a specified task
`fail`: Prefetch failed
`done`: Prefetch succeeded
`process`: Prefetch in progress
`invalid`: Invalid prefetch with 4XX/5XX status code returned from the origin server
...
class DescribePushTasksResponse(AbstractModel):
    r"""DescribePushTasks response structure.
...
class DescribeReportDataRequest(AbstractModel):
    r"""DescribeReportData request structure.
...
`overseas`: Regions outside the Chinese mainland
    ...
    @property
    def StartTime(self):
        r"""Query the start time in the format of `yyyy-MM-dd`
If the report type is `daily`, the start time and end time must be of the same day.
If the report type is `weekly`, the start time must be Monday and the end time must be the Sunday of the same week.
If the report type is `monthly`, the start time must be the first day of the month and the end time must be the last day of the same month.
        :rtype: str
    ...
    @property
    def EndTime(self):
        r"""Query the end time in the format of `yyyy-MM-dd`
If the report type is `daily`, the start time and end time must be of the same day.
If the report type is `weekly`, the start time must be Monday and the end time must be the Sunday of the same week.
If the report type is `monthly`, the start time must be the first day of the month and the end time must be the last day of the same month.
        :rtype: str
...
`overseas`: Regions outside the Chinese mainland
    ...
    @property
    def Limit(self):
        r"""Number of data entries. Default value: 1000.
        :rtype: int
        """
        return self._Limit
...
class DescribeReportDataResponse(AbstractModel):
    r"""DescribeReportData response structure.
    ...
    def DomainReport(self):
        r"""Domain name-level data details.
...
class DescribeUrlViolationsRequest(AbstractModel):
    r"""DescribeUrlViolations request structure.
    ...
    @property
    def Limit(self):
        r"""Limit on paginated queries. Default value: 100.
        :rtype: int
        """
        return self._Limit
...
class DescribeUrlViolationsResponse(AbstractModel):
    r"""DescribeUrlViolations response structure.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def UrlRecordList(self):
        r"""Details of URLs in violation
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def TotalCount(self):
        r"""Total number of records, which is used for pagination.
        :rtype: int
        """
        return self._TotalCount
...
class DetailDomain(AbstractModel):
    r"""Complete acceleration domain configuration information
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def IpFreqLimit(self):
        r"""IP access limit configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.IpFreqLimit`
        """
        return self._IpFreqLimit
    ...
    @property
    def StatusCodeCache(self):
        r"""Status code cache configuration.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.StatusCodeCache`
        """
        return self._StatusCodeCache
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def ErrorPage(self):
        r"""Custom error page configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.ErrorPage`
        """
        return self._ErrorPage
    ...
    @property
    def RequestHeader(self):
        r"""Custom request header configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.RequestHeader`
        """
        return self._RequestHeader
    ...
    @property
    def ResponseHeader(self):
        r"""Custom response header configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.ResponseHeader`
        """
        return self._ResponseHeader
    ...
    @property
    def DownstreamCapping(self):
        r"""Single-link downstream speed limit configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.DownstreamCapping`
        """
        return self._DownstreamCapping
    ...
    @property
    def CacheKey(self):
        r"""Configuration of cache with/without parameter
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.CacheKey`
        """
        return self._CacheKey
    ...
    @property
    def ResponseHeaderCache(self):
        r"""Origin server header cache configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.ResponseHeaderCache`
        """
        return self._ResponseHeaderCache
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Cache(self):
        r"""Node cache expiration rule configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.Cache`
        """
        return self._Cache
    ...
    @property
    def OriginPullOptimization(self):
        r"""Cross-border linkage optimization configuration (in beta)
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.OriginPullOptimization`
        """
        return self._OriginPullOptimization
    ...
    @property
    def Https(self):
        r"""HTTPS Acceleration Configuration Guide
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.Https`
        """
        return self._Https
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def ForceRedirect(self):
        r"""Access protocol forced redirect configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.ForceRedirect`
        """
        return self._ForceRedirect
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def MaxAge(self):
        r"""Browser cache expiration rule configuration (in beta)
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.MaxAge`
        """
        return self._MaxAge
    ...
    @property
    def Ipv6(self):
        r"""IPv6 origin-pull configuration (in beta)
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.Ipv6`
        """
        return self._Ipv6
    ...
    def Compatibility(self):
        r"""Backwards compatibility configuration (compatibility field for internal use)
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def SpecificConfig(self):
        r"""Region-specific configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.SpecificConfig`
        """
        return self._SpecificConfig
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def AwsPrivateAccess(self):
        r"""S3 bucket origin access authentication configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.AwsPrivateAccess`
        """
        return self._AwsPrivateAccess
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def UserAgentFilter(self):
        r"""UA blocklist/allowlist configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Advance(self):
        r"""Whether to support advanced configuration items
`on`: Supported
`off`: Not supported
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def OriginAuthentication(self):
        r"""Origin-pull authentication advanced configuration (allowlist feature)
Note: This field may return `null`, indicating that no valid value can be obtained.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def OfflineCache(self):
        r"""Offline cache (only available to beta users)
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.OfflineCache`
        """
        return self._OfflineCache
    ...
    def OriginCombine(self):
        r"""Merging origin-pull requests (only available to beta users)
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def PostMaxSize(self):
        r"""POST request configuration item
Note: This field may return `null`, indicating that no valid value can be obtained.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def ShareCname(self):
        r"""Shared CNAME configuration (only available to beta users)
Note: This field may return `null`, indicating that no valid value can be obtained.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def HwPrivateAccess(self):
        r"""Access authentication for Huawei Cloud OBS origin
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.HwPrivateAccess`
        """
        return self._HwPrivateAccess
    ...
    @property
    def QnPrivateAccess(self):
        r"""Access authentication for QiNiu Cloud Kodo origin
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.QnPrivateAccess`
        """
        return self._QnPrivateAccess
...
class DisableClsLogTopicRequest(AbstractModel):
    r"""DisableClsLogTopic request structure.
...
class DisableClsLogTopicResponse(AbstractModel):
    r"""DisableClsLogTopic response structure.
...
class DomainAreaConfig(AbstractModel):
    r"""Region configuration for domain names
    ...
    @property
    def Area(self):
        r"""Region list, where the element can be `mainland`/`overseas`
        :rtype: list of str
        """
        return self._Area
...
class DomainFilter(AbstractModel):
    r"""Filter conditions for domain name query.
...
- `tagKey`: Tag key.
    ...
    @property
    def Fuzzy(self):
        r"""Whether to enable fuzzy query. Only `origin` or `domain` is supported for the filter field name.
When fuzzy query is enabled, the maximum Value length is 1. When fuzzy query is disabled, the maximum Value length is 5.
        :rtype: bool
        """
        return self._Fuzzy
...
class DomainLog(AbstractModel):
    r"""Details about a log package download link
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def StartTime(self):
        r"""Starting time of the log package
        :rtype: str
        """
        return self._StartTime
    ...
    @property
    def Area(self):
        r"""Acceleration region corresponding to the log package
`mainland`: Within the Chinese mainland
`overseas`: Outside the Chinese mainland
        :rtype: str
        """
...
class DownstreamCapping(AbstractModel):
    r"""Single link downstream speed limit configuration. This is disabled by default.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable downstream speed limit. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
    ...
    def CappingRules(self):
        r"""Downstream speed limiting rules
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class EnableClsLogTopicRequest(AbstractModel):
    r"""EnableClsLogTopic request structure.
...
class EnableClsLogTopicResponse(AbstractModel):
    r"""EnableClsLogTopic response structure.
...
class ErrorPage(AbstractModel):
    r"""Status code redirect configuration, which is disabled by default.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable status code-based redirection. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
    ...
    @property
    def PageRules(self):
        r"""Status code redirect rules configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
...
Supports 400, 403, 404, 500.
    ...
    def RedirectCode(self):
        r"""Redirect status code settings
Supports 301 or 302.
        :rtype: int
        """
...
class ExtraLogset(AbstractModel):
    r"""Information of logsets and log topics (except those created in the Shanghai region)
...
class FollowRedirect(AbstractModel):
    r"""301/302 automatic origin-pull follow-redirect configuration. It is disabled by default.
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable origin-pull to follow the origin configuration. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
    ...
    def RedirectConfig(self):
        r"""Specifies a host header for 302 redirects. This feature is only available to beta users. To join the beta, please submit a ticket.
Note: This field may return null, indicating that no valid values can be obtained.
...
class ForceRedirect(AbstractModel):
    r"""Access protocol forced redirect configuration. This is disabled by default.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable forced HTTPS redirects. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
    ...
    def RedirectType(self):
        r"""Access forced redirect types
http: forced HTTP redirect
https: forced HTTPS redirect
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def CarryHeaders(self):
        r"""Whether to return the newly added header during force redirection
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
class GuetzliAdapter(AbstractModel):
    r"""Image optimization - `GuetzliAdapter` configuration
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable Cachekey control. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
    ...
    @property
    def Value(self):
        r"""Array of headers that make up the `CacheKey` (separated by ';')
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
        return self._Value
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable HSTS. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def IncludeSubDomains(self):
        r"""Whether to include subdomain names. Valid values: on, off.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
class HttpHeaderPathRule(AbstractModel):
    r"""HTTP header setting rules. Up to 100 entries can be set.
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def HeaderName(self):
        r"""HTTP header name. Up to 100 characters can be set.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
class HttpHeaderRule(AbstractModel):
    ...
    @property
    def HeaderMode(self):
        r"""HTTP header setting method. Valid values: `add` (add header), `set` (set header) or `del` (delete header).
        :rtype: str
        """
        return self._HeaderMode
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable HTTPS. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def VerifyClient(self):
        r"""Client certificate authentication feature
`on`: Enable
`off`: Disable
This is disabled by default. The client certificate information is needed when enabled. This is still in beta and not generally available yet.
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def CertInfo(self):
        r"""Server certificate configuration information
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.ServerCert`
        """
        return self._CertInfo
    ...
    def ClientCertInfo(self):
        r"""Client certificate configuration information
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.ClientCert`
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def SslStatus(self):
        r"""HTTPS certificate deployment status
closed: already closed
deploying: in deployment
deployed: successfully deployed
failed: deployment failed
...
class HttpsBilling(AbstractModel):
    r"""HTTPS. When it’s disabled, HTTPS requests are blocked.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r""" Whether to enable origin-pull authentication for Huawei Cloud OBS origin. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def GuetzliAdapter(self):
        r"""`GuetzliAdapter` configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class IpFilter(AbstractModel):
    r"""IP blocklist/allowlist configuration. This is disabled by default.
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable IP blocklist/allowlist. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
class IpFilterPathRule(AbstractModel):
    r"""IP blocklist/allowlist path-based configuration
...
class IpFreqLimit(AbstractModel):
    r"""Access limit configuration for a single IP of a single node. This is disabled by default.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable IP rate limit. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
    ...
    @property
    def Qps(self):
        r"""Sets the limited number of requests per second
514 will be returned for requests that exceed the limit
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: int
        """
...
class Ipv6(AbstractModel):
    r"""IPv6 origin configuration (changes not allowed).
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable an IPv6 address for the origin server. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable IPv6 access. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
class KeyRule(AbstractModel):
    r"""Path-based cache key configuration
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def RuleTag(self):
        r"""Path cache key tag, the value "user" is passed.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
class ListClsLogTopicsRequest(AbstractModel):
    r"""ListClsLogTopics request structure.
...
class ListClsLogTopicsResponse(AbstractModel):
    r"""ListClsLogTopics response structure.
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Logset(self):
        r"""Information of logsets in the Shanghai region
        :rtype: :class:`tencentcloud.cdn.v20180606.models.LogSetInfo`
        """
        return self._Logset
    ...
    @property
    def Topics(self):
        r"""Information of log topics in the Shanghai region
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: list of TopicInfo
        """
        return self._Topics
    ...
    def ExtraLogset(self):
        r"""Information on logsets in regions except Shanghai
Note: this field may return `null`, indicating that no valid values can be obtained.
...
class ListClsTopicDomainsRequest(AbstractModel):
    r"""ListClsTopicDomains request structure.
...
class ListClsTopicDomainsResponse(AbstractModel):
    r"""ListClsTopicDomains response structure.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def DomainAreaConfigs(self):
        r"""Domain name region configuration, which may contain deleted domain names. If this is to be used in `ManageClsTopicDomains` API, you need to exclude deleted domain names by using the `ListCdnDomains` API.
        :rtype: list of DomainAreaConfig
        """
        return self._DomainAreaConfigs
...
class ListTopDataRequest(AbstractModel):
    r"""ListTopData request structure.
...
`client`: Query data of the client region where the request devices are located; if `Metric` is `host`, supported filters are `flux`, `request`, and `bandwidth`.
    ...
    @property
    def StartTime(self):
        r"""Query start time in the format of `yyyy-MM-dd HH:mm:ss`
Only data queries at the granularity of minutes are supported. The start time is truncated to minutes. For example, if the value of `StartTime` is 2018-09-04 10:40:23, the start time of the data returned is 2018-09-04 10:40:00.
Only data for the last 90 days can be queried.
        :rtype: str
        """
    ...
    @property
    def EndTime(self):
        r"""Query end time in the format of `yyyy-MM-dd HH:mm:ss`
Only data queries at the granularity of days are supported. Take the day in the input parameter as the end date, and the data generated on or before 23:59:59 on the end date is returned. For example, if the value of `EndTime` is 2018-09-05 22:40:00, the end time of the data returned is 2018-09-05 23:59:59.
`EndTime` must be later than or equal to `StartTime`.
        :rtype: str
        """
...
`originHost`: Sort by domain name origin-pull data. Supported filters are `flux`, `request`, `bandwidth`, and `OriginStatusCode` (origin_2XX, origin_3XX, origin_4XX, origin_5XX).
    ...
    @property
    def Filter(self):
        r"""Metric name used for sorting:
flux: If Metric is `host`, it indicates the access traffic; if Metric is `originHost`, it indicates the origin-pull traffic.
bandwidth: If Metric is `host`, it indicates the access bandwidth; if Metric is `originHost`, it indicates the origin-pull bandwidth.
request: If Metric is `host`, it indicates the number of access requests; if Metric is `originHost`, it indicates the number of origin-pull requests.
fluxHitRate: Average traffic hit rate
...
Please note that if domain names are specified, this parameter will be ignored.
    ...
    @property
    def Detail(self):
        r"""The sorted results of all domain names are returned by default (false) during a multi-domain-name query
If `Metric` is `url`, `path`, `district`, or `isp` and `Filter` is `flux` or `request`, it can be set to `true` to return the sorted results of each domain.
        :rtype: bool
        """
        return self._Detail
    ...
    @property
    def Code(self):
        r"""When Filter is `statusCode` or `OriginStatusCode`, enter a code to query and sort results.
        :rtype: str
        """
        return self._Code
...
`overseas`: Query CDN data outside the Chinese mainland. Supported metrics are `url`, `district`, `host`, and `originHost`. If `Metric` is `originHost`, supported filters are `flux`, `request`, and `bandwidth`.
    ...
    @property
    def AreaType(self):
        r"""Specifies a region type for the query. If it is left blank, data of the service region will be queried. This parameter is only valid when `Area` is `overseas` and `Metric` is `district` or `host`.
`server`: Query by the location of server (Tencent Cloud CDN nodes).
`client`: Query data of the client region where the request devices are located; if `Metric` is `host`, supported filters are `flux`, `request`, and `bandwidth`.
        :rtype: str
        """
    ...
    @property
    def Limit(self):
        r"""Returns the first N data entries. The default value is 100 if this parameter is not specified, whereas 1000 if `Metric` is `url`.
        :rtype: int
        """
        return self._Limit
...
class ListTopDataResponse(AbstractModel):
    r"""ListTopData response structure.
    ...
    @property
    def Data(self):
        r"""Top access data details of each resource
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def IsDefault(self):
        r"""Whether it is the default logset
        :rtype: int
        """
    ...
    def LogsetSavePeriod(self):
        r"""Log retention period in days
        :rtype: int
        """
    ...
    @property
    def Deleted(self):
        r"""Whether the logset has been removed from CLS
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
    ...
    @property
    def RegionEn(self):
        r"""Whether English is used in this region
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def DownstreamCapping(self):
        r"""Download speed limit configuration.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.DownstreamCapping`
        """
        return self._DownstreamCapping
    ...
    @property
    def ErrorPage(self):
        r"""Error code redirect configuration.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.ErrorPage`
        """
        return self._ErrorPage
    ...
    @property
    def FollowRedirect(self):
        r"""301 and 302 automatic origin-pull follow-redirect configuration.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.FollowRedirect`
        """
        return self._FollowRedirect
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def IpFreqLimit(self):
        r"""IP access limiting configuration.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.IpFreqLimit`
        """
        return self._IpFreqLimit
    ...
    @property
    def MaxAge(self):
        r"""Browser cache rules configuration.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.MaxAge`
        """
        return self._MaxAge
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def OriginPullOptimization(self):
        r"""Cross-border optimization configuration.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.OriginPullOptimization`
        """
        return self._OriginPullOptimization
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Referer(self):
        r"""Hotlink protection configuration.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.Referer`
        """
        return self._Referer
    ...
    @property
    def RequestHeader(self):
        r"""Origin-pull request header configuration.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.RequestHeader`
        """
        return self._RequestHeader
    ...
    @property
    def ResponseHeader(self):
        r"""Origin server response header configuration.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.ResponseHeader`
        """
        return self._ResponseHeader
    ...
    @property
    def ResponseHeaderCache(self):
        r"""Follows origin server cache header configuration.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.ResponseHeaderCache`
        """
        return self._ResponseHeaderCache
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def ServiceType(self):
        r"""Domain name service type. Values: `web` (static acceleration); `download` (download acceleration); `media` (streaming media acceleration).
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
        return self._ServiceType
...
class ManageClsTopicDomainsRequest(AbstractModel):
    r"""ManageClsTopicDomains request structure.
    ...
    @property
    def DomainAreaConfigs(self):
        r"""Domain name region configuration. Note: if this field is empty, it means to unbind all domain names from the corresponding topic
        :rtype: list of DomainAreaConfig
        """
        return self._DomainAreaConfigs
...
class ManageClsTopicDomainsResponse(AbstractModel):
    r"""ManageClsTopicDomains response structure.
...
class MapInfo(AbstractModel):
    r"""Mapping between a name and an ID
...
class MaxAge(AbstractModel):
    r"""Browser cache rule configuration, which is used to set the default value of `MaxAge` and is disabled by default.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable browser caching. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
`clear`: Clear the cache-control header.
    ...
    def StatusCodes(self):
        r"""Specifies the HTTP status code in the range 400-599.
        :rtype: list of str
        """
...
Note: The value `0` means not to cache.
    ...
    def FollowOrigin(self):
        r"""Whether to follow the origin server. Valid values: `on` and `off`. If it's on, `MaxAgeTime` is ignored.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
class ModifyDomainConfigRequest(AbstractModel):
    r"""ModifyDomainConfig request structure.
    ...
    @property
    def Route(self):
        r"""Name of the configuration parameter.
        :rtype: str
        """
        return self._Route
    ...
    @property
    def Value(self):
        r"""Value of the configuration parameter. This field is serialized to a JSON string {key:value}, where **key** is fixed to `update`.
        :rtype: str
        """
        return self._Value
...
class ModifyDomainConfigResponse(AbstractModel):
    r"""ModifyDomainConfig response structure.
...
class OfflineCache(AbstractModel):
    r"""Offline cache feature status switch.
...
`off`: Disable
    ...
    @property
    def Switch(self):
        r"""Whether to enable offline caching. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
class Origin(AbstractModel):
    r"""Complex origin server configurations. The following configurations are supported:
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Origins(self):
        r"""List of primary origin servers
<font color=red>When modifying the origins, you need to specify `OriginType`.</font>
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: list of str
        """
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    def CosPrivateAccess(self):
        r"""When OriginType is COS, you can specify if access to private buckets is allowed.
Note: To enable this configuration, you need to first grant CDN access to the private bucket. Values: `on` and `off`.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def BackupOrigins(self):
        r"""List of secondary origin servers
<font color=red>This field is used together with `BackupOriginType`.</font>
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: list of str
        """
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    def BackupServerName(self):
        r"""Host header used when accessing the backup origin server. If it is left empty, the `ServerName` of primary origin server will be used by default.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def PathRules(self):
        r"""Origin-pull path rewriting configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def PathBasedOrigin(self):
        r"""Path-based origin-pull configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    def AdvanceHttps(self):
        r"""HTTPS advanced origin-pull configuration
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def OriginCompany(self):
        r"""Third-party object storage service vendor
<font color=red>This field is required when `OriginType=third-party`.</font>
Values:
`aws_s3`: AWS S3
`ali_oss`: Alibaba Cloud OSS
...
class OriginAuthentication(AbstractModel):
    r"""Origin-pull authentication advanced configuration
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable advanced origin-pull authentication. Values:
`on`: Enable
`off`: Disable
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def TypeA(self):
        r"""Authentication type configuration A
Note: this field may return `null`, indicating that no valid values can be obtained.
...
class OriginAuthenticationTypeA(AbstractModel):
    r"""Origin-pull authentication advanced configuration TypeA
...
class OriginCombine(AbstractModel):
    r"""Merging pull requests configuration item
...
`off`: Disable
    ...
    @property
    def Switch(self):
        r"""Whether to enable origin-pull merge. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
class OriginIp(AbstractModel):
    r"""IP information of CDN intermediate nodes
    ...
    @property
    def Ip(self):
        r"""Intermediate IP range/intermediate IP. The IP range information is returned by default.
        :rtype: str
        """
        return self._Ip
...
class OriginPullOptimization(AbstractModel):
    r"""(Disused) Cross-border origin-pull optimization
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable cross-MLC-border origin-pull optimization. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    def ConnectTimeout(self):
        r"""The origin-pull connection timeout (in seconds). Valid range: 5-60.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: int
        """
    ...
    def ReceiveTimeout(self):
        r"""The origin-pull receipt timeout (in seconds). Valid range: 10-300.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: int
        """
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable HTTPS origin-pull SNI. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
class OssPrivateAccess(AbstractModel):
    r"""Access authentication configuration for OSS origin
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable OSS origin-pull authentication. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable origin-pull authentication for other object storage origins. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def ForceRedirect(self):
        r"""Protocol redirect configuration.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.ForceRedirect`
        """
        return self._ForceRedirect
...
For `index`, enter a forward slash `/`.
    ...
    @property
    def Origin(self):
        r"""Origin server list. Domain name and IPv4 addresses are supported.
        :rtype: list of str
        """
        return self._Origin
...
class PathRule(AbstractModel):
    r"""Path-based origin-pull configuration rules
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Regex(self):
        r"""Whether to enable wildcard match (`*`).
`false`: disabled
`true`: enabled
Note: this field may return `null`, indicating that no valid value can be obtained.
        :rtype: bool
    ...
    @property
    def Path(self):
        r"""Matched URL. Only URLs are supported, while parameters are not. The exact match is used by default. If wildcard match is enabled, up to 5 wildcards are supported. The URL can contain up to 1,024 characters.
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
        return self._Path
    ...
    @property
    def Origin(self):
        r"""Origin server when the path matches. COS origin with private read/write is not supported. The default origin server will be used by default when this field is left empty.
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
        return self._Origin
    ...
    @property
    def ServerName(self):
        r"""Origin server host header when the path matches. The default `ServerName` will be used by default when this field is left empty.
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
        return self._ServerName
    ...
    @property
    def OriginArea(self):
        r"""Region of the origin server. Valid values: `CN` and `OV`.
`CN`: Within the Chinese mainland
`OV`: Outside the Chinese mainland
Default value: `CN`.
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def ForwardUri(self):
        r"""Origin server URI path when the path matches, starting with `/` and excluding parameters. The path can contain up to 1,024 characters. The wildcards in the match path can be respectively captured using `$1`, `$2`, `$3`, `$4`, and `$5`. Up to 10 values can be captured.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
    ...
    def RequestHeaders(self):
        r"""Origin-pull header setting when the path matches.
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def FullMatch(self):
        r"""When `Regex` is `false`, this parameter should be `true`.
`false`: Disabled
`true`: enabled
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: bool
...
`off`: Disable
    ...
    @property
    def Switch(self):
        r"""Maximum size of the file uploaded for streaming via a POST request. Values:
`on`: Enable. When enabled, it is set to 32 MB by default.
`off`: Disable
    ...
    @property
    def MaxSize(self):
        r"""Maximum size. Value range: 1 MB to 200 MB.
        :rtype: int
        """
...
class PurgePathCacheRequest(AbstractModel):
    r"""PurgePathCache request structure.
...
The specified region to purge should match the domain name’s acceleration region.
    ...
    @property
    def Paths(self):
        r"""List of directories. The protocol header such as "http://" or "https://" needs to be included.
        :rtype: list of str
        """
        return self._Paths
...
`delete`: purges all resources
    ...
    @property
    def UrlEncode(self):
        r"""Whether to encode Chinese characters before purge.
        :rtype: bool
        """
...
class PurgePathCacheResponse(AbstractModel):
    r"""PurgePathCache response structure.
    ...
    @property
    def TaskId(self):
        r"""Purge task ID. Directories submitted in one request share a task ID.
        :rtype: str
        """
        return self._TaskId
...
class PurgeUrlsCacheRequest(AbstractModel):
    r"""PurgeUrlsCache request structure.
...
The specified purging region should match the domain name acceleration region.
    ...
    @property
    def UrlEncode(self):
        r"""Whether to encode Chinese characters for purge
        :rtype: bool
        """
        return self._UrlEncode
...
class PurgeUrlsCacheResponse(AbstractModel):
    r"""PurgeUrlsCache response structure.
    ...
    @property
    def TaskId(self):
        r"""Purge task ID. URLs submitted in one request share a task ID.
        :rtype: str
        """
        return self._TaskId
...
`invalid`: Invalid prefetch with 4XX/5XX status code returned from the origin server
    ...
    @property
    def Percent(self):
        r"""Prefetch progress in percentage
        :rtype: int
        """
    ...
    @property
    def CreateTime(self):
        r"""Prefetch task submission time
        :rtype: str
        """
        return self._CreateTime
...
class PushUrlsCacheRequest(AbstractModel):
    r"""PushUrlsCache request structure.
...
This feature is in beta test.
    ...
    @property
    def UserAgent(self):
        r"""Specifies the User-Agent header of an HTTP prefetch request when it is forwarded to the origin server
Default value: `TencentCdn`
        :rtype: str
        """
    ...
    @property
    def Area(self):
        r"""Destination region for the prefetch
`mainland`: prefetches resources to nodes within Mainland China
`overseas`: prefetches resources to nodes outside Mainland China
`global`: prefetches resources to global nodes
Default value: `mainland`. You can prefetch a URL to nodes in a region provided that CDN service has been enabled for the domain name in the URL in the region.
    ...
    @property
    def Layer(self):
        r"""By default, prefetch for regions in the Chinese mainland is performed onto the intermediate nodes, while prefetch for regions outside the Chinese mainland is performed onto the edge nodes and the traffic generated will be billed.
If this parameter is `middle` or left empty, prefetch will be performed onto the intermediate node.
        :rtype: str
        """
        return self._Layer
    ...
    @property
    def ParseM3U8(self):
        r"""Whether to recursively resolve the M3U8 index file and prefetch the TS shards in it.
Notes:
1. This feature requires that the M3U8 index file can be directly requested and obtained.
2. In the M3U8 index file, currently only the TS shards at the first to the third level can be recursively resolved.
3. Prefetching the TS shards obtained through recursive resolution consumes the daily prefetch quota. If the usage exceeds the quota, the feature will be disabled and TS shards will not be prefetched.
    ...
    def DisableRange(self):
        r"""Specifies whether to disable Range GETs.
Notes:
This feature is in beta test.
        :rtype: bool
        """
    ...
    @property
    def Headers(self):
        r"""Custom HTTP request headers (Up to 20). `Name`: Up to 128 characters. `Value`: Up to 1024 characters.
...
class PushUrlsCacheResponse(AbstractModel):
    r"""PushUrlsCache response structure.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable origin-pull authentication for QiNiu Cloud Kodo. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to include `QueryString` as part of `CacheKey`. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Action(self):
        r"""Whether to include URL parameters. Values:
`includeAll`: Include all parameters.
`excludeAll`: Exclude all parameters.
`includeCustom`: Include custom parameters.
`excludeCustom`: Exclude custom parameters.
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Value(self):
        r"""Array of included/excluded query strings (separated by ';')
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
        return self._Value
...
`off`: Disable
    ...
    @property
    def Switch(self):
        r"""Whether to enable QUIC. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
class Quota(AbstractModel):
    r"""Purge/Prefetch available usage and quota
    ...
    @property
    def Batch(self):
        r"""Quota limit for one batch submission request.
        :rtype: int
        """
        return self._Batch
    ...
    @property
    def Total(self):
        r"""Daily submission quota limit.
        :rtype: int
        """
        return self._Total
    ...
    @property
    def Available(self):
        r"""Remaining daily submission quota.
        :rtype: int
        """
...
class RangeOriginPull(AbstractModel):
    r"""Range GETs configuration which is enabled by default
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable Range GETs. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
class RedirectConfig(AbstractModel):
    r"""Host header for 302 redirects
...
`off`: Disable
    ...
    @property
    def Switch(self):
        r"""Whether to enable the custom origin-pull request to follow the host when a 302 code is returned. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
    ...
    def FollowRedirectHost(self):
        r"""The custom host header that is sent when the primary origin server follows 302 redirects
        :rtype: str
        """
    ...
    def FollowRedirectBackupHost(self):
        r"""The custom host header that is sent when the secondary origin server follows 302 redirects
        :rtype: str
        """
...
class Referer(AbstractModel):
    r"""Referer blacklist/whitelist configuration. This is disabled by default.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable referer blocklist/allowlist. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
    ...
    def RefererRules(self):
        r"""Referer blacklist/whitelist configuration rule
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class RefererRule(AbstractModel):
    r"""Referer blacklist/whitelist configuration rules, which is effective for specific resources.
...
`blacklist`: Blocklist
    ...
    @property
    def AllowEmpty(self):
        r"""Whether to allow empty referer
`true`: Allow empty referer when `RefererType = whitelist`.
`false`: Reject empty refer when `RefererType = blacklist`.
        :rtype: bool
        """
...
class RegionMapRelation(AbstractModel):
    r"""Association between a region ID and sub-region IDs.
...
class RemoteAuthentication(AbstractModel):
    r"""Configuration of remote authentication rules. Setting up multiple rules is supported.
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable remote authentication. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
    ...
    def RemoteAuthenticationRules(self):
        r"""Remote authentication rule configuration
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Server(self):
        r"""Remote authentication server
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
        return self._Server
...
The server configured in `RemoteAutherntication` is used by default.
    ...
    @property
    def AuthMethod(self):
        r"""HTTP method used by the remote authentication server. Valid values: `get`, `post`, `head`, and `all`. 
`all`: the remote authentication server follows the client request method.
Default: `all`
        :rtype: str
        """
...
Default: `*`
    ...
    def AuthTimeout(self):
        r"""Timeout period of the remote authentication server. Unit: ms.
Value range: [1, 30,000]
Default: 20000
        :rtype: int
        """
    ...
    def AuthTimeoutAction(self):
        r"""Whether to deny or allow the request when the remote authentication server is timed out:
`RETURN_200`: the request is allowed when the remote authentication server is timed out.
`RETURN_403`: the request is denied when the remote authentication server is timed out.
Default: `RETURN_200`
        :rtype: str
...
class ReportData(AbstractModel):
    ...
    @property
    def Value(self):
        r"""Total traffic/max bandwidth in bytes and bps, respectively.
        :rtype: int
        """
        return self._Value
    ...
    @property
    def Percentage(self):
        r"""Percentage of individual resource out of all resources.
        :rtype: float
        """
    ...
    def BillingValue(self):
        r"""Total billable traffic/max billable bandwidth in bytes and bps, respectively.
        :rtype: int
        """
    ...
    def BillingPercentage(self):
        r"""Percentage of billable amount out of total amount.
        :rtype: float
        """
...
class RequestHeader(AbstractModel):
    r"""Custom request header configuration. This is disabled by default.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable custom request headers. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
    ...
    def HeaderRules(self):
        r"""Custom request header configuration rules
Note: This field may return `null`, indicating that no valid value can be obtained.
...
`all`: Details at the account level
    ...
    @property
    def Resource(self):
        r"""Resource name, which is classified as follows based on different query filters:
When a domain name is specified: Details of the domain name
`multiDomains`: Aggregated details of multiple domain names
A specific project ID: ID of the specifically queried project
`all`: Details at the account level
...
class ResourceData(AbstractModel):
    r"""This API is used to query an object and its access details.
...
class ResourceOriginData(AbstractModel):
    r"""This API is used to query an object and its origin-pull details.
...
class ResponseHeader(AbstractModel):
    r"""Custom response header configuration. This is disabled by default.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable custom response headers. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
    ...
    @property
    def HeaderRules(self):
        r"""Custom response header rules
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: list of HttpHeaderPathRule
        """
        return self._HeaderRules
...
class ResponseHeaderCache(AbstractModel):
    r"""Origin server header cache configuration. This is enabled by default and caches all the header information.
...
`off`: Disable
    ...
    @property
    def Switch(self):
        r"""Whether to enable response header caching. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
class Revalidate(AbstractModel):
    r"""Whether to forward to the origin server for verification
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable origin-pull authentication. Values:
`on`: Enable
`off`: Disable
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Path(self):
        r"""Forwards to the origin server for verification only for specific request path
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
        return self._Path
...
class RuleCache(AbstractModel):
    r"""Path-based cache rule configuration
...
class RuleCacheConfig(AbstractModel):
    r"""Path cache configuration, choose one from the following three cache modes.
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable rule engine. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
class RuleQueryString(AbstractModel):
    r"""Configuration to retain query strings for this path
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to include query string parameters. Values:
`on`: Include `QueryString` as part of `CacheKey`.
`off`: Do not include `QueryString` as part of `CacheKey`.
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Action(self):
        r"""`includeCustom` will retain partial query strings
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
        return self._Action
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable scheme as part of the cache key. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
class SearchClsLogRequest(AbstractModel):
    r"""SearchClsLog request structure.
    ...
    @property
    def TopicIds(self):
        r"""List of IDs of log topics to be queried, separated by commas
        :rtype: str
        """
    ...
    @property
    def Context(self):
        r"""This field is used when loading more results. Pass through the last `context` value returned to get more log content. Up to 10,000 logs can be obtained through the cursor. Please narrow down the time range as much as possible.
        :rtype: str
        """
        return self._Context
    ...
    @property
    def Sort(self):
        r"""Sorting by log time. Valid values: asc (ascending), desc (descending). Default value: desc
        :rtype: str
        """
        return self._Sort
...
class SearchClsLogResponse(AbstractModel):
    r"""SearchClsLog response structure.
...
`off`: Disable
    ...
    @property
    def Switch(self):
        r"""Whether to enable SCDN. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
class Seo(AbstractModel):
    r"""SEO configuration. This is disabled by default.
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable SEO. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
class ServerCert(AbstractModel):
    r"""HTTPS acceleration server certificate configuration:
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def CertId(self):
        r"""Server certificate ID, which is auto-generated when the certificate is being managed by the SSL Certificate Service
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
        return self._CertId
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Certificate(self):
        r"""Server certificate information
This is required when uploading an external certificate, which should contain the complete certificate chain.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable Shared CNAME. Values:
`on`: Enable. When enabled, it uses a shared CNAME.
`off`: Disable. When disabled, it uses a default CNAME.
    ...
    @property
    def Cname(self):
        r"""Shared CNAME to be configured
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
        """
        return self._Cname
...
class SimpleCache(AbstractModel):
    r"""Cache configuration basic version
    The cache expiration time for all files is 30 days by default.
    Static acceleration type domain names .php, .jsp, .asp, and .aspx are not cached by default
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def FollowOrigin(self):
        r"""Follows origin server Cache-Control: max-age configurations
`on`: Enable
`off`: Disable
If this is enabled, resources that do not match CacheRules rules will be cached by the node according to the max-age value returned by the origin server. Resources that match CacheRules rules will be cached on the node according to the cache expiration time set in CacheRules.
This conflicts with CompareMaxAge. The two cannot be enabled at the same time.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def IgnoreSetCookie(self):
        r"""Ignores the Set-Cookie header of the origin server
`on`: Enable
`off`: Disable
It is disabled by default.
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class SimpleCacheRule(AbstractModel):
    r"""Cache expiration rules configuration
...
Default value: createTime.
    ...
    @property
    def Key(self):
        r"""Fields that can be sorted. Currently supports:
`createTime`: domain name creation time.
`certExpireTime`: certificate expiration time.
Default value: createTime.
        :rtype: str
...
class SpecificConfig(AbstractModel):
    r"""Specific configuration for domain names inside and outside mainland China by regions.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Mainland(self):
        r"""Specific configuration for domain name inside mainland China.
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Overseas(self):
        r"""Specific configuration for domain name outside mainland China.
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class StartCdnDomainRequest(AbstractModel):
    r"""StartCdnDomain request structure.
...
class StartCdnDomainResponse(AbstractModel):
    r"""StartCdnDomain response structure.
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Type(self):
        r"""Type of usage limit. `total`: Cumulative usage; `moment`: Instantaneous usage.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
        return self._Type
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def AlertPercentage(self):
        r"""Threshold (in percentage) that triggers alarms
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: int
        """
        return self._AlertPercentage
    ...
    @property
    def AlertSwitch(self):
        r"""Whether to enable alerts for cumulative usage limit. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
    ...
    @property
    def Metric(self):
        r"""Metric type. `flux`: Traffic; `bandwidth`: Bandwidth.
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
        return self._Metric
    ...
    @property
    def Switch(self):
        r"""Whether to enable cumulative usage limit. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
class StatusCodeCache(AbstractModel):
    r"""Status code cache expiration configuration. 404 status codes are cached for 10 seconds by default
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable status code caching. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
    ...
    @property
    def CacheRules(self):
        r"""Status code cache expiration rules details
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class StatusCodeCacheRule(AbstractModel):
    r"""Status code cache expiration time rule configuration
...
Supports 403 and 404 status codes
    ...
    @property
    def CacheTime(self):
        r"""Status code cache expiration time (in seconds)
        :rtype: int
        """
        return self._CacheTime
...
class StopCdnDomainRequest(AbstractModel):
    r"""StopCdnDomain request structure.
...
class StopCdnDomainResponse(AbstractModel):
    r"""StopCdnDomain response structure.
...
class SummarizedData(AbstractModel):
    r"""Aggregated value, which is aggregated from all data of each metric. Aggregation methods are used depending on the metric attributes.
...
`avg`: Average value
    ...
    @property
    def Name(self):
        r"""Aggregation method, which can be:
`sum`: Aggregate summation
`max`: Maximum value. In bandwidth mode, the peak bandwidth is calculated based on the data aggregated in 5 minutes.
`avg`: Average value
        :rtype: str
...
class Tag(AbstractModel):
    r"""Domain name tag configuration
...
class TimestampData(AbstractModel):
    r"""Timestamp and its corresponding value
...
For example, if the time is set to 13:35:00, and `interval` is `5min`, the data returned is collected between 13:35:00 and 13:39:59
    ...
    @property
    def Time(self):
        r"""The start point of the sampling period. 
For example, if the time is set to 13:35:00, and `interval` is `5min`, the data returned is collected between 13:35:00 and 13:39:59
        :rtype: str
        """
        return self._Time
...
class TopData(AbstractModel):
    r"""Data structure of sorted data
...
all: This indicates the details at the account level
    ...
    @property
    def Resource(self):
        r"""Resource name, which is classified as follows based on different query conditions:
A specific domain name: This indicates the details of this domain name
multiDomains: This indicates the aggregate details of multiple domain names
Project ID: This displays the ID of the specifically queried project
all: This indicates the details at the account level
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Enabled(self):
        r"""Whether to enable publishing
        :rtype: int
        """
...
class TpgAdapter(AbstractModel):
    r"""Image optimization - `TpgAdapter` configuration
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable TpgAdapter for image optimization. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
class UpdateDomainConfigRequest(AbstractModel):
    r"""UpdateDomainConfig request structure.
...
After switching to global acceleration, configurations of the domain name will be deployed to the region inside or outside the Chinese mainland. The deployment will take some time as this domain name has special settings.
    ...
    @property
    def ErrorPage(self):
        r"""Error code redirect configuration (This feature is in beta and not generally available yet.)
        :rtype: :class:`tencentcloud.cdn.v20180606.models.ErrorPage`
        """
        return self._ErrorPage
    ...
    @property
    def OriginPullOptimization(self):
        r"""(Disused) Cross-border linkage optimization\
        :rtype: :class:`tencentcloud.cdn.v20180606.models.OriginPullOptimization`
        """
        return self._OriginPullOptimization
    ...
    @property
    def MaxAge(self):
        r"""Browser cache configuration (This feature is in beta and not generally available yet.)
        :rtype: :class:`tencentcloud.cdn.v20180606.models.MaxAge`
        """
        return self._MaxAge
    ...
    @property
    def SpecificConfig(self):
        r"""Specific-region special configuration
Applicable to cases where the acceleration domain name configuration differs for regions in and outside the Chinese mainland.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.SpecificConfig`
        """
        return self._SpecificConfig
...
After switching to global acceleration, configurations of the domain name will be deployed to the region inside or outside the Chinese mainland. The deployment will take some time as this domain name has special settings.
    ...
    @property
    def HttpsBilling(self):
        r"""HTTPS, which is a paid service. You can check the product document and Billing Overview for more information.
        :rtype: :class:`tencentcloud.cdn.v20180606.models.HttpsBilling`
        """
        return self._HttpsBilling
...
class UpdateDomainConfigResponse(AbstractModel):
    r"""UpdateDomainConfig response structure.
...
class UpdatePayTypeRequest(AbstractModel):
    r"""UpdatePayType request structure.
    ...
    @property
    def Area(self):
        r"""Billing region, which can be `mainland` or `overseas`.
        :rtype: str
        """
        return self._Area
    ...
    @property
    def PayType(self):
        r"""Billing mode, which can be `flux` or `bandwidth`.
        :rtype: str
        """
        return self._PayType
...
class UpdatePayTypeResponse(AbstractModel):
    r"""UpdatePayType response structure.
...
Note: this field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable URL rewriting. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
    ...
    @property
    def PathRules(self):
        r"""Rule of URL rewriting rule, which is required if `Switch` is `on`. There can be up to 10 rules.
Note: this field may return `null`, indicating that no valid value can be obtained.
...
class UrlRedirectRule(AbstractModel):
    r"""URL redirect rule configuration
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def RedirectStatusCode(self):
        r"""Redirect status code. Valid values: 301, 302
        :rtype: int
        """
        return self._RedirectStatusCode
    ...
    @property
    def Pattern(self):
        r"""URL to be matched. Only URLs are supported, while parameters are not. The exact match is used by default. In regex match, up to 5 wildcards `*` are supported. The URL can contain up to 1,024 characters.
        :rtype: str
        """
    ...
    @property
    def RedirectUrl(self):
        r"""Target URL, starting with `/` and excluding parameters. The path can contain up to 1,024 characters. The wildcards in the matching path can be respectively captured using `$1`, `$2`, `$3`, `$4`, and `$5`. Up to 10 values can be captured.
        :rtype: str
        """
        return self._RedirectUrl
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def FullMatch(self):
        r"""Whether to use full-path matching or arbitrary matching
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: bool
        """
        return self._FullMatch
...
class UserAgentFilter(AbstractModel):
    r"""`UserAgent` blacklist/whitelist configuration
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable User-Agent blocklist/allowlist. Values:
`on`: Enable
`off`: Disable
Note: This field may return `null`, indicating that no valid values can be obtained.
        :rtype: str
...
class UserAgentFilterRule(AbstractModel):
    r"""`UserAgent` blacklist/whitelist rule configuration
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    @property
    def FilterType(self):
        r"""Blocklist or allowlist. Valid values: `blacklist`, `whitelist`
Note: This field may return `null`, indicating that no valid value can be obtained.
        :rtype: str
        """
        return self._FilterType
...
class VideoSeek(AbstractModel):
    r"""Video dragging configuration. This is disabled by default.
...
`off`: Disable
    ...
    @property
    def Switch(self):
        r"""Whether to enable video dragging. Values:
`on`: Enable
`off`: Disable
        :rtype: str
        """
...
`complain`: Appeal in process
    ...
    @property
    def RealUrl(self):
        r"""Origin access URL of the resource in violation
        :rtype: str
        """
        return self._RealUrl
    ...
    def DownloadUrl(self):
        r"""Snapshot path. This is used to display a snapshot of the content in violation on the console.
        :rtype: str
        """
    ...
    @property
    def UrlStatus(self):
        r"""Current status of non-compliant resource
`forbid`: Blocked
`release`: Unblocked
`delay`: Processing delayed
`reject`: Appeal dismissed. It is still in `forbid` status.
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable WebSocket connection timeout. Values:
`on`: When it's enabled, the connection timeout can be configured.
`off`: When it's disabled, the connection timeout is set to 15 seconds by default.
    ...
    @property
    def Timeout(self):
        r"""Sets timeout period in seconds. Maximum value: 300
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: int
        """
...
class WebpAdapter(AbstractModel):
    r"""Image optimization - `WebpAdapter` configuration
...
Note: This field may return·`null`, indicating that no valid values can be obtained.
    ...
    @property
    def Switch(self):
        r"""Whether to enable WebpAdapter for image optimization. Values:
`on`: Enable
`off`: Disable
Note: This field may return·`null`, indicating that no valid values can be obtained.
        :rtype: str
