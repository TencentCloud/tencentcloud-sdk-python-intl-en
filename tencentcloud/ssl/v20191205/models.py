...
class CheckCertificateDomainVerificationRequest(AbstractModel):
    r"""CheckCertificateDomainVerification request structure.
...
class CheckCertificateDomainVerificationResponse(AbstractModel):
    r"""CheckCertificateDomainVerification response structure.

    """

    def __init__(self):
        r"""
        :param _VerificationResults: Domain validation result list. If the cert is bound to multiple domain names, the return array contains multiple items.
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    def VerificationResults(self):
        r"""Domain validation result list. If the cert is bound to multiple domain names, the return array contains multiple items.
Note: This field may return null, indicating that no valid values can be obtained.
...
class ClbInstanceDetail(AbstractModel):
    ...
    @property
    def Forward(self):
        r"""CLB type. 0 classic CLB; 1 application CLB.
        :rtype: int
        """
...
class DescribeCertificateBindResourceTaskDetailRequest(AbstractModel):
    ...
    @property
    def TaskId(self):
        r"""<p>Task ID. Query the result of binding cloud resources based on the task ID obtained from CreateCertificateBindResourceSyncTask.</p>
        :rtype: str
        """
        return self._TaskId
    ...
    @property
    def Limit(self):
        r"""<p>Number of items per page, default 10, maximum value 100; total pages is the total number of instances in the resource region, that is, page 1 will pull the number of instances under each Tencent Cloud resource region up to the Limit</p>
        :rtype: str
        """
        return self._Limit
    ...
    def ResourceTypes(self):
        r"""<p>Query result details of the resource type. Query all if not specified. Supported values: - clb- cdn- ddos- live- vod- waf- apigateway- teo- tke- cos- tse- tcb</p>
        :rtype: list of str
        """
    ...
    @property
    def Regions(self):
        r"""<p>Query the data of region list. clb, tke, waf, API Gateway, tcb, cos, and tse support query region. Other resource types are unsupported.</p>
        :rtype: list of str
        """
...
class DescribeCertificateBindResourceTaskDetailResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _CLB: <p>clb resource detail</p>
        :type CLB: list of ClbInstanceList
        :param _CDN: <p>cdn resource detail</p>
        :type CDN: list of CdnInstanceList
        :param _WAF: <p>waf resource detail</p>
        :type WAF: list of WafInstanceList
        :param _DDOS: <p>Associate ddos resource detail</p>
        :type DDOS: list of DdosInstanceList
        :param _LIVE: <p>Associate live resource detail</p>
        :type LIVE: list of LiveInstanceList
        :param _VOD: <p>vod resource detail</p>
        :type VOD: list of VODInstanceList
        :param _TKE: <p>tke resource detail</p>
        :type TKE: list of TkeInstanceList
        :param _APIGATEWAY: <p>apigateway resource detail</p>
        :type APIGATEWAY: list of ApiGatewayInstanceList
        :param _TCB: <p>tcb resource detail</p>
        :type TCB: list of TCBInstanceList
        :param _TEO: <p>Associate teo resource detail</p>
        :type TEO: list of TeoInstanceList
        :param _Status: <p>Associate cloud resources async query result: 0 indicates querying, 1 indicates success. 2 indicates an exception. If the status is 1, view the BindResourceResult. If the status is 2, view the Error reason.</p>
        :type Status: int
        :param _CacheTime: <p>Current result cache time</p>
        :type CacheTime: str
        :param _TSE: <p>Associate tse resource detail</p>
        :type TSE: list of TSEInstanceList
        :param _COS: <p>Associated COS resource detail</p>
        :type COS: list of COSInstanceList
        :param _TDMQ: <p>Associated TDMQ - Rabbit resource detail</p>
        :type TDMQ: list of TDMQInstanceList
        :param _MQTT: <p>Associated MQTT resource detail</p>
        :type MQTT: list of MQTTInstanceList
        :param _GAAP: <p>Associated GAAP resource detail</p>
        :type GAAP: list of GAAPInstanceList
        :param _SCF: <p>Associated SCF resource detail</p>
    ...
    @property
    def DDOS(self):
        r"""<p>Associate ddos resource detail</p>
    ...
    @property
    def LIVE(self):
        r"""<p>Associate live resource detail</p>
    ...
    @property
    def APIGATEWAY(self):
        r"""<p>apigateway resource detail</p>
    ...
    @property
    def TEO(self):
        r"""<p>Associate teo resource detail</p>
    ...
    @property
    def Status(self):
        r"""<p>Associate cloud resources async query result: 0 indicates querying, 1 indicates success. 2 indicates an exception. If the status is 1, view the BindResourceResult. If the status is 2, view the Error reason.</p>
        :rtype: int
        """
        return self._Status
    ...
    @property
    def CacheTime(self):
        r"""<p>Current result cache time</p>
        :rtype: str
        """
    ...
    @property
    def TSE(self):
        r"""<p>Associate tse resource detail</p>
    ...
    @property
    def COS(self):
        r"""<p>Associated COS resource detail</p>
    ...
    @property
    def TDMQ(self):
        r"""<p>Associated TDMQ - Rabbit resource detail</p>
    ...
    @property
    def MQTT(self):
        r"""<p>Associated MQTT resource detail</p>
    ...
    @property
    def GAAP(self):
        r"""<p>Associated GAAP resource detail</p>
    ...
    @property
    def SCF(self):
        r"""<p>Associated SCF resource detail</p>
...
class DescribeHostUploadUpdateRecordDetailResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _DeployRecordDetail: Hosting record detail list.
...
class DomainValidationResult(AbstractModel):
    r"""Domain validation result of the certificate
    ...
    @property
    def Domain(self):
        r"""Domain names bound to the certificate.
        :rtype: str
        """
        return self._Domain
    ...
    @property
    def VerifyType(self):
        r"""Domain name validation type. Value is DNS, FILE, DNS_AUTO, DNS_PROXY, or FILE_PROXY.
        :rtype: str
        """
        return self._VerifyType
    ...
    @property
    def LocalCheck(self):
        r"""Tencent Cloud detection result, Value: 1 (verified); -1 (rate limited or txt record not found); -2 (txt record not match); -3 (ns record not found); -4 (file not found); -5 (file not match); -6 (cname record not found); -7 (cname record not match); -8 (ns record not found); -9 (file not found); -10 (file not match).
    ...
    @property
    def CaCheck(self):
        r"""CA check result. Value: -1 (detection failed); 2 (detection passed).
        :rtype: int
        """
    ...
    def LocalCheckFailReason(self):
        r"""Check failure reasons. Description of the LocalCheck status.
        :rtype: str
        """
    ...
    @property
    def Frequently(self):
        r"""Whether the request is rate-limited. Valid values: false (not rate-limited); true (rate-limited).
        :rtype: bool
        """
    ...
    @property
    def Issued(self):
        r"""Whether the certificate has been issued. Value: false (not issued); true (issued).
        :rtype: bool
        """
        return self._Issued
...
class GAAPInstanceList(AbstractModel):
    r"""GAAP instance details - Asynchronous associate cloud resources data structure
...
class GAAPListenerDetail(AbstractModel):
    ...
    @property
    def CertIdList(self):
        r"""Certificate list associated with CVM instances	
        :rtype: list of str
        """
...
class GatewayCertificate(AbstractModel):
    ...
    @property
    def CertId(self):
        r"""Currently bound SSL certificate ID
        :rtype: str
        """
        return self._CertId
...
class MQTTInstanceList(AbstractModel):
    r"""MQTT instance details - Asynchronously associate cloud resources data structure
...
class ModifyCertificatesExpiringNotificationSwitchResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _CertificateIds: Certificate ID list.
        :type CertificateIds: list of str
        :param _RequestId: The unique request ID, generated by the server, will be returned for every request (if the request fails to reach the server for other reasons, the request will not obtain a RequestId). RequestId is required for locating a problem.
        :type RequestId: str
        """
...
class RevokeCertificateRequest(AbstractModel):
    r"""RevokeCertificate request structure.
    ...
    @property
    def Reason(self):
        r"""Reason to revoke certificate.
        :rtype: str
        """
        return self._Reason
...
class RevokeCertificateResponse(AbstractModel):
    r"""RevokeCertificate response structure.

    """

    def __init__(self):
        r"""
        :param _RevokeDomainValidateAuths: Revoke certificate domain name verification info.
    ...
    def RevokeDomainValidateAuths(self):
        r"""Revoke certificate domain name verification info.
...
class RevokeDomainValidateAuths(AbstractModel):
    ...
    def DomainValidateAuthPath(self):
        r"""DV authentication value path.
        :rtype: str
        """
    ...
    def DomainValidateAuthDomain(self):
        r"""DV authentication domain name.
        :rtype: str
        """
...
class SCFInstanceList(AbstractModel):
    r"""SCF Instance Details - Asynchronous Associate Cloud Resources Data Structure
    ...
    @property
    def TotalCount(self):
        r"""<p>Total count in the region</p>
        :rtype: int
        """
        return self._TotalCount
...
class TCBAccessInstance(AbstractModel):
    ...
    def IsPreempted(self):
        r"""Whether it is preempted. Preemption means the domain name is bound to another environment and must be unbound or rebound.
    ...
    @property
    def ICPStatus(self):
        r"""icp blocklist ban status. 0 - Not blocked. 1 - Blocked.
...
class TDMQInstanceDetail(AbstractModel):
    r"""TDMQ - Rabbit instance details
...
class TDMQInstanceList(AbstractModel):
    r"""TDMQ - Rabbit instance details - Asynchronously associate cloud resources data structure
...
`Issued`: binding failed.
    ...
    @property
    def Algorithm(self):
        r"""Certificate encryption algorithm
        :rtype: str
        """
...
class UploadUpdateCertificateInstanceResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _DeployRecordId: The tencent cloud resource update task ID. DeployRecordId equals 0 indicates the task is in progress. Repeatedly request this API, and when DeployRecordId is greater than 0, it means the task has been successfully created. If not successfully created, an exception will be thrown.
        :type DeployRecordId: int
        :param _DeployStatus: Update task creation status: 1 indicates successful creation; 0 indicates an existing ongoing update task, and no new update task was created. The return value DeployRecordId represents the ID of the ongoing update task.
        :type DeployStatus: int
        :param _UpdateSyncProgress: Create progress details for asynchronous update tasks.
Note: This field may return null, indicating that no valid values can be obtained.
        :type UpdateSyncProgress: list of UpdateSyncProgress
        :param _RequestId: The unique request ID, generated by the server, will be returned for every request (if the request fails to reach the server for other reasons, the request will not obtain a RequestId). RequestId is required for locating a problem.
        :type RequestId: str
