...
class AvailableType(AbstractModel):
    ...
    @property
    def Protocols(self):
        r"""<p>Protocol and sale details</p>
    ...
    @property
    def Type(self):
        r"""<p>Storage type. In the return value, SD indicates General Standard Storage, HP indicates General Performance Storage, TB indicates Standard Turbo, and TP indicates High-Performance Turbo.</p>
        :rtype: str
        """
        return self._Type
    ...
    @property
    def Prepayment(self):
        r"""<p>Support for prepaid. In the return value, true means supported and false means unsupported.</p>
        :rtype: bool
        """
    ...
    @property
    def Version(self):
        r"""<p>File system version</p><p>Enumeration value:</p><ul><li>v1.5: Universal Series</li><li>v3.1: Universal Series (enhanced)</li><li>v4.0: Turbo series</li></ul>
        :rtype: str
        """
...
class DescribeAvailableZoneInfoResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _RegionZones: <p>Resource sale status in each availability zone as well as supported storage types, storage protocol, etc.</p>
    ...
    def RegionZones(self):
        r"""<p>Resource sale status in each availability zone as well as supported storage types, storage protocol, etc.</p>
