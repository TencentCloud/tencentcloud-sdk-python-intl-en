...
class RceClient(AbstractClient):
    ...
    async def DescribeRiskAssessment(
            self,
            request: models.DescribeRiskAssessmentRequest,
            opts: Dict = None,
        ...
        kwargs = {}
        kwargs["action"] = "DescribeRiskAssessment"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.DescribeRiskAssessmentResponse
