...
class AntiddosClient(AbstractClient):
    ...
    def DescribeDDoSBlockRecords(self, request):
        r"""Query block unblock records and unblocking quota info.
    ...
    def UnblockResources(self, request):
        r"""Apply for unblocking resources. You can obtain the unblocking status of resources through the DescribeDDoSBlockRecords API.
