...
class AccessRule(AbstractModel):
    ...
    @property
    def Address(self):
        r"""Permission rule address (IP range or IP)
        :rtype: str
        """
    ...
    @property
    def AccessMode(self):
        r"""Permission rule access mode (1: read-only; 2: read-write)
        :rtype: int
        """
    ...
    @property
    def Priority(self):
        r"""Priority (value range: 1–100. The smaller the value, the higher the priority)
        :rtype: int
        """
...
class AssociateAccessGroupsRequest(AbstractModel):
    r"""AssociateAccessGroups request structure.
    ...
    def AccessGroupIds(self):
        r"""List of permission group IDs
        :rtype: list of str
        """
...
class AssociateAccessGroupsResponse(AbstractModel):
    r"""AssociateAccessGroups response structure.
...
class CreateAccessGroupRequest(AbstractModel):
    r"""CreateAccessGroup request structure.
    ...
    @property
    def Description(self):
        r"""Permission group description, which is an empty string by default
        :rtype: str
        """
        return self._Description
...
class CreateAccessGroupResponse(AbstractModel):
    r"""CreateAccessGroup response structure.
...
class CreateAccessRulesRequest(AbstractModel):
    r"""CreateAccessRules request structure.
    ...
    def AccessRules(self):
        r"""Multiple permission rules (up to 10)
...
class CreateAccessRulesResponse(AbstractModel):
    r"""CreateAccessRules response structure.
...
class CreateFileSystemRequest(AbstractModel):
    r"""CreateFileSystem request structure.
    ...
    @property
    def Description(self):
        r"""File system description, which is an empty string by default
        :rtype: str
        """
        return self._Description
    ...
    @property
    def SuperUsers(self):
        r"""List of superuser names, which is an empty array by default
        :rtype: list of str
        """
    ...
    def RootInodeUser(self):
        r"""Username of the root directory Inode, which is `hadoop` by default
        :rtype: str
        """
    ...
    def RootInodeGroup(self):
        r"""Group name of the root directory Inode, which is `supergroup` by default
        :rtype: str
        """
    ...
    def EnableRanger(self):
        r"""Whether to enable verification of Ranger service addresses
        :rtype: bool
        """
    ...
    def RangerServiceAddresses(self):
        r"""List of Ranger service addresses (empty array by default)
        :rtype: list of str
        """
    ...
    @property
    def Tags(self):
        r"""Multiple resource tags, which can be an empty array
        :rtype: list of Tag
        """
        return self._Tags
...
class CreateFileSystemResponse(AbstractModel):
    r"""CreateFileSystem response structure.
...
class CreateLifeCycleRulesRequest(AbstractModel):
    r"""CreateLifeCycleRules request structure.
    ...
    def LifeCycleRules(self):
        r"""Multiple lifecycle rules (up to 10)
...
class CreateLifeCycleRulesResponse(AbstractModel):
    r"""CreateLifeCycleRules response structure.
...
class CreateMountPointRequest(AbstractModel):
    r"""CreateMountPoint request structure.
    ...
    def MountPointStatus(self):
        r"""Mount point status (1: enabled; 2: disabled)
        :rtype: int
        """
...
class CreateMountPointResponse(AbstractModel):
    r"""CreateMountPoint response structure.
...
class CreateRestoreTasksRequest(AbstractModel):
    r"""CreateRestoreTasks request structure.
    ...
    def RestoreTasks(self):
        r"""Multiple restoration tasks (up to 10)
...
class CreateRestoreTasksResponse(AbstractModel):
    r"""CreateRestoreTasks response structure.
...
class DeleteAccessGroupRequest(AbstractModel):
    r"""DeleteAccessGroup request structure.
...
class DeleteAccessGroupResponse(AbstractModel):
    r"""DeleteAccessGroup response structure.
...
class DeleteAccessRulesRequest(AbstractModel):
    r"""DeleteAccessRules request structure.
    ...
    def AccessRuleIds(self):
        r"""Multiple permission rule IDs (up to 10)
...
class DeleteAccessRulesResponse(AbstractModel):
    r"""DeleteAccessRules response structure.
...
class DeleteFileSystemRequest(AbstractModel):
    r"""DeleteFileSystem request structure.
...
class DeleteFileSystemResponse(AbstractModel):
    r"""DeleteFileSystem response structure.
...
class DeleteLifeCycleRulesRequest(AbstractModel):
    r"""DeleteLifeCycleRules request structure.
    ...
    def LifeCycleRuleIds(self):
        r"""Multiple lifecycle rule IDs (up to 10)
        :rtype: list of int non-negative
        """
...
class DeleteLifeCycleRulesResponse(AbstractModel):
    r"""DeleteLifeCycleRules response structure.
...
class DeleteMountPointRequest(AbstractModel):
    r"""DeleteMountPoint request structure.
...
class DeleteMountPointResponse(AbstractModel):
    r"""DeleteMountPoint response structure.
...
class DescribeAccessGroupRequest(AbstractModel):
    r"""DescribeAccessGroup request structure.
...
class DescribeAccessGroupResponse(AbstractModel):
    r"""DescribeAccessGroup response structure.
...
class DescribeAccessGroupsRequest(AbstractModel):
    r"""DescribeAccessGroups request structure.
...
class DescribeAccessGroupsResponse(AbstractModel):
    r"""DescribeAccessGroups response structure.
...
class DescribeAccessRulesRequest(AbstractModel):
    r"""DescribeAccessRules request structure.
...
class DescribeAccessRulesResponse(AbstractModel):
    r"""DescribeAccessRules response structure.
...
class DescribeFileSystemRequest(AbstractModel):
    r"""DescribeFileSystem request structure.
...
class DescribeFileSystemResponse(AbstractModel):
    r"""DescribeFileSystem response structure.
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    def CapacityUsed(self):
        r"""Used capacity of the file system, in bytes
Note: this field may return `null`, indicating that no valid value was found.
        :rtype: int
        """
    ...
    def ArchiveCapacityUsed(self):
        r"""Used ARCHIVE capacity of COS, in bytes
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: int
        """
    ...
    def StandardCapacityUsed(self):
        r"""Used STANDARD capacity of COS, in bytes
Note: this field may return `null`, indicating that no valid values can be obtained.
        :rtype: int
        """
    ...
    def DegradeCapacityUsed(self):
        r"""Used STANDARD_IA capacity of COS, in bytes
Note: this field may return `null`, indicating that no valid value was found.
        :rtype: int
        """
    ...
    def DeepArchiveCapacityUsed(self):
        r"""COS DEEP ARCHIVE storage usage, in bytes
Note: This field may return null, indicating that no valid values can be obtained.
        :rtype: int
        """
    ...
    def IntelligentCapacityUsed(self):
        r"""COS INTELLIGENT TIERING storage usage, in bytes
Note: This field may return null, indicating that no valid values can be obtained.
        :rtype: int
        """
...
class DescribeFileSystemsResponse(AbstractModel):
    r"""DescribeFileSystems response structure.
...
class DescribeLifeCycleRulesRequest(AbstractModel):
    r"""DescribeLifeCycleRules request structure.
...
class DescribeLifeCycleRulesResponse(AbstractModel):
    r"""DescribeLifeCycleRules response structure.
...
class DescribeMountPointRequest(AbstractModel):
    r"""DescribeMountPoint request structure.
...
class DescribeMountPointResponse(AbstractModel):
    r"""DescribeMountPoint response structure.
...
class DescribeMountPointsRequest(AbstractModel):
    r"""DescribeMountPoints request structure.
...
class DescribeMountPointsResponse(AbstractModel):
    r"""DescribeMountPoints response structure.
...
class DescribeResourceTagsRequest(AbstractModel):
    r"""DescribeResourceTags request structure.
...
class DescribeResourceTagsResponse(AbstractModel):
    r"""DescribeResourceTags response structure.
...
class DescribeRestoreTasksRequest(AbstractModel):
    r"""DescribeRestoreTasks request structure.
...
class DescribeRestoreTasksResponse(AbstractModel):
    r"""DescribeRestoreTasks response structure.
...
class DisassociateAccessGroupsRequest(AbstractModel):
    r"""DisassociateAccessGroups request structure.
...
class DisassociateAccessGroupsResponse(AbstractModel):
    r"""DisassociateAccessGroups response structure.
...
Note: this field may return `null`, indicating that no valid value was found.
    ...
    @property
    def BlockSize(self):
        r"""File system block size (in bytes)
        :rtype: int
        """
    ...
    @property
    def CapacityQuota(self):
        r"""File system capacity (in bytes)
        :rtype: int
        """
        return self._CapacityQuota
    ...
    @property
    def Status(self):
        r"""File system status (1: creating; 2: created successfully; 3: failed to create)
        :rtype: int
        """
        return self._Status
...
Note: this field may return `null`, indicating that no valid value was found.
    ...
    @property
    def RangerServiceAddresses(self):
        r"""List of Ranger service addresses
Note: this field may return `null`, indicating that no valid value was found.
        :rtype: list of str
        """
        return self._RangerServiceAddresses
...
class LifeCycleRule(AbstractModel):
    ...
    @property
    def Path(self):
        r"""Lifecycle rule path (directory or file)
        :rtype: str
        """
        return self._Path
    ...
    def Transitions(self):
        r"""List of lifecycle rule transitions
    ...
    @property
    def Status(self):
        r"""Lifecycle rule status (1: enabled; 2: disabled)
        :rtype: int
        """
        return self._Status
    ...
    @property
    def Summary(self):
        r"""Detailed storage usage of the current lifecycle rule path
...
class ModifyAccessGroupRequest(AbstractModel):
    r"""ModifyAccessGroup request structure.
...
class ModifyAccessGroupResponse(AbstractModel):
    r"""ModifyAccessGroup response structure.
...
class ModifyAccessRulesRequest(AbstractModel):
    r"""ModifyAccessRules request structure.
...
class ModifyAccessRulesResponse(AbstractModel):
    r"""ModifyAccessRules response structure.
...
class ModifyFileSystemRequest(AbstractModel):
    r"""ModifyFileSystem request structure.
...
Note: the file system capacity after change cannot be smaller than the currently used capacity
    ...
    @property
    def SuperUsers(self):
        r"""List of superuser names, which can be an empty array
        :rtype: list of str
        """
        return self._SuperUsers
    ...
    @property
    def RangerServiceAddresses(self):
        r"""List of Ranger service addresses, which can be an empty array
        :rtype: list of str
        """
        return self._RangerServiceAddresses
...
class ModifyFileSystemResponse(AbstractModel):
    r"""ModifyFileSystem response structure.
...
class ModifyLifeCycleRulesRequest(AbstractModel):
    r"""ModifyLifeCycleRules request structure.
...
class ModifyLifeCycleRulesResponse(AbstractModel):
    r"""ModifyLifeCycleRules response structure.
...
class ModifyMountPointRequest(AbstractModel):
    r"""ModifyMountPoint request structure.
...
class ModifyMountPointResponse(AbstractModel):
    r"""ModifyMountPoint response structure.
...
class ModifyResourceTagsRequest(AbstractModel):
    r"""ModifyResourceTags request structure.
...
class ModifyResourceTagsResponse(AbstractModel):
    r"""ModifyResourceTags response structure.
...
class MountPoint(AbstractModel):
    ...
    @property
    def AccessGroupIds(self):
        r"""List of IDs of the bound permission groups
        :rtype: list of str
        """
        return self._AccessGroupIds
...
class RestoreTask(AbstractModel):
    ...
    @property
    def Type(self):
        r"""Restoration task type (`1`: standard; `2`: expedited; `3`: bulk, with only the expedited type available currently)
        :rtype: int
        """
        return self._Type
    ...
    @property
    def Days(self):
        r"""Validity period (in days) of the temporary copy generated during restoration
        :rtype: int
        """
        return self._Days
    ...
    @property
    def Status(self):
        r"""Restoration task status (1: binding file; 2: file binding completed; 3: restoring file; 4: file restoration completed)
        :rtype: int
        """
        return self._Status
...
class Summary(AbstractModel):
    r"""Details about the storage usage of the current lifecycle rule path
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    @property
    def StandardCapacityUsed(self):
        r"""COS STANDARD storage usage in bytes
Note: This field may return null, indicating that no valid values can be obtained.
        :rtype: int
        """
        return self._StandardCapacityUsed
    ...
    @property
    def DegradeCapacityUsed(self):
        r"""COS STANDARD_IA storage usage in bytes
Note: This field may return null, indicating that no valid values can be obtained.
        :rtype: int
        """
        return self._DegradeCapacityUsed
    ...
    @property
    def ArchiveCapacityUsed(self):
        r"""COS ARCHIVE storage usage in bytes
Note: This field may return null, indicating that no valid values can be obtained.
        :rtype: int
        """
        return self._ArchiveCapacityUsed
...
class Transition(AbstractModel):
    r"""Lifecycle rule transition attribute
    ...
    @property
    def Type(self):
        r"""Transition type (`1`: ARCHIVE; `2`: Delete; `3`: STANDARD_IA; `4`: DEEP ARCHIVE; `5`: INTELLIGENT TIERING)
        :rtype: int
        """
        return self._Type
