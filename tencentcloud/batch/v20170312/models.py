...
class DataPointView(AbstractModel):
    ...
    @property
    def Timestamps(self):
        r"""The time when monitoring data is collected
    ...
    @property
    def Values(self):
        r"""Monitoring metric data; if involved in the gap time of monitoring data of multiple instances, the value will be null
...
class DescribeJobMonitorDataRequest(AbstractModel):
    r"""DescribeJobMonitorData request structure.
...
Sample: [{"Name":"diskname", "Value":"vdb"}]
    ...
    @property
    def JobId(self):
        r"""Job ID; see JobId in the job list (https://www.tencentcloud.com/document/product/599/15909?from_cn_redirect=1).
        :rtype: str
        """
        return self._JobId
    ...
    @property
    def TaskName(self):
        r"""Name of the job Task. See [job details](https://www.tencentcloud.com/document/product/599/15904?from_cn_redirect=1).
        :rtype: str
        """
    ...
    def TaskInstanceIndex(self):
        r"""Serial number of the task instance. For details, see [Task Detail](https://www.tencentcloud.com/document/product/599/15905?from_cn_redirect=1).
        :rtype: int
        """
    ...
    @property
    def MetricName(self):
        r"""Supported metrics; Metrics to be queried for the task currently supported.
...
-TargetDiskUsage: Specify disk utilization, unit: %; use in conjunction with the Dimensions parameter.
    ...
    @property
    def StartTime(self):
        r"""Query start time of the task instance. If the query start time is not passed in or the incoming time is less than the instance creation time (see task detail (https://www.tencentcloud.com/document/product/599/15905?from_cn_redirect=1) for instance creation time), the query time will automatically be adjusted to the instance creation time. The passed-in time format supports only the zero time zone format.
        :rtype: str
        """
        return self._StartTime
    ...
    @property
    def EndTime(self):
        r"""Query the termination time of the task instance. If the query end time is not passed in or the passed-in time is larger than the termination time of the task instance (see [task detail](https://www.tencentcloud.com/document/product/599/15905?from_cn_redirect=1) for the termination time of the task instance), and the task instance has already ended, the query end time will be automatically adjusted to the termination time of the task instance. If the task instance has not ended, the query end time will be automatically adjusted to the current time. The input time format supports only the zero time zone format.
        :rtype: str
        """
        return self._EndTime
    ...
    @property
    def Dimensions(self):
        r"""Query metrics extension parameter; currently only support TargetDiskUsage.
...
class DescribeJobMonitorDataResponse(AbstractModel):
    ...
    @property
    def Period(self):
        r"""Monitoring data granularity, measurement unit: second. Time granularity changes with the query time range. The smaller the query time range, the smaller the time granularity.
        :rtype: int
        """
        return self._Period
    ...
    @property
    def DataPoints(self):
        r"""The collected data is monitored. Timestamps and corresponding values have a one-to-one relationship. If the querying task retries and the collection time period involves multiple instances, values during specific periods are null, indicating no instance existence at the corresponding time and no corresponding monitoring data. The maximum number of null values between adjacent monitoring time periods is 10.
...
class Dimension(AbstractModel):
    r"""Job resource monitoring query dimension
    ...
    @property
    def Name(self):
        r"""Query the dimension name of a metric
        :rtype: str
        """
        return self._Name
    ...
    @property
    def Value(self):
        r"""Query the dimension value of a metric
        :rtype: str
        """
        return self._Value
