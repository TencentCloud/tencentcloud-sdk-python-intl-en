...
class DescribeAccessRegionsResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _RegionList: <p>Region information list</p>
...
class DeviceBaseInfo(AbstractModel):
    ...
    @property
    def CreateTime(self):
        r"""<p>The time when the device is created, in ms</p>
        :rtype: str
        """
    ...
    @property
    def LastTime(self):
        r"""<p>Last online time of the device, in ms</p>
        :rtype: str
        """
    ...
    @property
    def AccessScope(self):
        r"""<p>Access environment. 0: public cloud gateway; 1: private gateway; 2: public cloud gateway and private gateway. Defaults to public cloud gateway. Specific meaning: Public cloud gateway: The device can only access the public cloud gateway (nearby access). Private gateway: The device can only access the already launched private gateway (nearby access or fixed ip access). Public cloud gateway and private gateway: The device can also access both the public cloud gateway and the already launched private gateway (nearby access or fixed ip access).</p>
        :rtype: int
        """
        return self._AccessScope
    ...
    @property
    def LicensePayMode(self):
        r"""<p>license authorization validity period 0: monthly authorization 1: permanent license</p>
        :rtype: int
        """
        return self._LicensePayMode
    ...
    @property
    def Payer(self):
        r"""<p>Payment party 0: Manufacturer pays 1: Customer pays</p>
        :rtype: int
        """
        return self._Payer
    ...
    @property
    def FlowTrunc(self):
        r"""<p>Device data transfer plan processing method, 0: pay-as-you-go, 1: truncate acceleration</p>
        :rtype: int
        """
        return self._FlowTrunc
...
class GetNetMonitorRequest(AbstractModel):
    ...
    @property
    def Metrics(self):
        r"""<p>Statistical metric (Uplink rate: "TxRate": bit/s, Downstream rate: "RxRate": bit/s, Packet Loss: "Loss": %, Latency: "RTT": ms)</p>
        :rtype: str
        """
        return self._Metrics
    ...
    @property
    def GatewayType(self):
        r"""<p>Gateway type. 0: public cloud gateway; 1: private gateway. Defaults to 0 if not specified.</p>
        :rtype: int
        """
        return self._GatewayType
...
class GetNetMonitorResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _MonitorData: <p>Monitoring data.</p>
        :type MonitorData: list of MonitorData
        :param _AccessRegion: <p>Access region. Value ranges from 'MC' to 'AM'<br>MC=Chinese mainland<br>AP=Asia Pacific<br>EU=Europe<br>AM=Americas</p>
        :type AccessRegion: str
        :param _RequestId: The unique request ID, generated by the server, will be returned for every request (if the request fails to reach the server for other reasons, the request will not obtain a RequestId). RequestId is required for locating a problem.
        :type RequestId: str
        """
    ...
    @property
    def AccessRegion(self):
        r"""<p>Access region. Value ranges from 'MC' to 'AM'<br>MC=Chinese mainland<br>AP=Asia Pacific<br>EU=Europe<br>AM=Americas</p>
        :rtype: str
        """
        return self._AccessRegion
...
class ModifyDeviceAccessRegionsRequest(AbstractModel):
    r"""ModifyDeviceAccessRegions request structure.
...
class ModifyDeviceAccessRegionsResponse(AbstractModel):
    r"""ModifyDeviceAccessRegions response structure.
...
class RegionInfo(AbstractModel):
    r"""This data structure displays available region information.
    ...
    @property
    def RegionAbbr(self):
        r"""<p>English abbreviation of the region.</p>
        :rtype: str
        """
